...
class CachedNBT{constructor(){this.clear(),this.lastfilterUse=0,this.collapsedItem={}}unsetItem(e){delete this.nbt[e],delete this.collapsedItem[e],delete this.dropChance[e]}clear(){this.nbt={},this.collapsedItem={},this.dropChance={}}updateFilterLastUsed(){this.lastfilterUse=(new Date).getTime()}getItemType(e){var e=this.nbt[e];return null!=e&&"{}"!=e&&null!=(e=new CMDParser("").parseCompound(extractSegment("{","}",e.indexOf("{"),e))).id?extractMinecraftID(e.id.val):-1}setNBT(e,t){0<t.length?0==t.indexOf(",Slot:")?this.nbt[e]="{"+t.substr(t.indexOf("b")+2)+"}":this.nbt[e]="{"+t.substr(1)+"}":this.nbt[e]="{}",this.collapsedItem[e]=this.nbt[e]}setBlockNBT(e,t){null!=t&&"{}"!=t&&""!=t&&(this.nbt[e]=t)}copyCollapsedToNBT(e,t){this.nbt[e]=t}getCollapsedItem(e){return this.collapsedItem[e]}setCollapsedItem(e,t){this.collapsedItem[e]=t}getNBT(e){return this.nbt[e]}loadCachedItemNBT(e){var t=this.nbt[e];if(null!=t&&"{}"!=t)try{var a=new CMDParser("").parseCompound(extractSegment("{","}",t.indexOf("{"),t)),o=$("#"+e).val();if(null!=a.components)for(const n in a.components.val)loadComponentNBTIntoSlot(("!"==n.charAt(0)?"!":"")+extractMinecraftID(n),o,e,{val:a.components.val[n].val});null!=a.count&&$("#"+e+"Count").val(a.count.val)}catch(e){}}loadCachedEntityNBT(e){var t="e"+e,t=this.nbt[t];if(null!=t&&"{}"!=t)try{var a=new CMDParser(""),o=a.parseCompound(extractSegment("{","}",t.indexOf("{"),t));a.loadSummonCommand(o,e)}catch(e){}}loadCachedBlockNBT(e){e=this.nbt[e];if(null!=e&&"{}"!=e&&""!=e)try{var t=new CMDParser(""),a=t.parseCompound(extractSegment("{","}",e.indexOf("{"),e));t.loadBlockDataCommand(a,$("#block").val())}catch(e){}}}class Settings{constructor(){this.readSettings(),$("#settings").draggable(),$("#settings").hide(),$("#closeSettingsBut").off("click").on("click",function(){$("#settings").hide()}),$("#removeSlash").off("change").on("change",function(){settings.removeSlash=$("#removeSlash").is(":checked"),settings.writeSettings(),generateCommand()}),$("#loadItemUI").off("change").on("change",function(){settings.loadItemUI=$("#loadItemUI").is(":checked"),settings.writeSettings()}),$("#namespace").off("keyup").on("keyup",function(){settings.namespace=$("#namespace").val(),settings.writeSettings(),generateCommand()}),$("#commandPrefix").off("keyup").on("keyup",function(){settings.commandPrefix=$("#commandPrefix").val(),settings.writeSettings(),generateCommand()}),$("#updateNamespace").off("change").on("change",function(){settings.updateNamespace=$("#updateNamespace").is(":checked"),settings.writeSettings()}),$("#updateCommandPrefix").off("change").on("change",function(){settings.updateCommandPrefix=$("#updateCommandPrefix").is(":checked"),settings.writeSettings()}),$("#warnOnClose").off("change").on("change",function(){settings.warnOnClose=$("#warnOnClose").is(":checked"),settings.writeSettings(),electronMode||(settings.warnOnClose?window.addEventListener("beforeunload",function(e){e.preventDefault(),e.returnValue="Have you saved your command?"}):window.removeEventListener("beforeunload",function(e){e.preventDefault(),e.returnValue="Have you saved your command?"}))}),$("#themeChooser").off("change").on("change",function(){settings.cssTheme=$("#themeChooser").val(),settings.writeSettings(),changeTheme(settings.cssTheme)}),$("#langChooser").off("change").on("change",function(){settings.lang=$("#langChooser").val(),settings.writeSettings(),loadItemsAndBlocks(settings.lang)}),$("#sortMode").off("change").on("change",function(){settings.sortMode=$("#sortMode").val(),settings.writeSettings(),loadItemsAndBlocks(settings.lang)})}readSettings(){localStorage.namespace?this.namespace=localStorage.namespace:this.namespace="",localStorage.commandPrefix?this.commandPrefix=localStorage.commandPrefix:this.commandPrefix="",localStorage.updateNamespace&&"true"==localStorage.updateNamespace?this.updateNamespace=!0:this.updateNamespace=!1,localStorage.updateCommandPrefix&&"true"==localStorage.updateCommandPrefix?this.updateCommandPrefix=!0:this.updateCommandPrefix=!1,localStorage.removeSlash&&"true"==localStorage.removeSlash?this.removeSlash=!0:this.removeSlash=!1,localStorage.loadItemUI&&"true"==localStorage.loadItemUI?this.loadItemUI=!0:this.loadItemUI=!1,localStorage.warnOnClose&&"true"==localStorage.warnOnClose?(this.warnOnClose=!0,"true"!=localStorage.warnOnClose||electronMode||window.addEventListener("beforeunload",function(e){e.preventDefault(),e.returnValue="Have you saved your command?"})):this.warnOnClose=!1,localStorage.cssTheme?this.cssTheme=localStorage.cssTheme:this.cssTheme="mcstacker-darker.css",new URLSearchParams(window.location.search).has("theme")||changeTheme(this.cssTheme),localStorage.lang?this.lang=localStorage.lang:this.lang="en",localStorage.sortMode?this.sortMode=localStorage.sortMode:this.sortMode="desc_length",$("#namespace").val(this.namespace),$("#commandPrefix").val(this.commandPrefix),$("#updateNamespace").attr("checked",this.updateNamespace),$("#updateCommandPrefix").attr("checked",this.updateCommandPrefix),$("#loadItemUI").attr("checked",this.loadItemUI),$("#removeSlash").attr("checked",this.removeSlash),$("#warnOnClose").attr("checked",this.warnOnClose),$("#themeChooser").val(this.cssTheme),$("#langChooser").val(this.lang),$("#sortMode").val(this.sortMode)}modifyNamespace(e){this.updateNamespace&&(this.namespace=e,$("#namespace").val(this.namespace),this.writeSettings())}modifyCommandPrefix(e){this.updateCommandPrefix&&(this.commandPrefix=e,$("#commandPrefix").val(this.commandPrefix),this.writeSettings())}writeSettings(){localStorage.loadItemUI=this.loadItemUI,localStorage.namespace=this.namespace,localStorage.commandPrefix=this.commandPrefix,localStorage.updateNamespace=this.updateNamespace,localStorage.updateCommandPrefix=this.updateCommandPrefix,localStorage.removeSlash=this.removeSlash,localStorage.warnOnClose=this.warnOnClose,localStorage.cssTheme=this.cssTheme,localStorage.lang=this.lang,localStorage.sortMode=this.sortMode}}function changeTheme(e){$("#cssTheme").attr("href")!=e&&$("#cssTheme").attr("href",e)}function showSettings(){desktopMode&&$("#settings").css({top:mouse.y+200,left:mouse.x}),$("#settings").show(),bringToFront("settings")}function occurrences(e,t,a){if(e+="",(t+="").length<=0)return e.length+1;for(var o=0,n=0,s=a?1:t.length;0<=(n=e.indexOf(t,n));)++o,n+=s;return o}class CMDParser{constructor(e){this.level=0,this.state="S",e=e.trim(),this.nbt=null,this.executeParts=[]}parseLootTableNBT(e,t,a){this.nbt=convert_contents_to_value(extractSegment("{","}",0,a)),this.root=this.parseCompound(this.nbt),loadItemNBTIntoSlot({tag:{type:"compound",val:this.root}},t,e,this)}parseTheCommand(e){this.preParts=e.split(/(?= )/g);for(var t,a=0;a<this.preParts.length;a++)for(1<this.preParts[a].length&&" "==this.preParts[a].charAt(0)&&(this.preParts[a]=this.preParts[a].substr(1));a+1<this.preParts.length&&(occurrences(this.preParts[a],"[",!1)!=occurrences(this.preParts[a],"]",!1)||occurrences(this.preParts[a],"{",!1)!=occurrences(this.preParts[a],"}",!1));)this.preParts[a]+=this.preParts[a+1],this.preParts.splice(a+1,1);if(-1!=this.preParts[0].indexOf(":")?(-1!=(p=this.preParts[0].split(":"))[0].indexOf("/")&&(p[0]=p[0].substr(1)),settings.modifyCommandPrefix(p[0]),this.preParts[0]=p[1]):settings.modifyCommandPrefix(""),-1!=this.preParts[0].indexOf("execute")&&-1==e.indexOf("execute if entity")){for(t="execute",this.preParts.splice(0,1);"run"!=this.preParts[0]&&0<this.preParts.length;)t+=" "+this.preParts[0],this.preParts.splice(0,1);this.preParts.splice(0,1)}for(a=0;a<this.preParts.length;a++)"{"==this.preParts[a].charAt(0)?this.nbt=extractSegment("{","}",0,this.preParts[a]):"["==this.preParts[a].charAt(0)?this.nbt=extractSegment("[","]",0,this.preParts[a]):"@"==this.preParts[a].charAt(0)?-1!=this.preParts[a].indexOf("nbt=")&&(this.nbt=extractSegment("{","}",this.preParts[a].indexOf("nbt=")+4,this.preParts[a])):-1!=this.preParts[a].indexOf("{")&&(this.nbt=extractSegment("{","}",this.preParts[a].indexOf("{"),this.preParts[a]));if(-1==this.preParts[0].indexOf("tellraw")&&-1==this.preParts[0].indexOf("title")&&(this.root=this.parseCompound(this.nbt)),$("#disableOutput").prop("checked",!0),-1!=this.preParts[0].indexOf("summon")){loadForm("summon");var o=extractMinecraftID113(this.preParts[1]);if($("#entity"+entityIndex+" option[value='"+o+"']").length)$("#entity"+entityIndex).val(o),$("#entity"+entityIndex).trigger("change");else{let t=!1;if("potion"==o){let e="splash_potion";null!=this.root.Item&&null!=this.root.Item.val.id&&"lingering_potion"==extractMinecraftID(this.root.Item.val.id.val)&&(e="lingering_potion"),$("#entity"+entityIndex).val(e),$("#entity"+entityIndex).trigger("change"),t=!0}else-1!=o.indexOf("boat")&&null!=this.root.Type&&(p=this.root.Type.val+"_"+o,$("#entity"+entityIndex+" option[value='"+p+"']").length)&&($("#entity"+entityIndex).val(p),$("#entity"+entityIndex).trigger("change"),t=!0);if(!t)throw new MCSException(o+" is not a valid entity id")}$("#Summon").val(this.preParts[2]+" "+this.preParts[3]+" "+this.preParts[4]),this.loadSummonCommand(this.root,entityIndex)}else if(-1!=this.preParts[0].indexOf("execute")&&-1!=this.preParts[1].indexOf("if")&&-1!=this.preParts[2].indexOf("entity")){loadForm("execute if entity");var n=this.preParts[3];try{loadTargetSelectorsFromCommand113(n),this.loadSummonCommand(this.root,entityIndex)}catch(e){throw e}}else if(-1!=this.preParts[0].indexOf("kill")){loadForm("kill");n=this.preParts[1];try{loadTargetSelectorsFromCommand113(n),this.loadSummonCommand(this.root,entityIndex)}catch(e){throw e}}else if(-1!=this.preParts[0].indexOf("data")){if(-1!=this.preParts[2].indexOf("block")){loadForm("data merge block"),$("#commandForm").append("<div id='importBlockChooser'><br>To continue importing this command, please select the <br>type of block this <i>/data block merge</i> command was for.<br></div>"),$("#blockPane").hide(),$("#importBlockChooser").append("<br>Block Type For Import <select id='blockImport'></select>");var s,i=['<option value="-1">Choose Block</option>'];for(s in itemsAndBlocks)-1!=hasBlockData.indexOf(s)&&"i"!=itemsAndBlocks[s].c&&i.push('<option value="',s,'">',itemsAndBlocks[s].d,"</option>");const h=this;$("#blockImport").html(i.join("")),$("#blockImport").bind("change",function(){$("#blockPane").show(),$("#Block").val(h.preParts[3]+" "+h.preParts[4]+" "+h.preParts[5]),$("#block0").val($("#blockImport").val()),$("#block0").trigger("change"),h.loadBlockDataFromNBT($("#block0").val(),0),$("#importBlockChooser").hide(),generateCommand()})}else if(-1!=this.preParts[2].indexOf("entity")){loadForm("data merge entity");for(var n=this.preParts[3],l=4;-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;try{loadTargetSelectorsFromCommand113(n)}catch(e){throw e}this.loadSummonCommand(this.root,entityIndex)}}else if(-1!=this.preParts[0].indexOf("give")){loadForm("give");for(var n=this.preParts[1],l=2;-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;loadTargetSelectorsFromCommand113(n);var r={},c=extractMinecraftID113(this.preParts[l]),e=-1!=this.preParts[l].indexOf(c+"[")||-1!=this.preParts[l].indexOf("minecraft:"+c+"["),p=e?extractSegment("[","]",this.preParts[l].indexOf("["),this.preParts[l]):"";if(l++,isNaN(this.preParts[l])?r.count={type:"raw",val:1}:r.count={type:"raw",val:this.preParts[l]},r.tag={type:"compound",val:this.root},$("#GiveItem0").length){if(!$("#GiveItem0 option[value='"+c+"']").length)throw new MCSException(c+" is not a valid item id");$("#GiveItem0").val(c),$("#GiveItem0").trigger("change"),e?loadComponentNBTIntoSlotForGive(p.substring(1,p.length-1),c,"GiveItem0",this,r):loadItemNBTIntoSlot(r,c,"GiveItem0",this)}}else if(-1!=this.preParts[0].indexOf("effect")){loadForm("effect");l=2,n=this.preParts[l];for(l++;-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;-1!=n.indexOf("@e")&&($("#entity0").val("entity"),$("#entity0").trigger("change")),loadTargetSelectorsFromCommandGeneric(n,"entity0");e=extractMinecraftID113(this.preParts[l]);$("#effect").val(e),this.preParts.length>++l&&("infinite"==this.preParts[l]?$("#seconds").val("infinite"):-1!=["saturation","instant_health","instant_damage"].indexOf(e)?$("#seconds").val(parseInt(this.preParts[l])/20):$("#seconds").val(this.preParts[l]),this.preParts.length>++l)&&($("#amplifier").val(this.preParts[l]),this.preParts.length>++l)&&$("#hideParticles").val(this.preParts[l])}else if(-1!=this.preParts[0].indexOf("ride"))loadForm("ride"),-1!=this.preParts[1].indexOf("@e")&&($("#entity0").val("entity"),$("#entity0").trigger("change")),loadTargetSelectorsFromCommandGeneric(this.preParts[1],"entity0"),$("#ridetype0").val(this.preParts[2]),"mount"==this.preParts[2]&&4<=this.preParts.length&&loadTargetSelectorsFromCommandGeneric(this.preParts[3],"ridetype0");else if(-1!=this.preParts[0].indexOf("damage"))loadForm("damage"),-1!=this.preParts[1].indexOf("@e")&&($("#entity0").val("entity"),$("#entity0").trigger("change")),loadTargetSelectorsFromCommandGeneric(this.preParts[1],"entity0"),$("#Amount0").val(this.preParts[2]),3<this.preParts.length&&($("#damageType0").val(extractMinecraftID(this.preParts[3])),4<this.preParts.length)&&("at"==this.preParts[4]?($("#target0").val("block"),$("#target0").trigger("change"),$("#location").val(this.preParts[5]+" "+this.preParts[6]+" "+this.preParts[7])):(-1!=this.preParts[5].indexOf("@e")?$("#target0").val("entity"):$("#target0").val("player"),$("#target0").trigger("change"),loadTargetSelectorsFromCommandGeneric(this.preParts[5],"target0"),6<this.preParts.length&&(-1!=this.preParts[7].indexOf("@e")?$("#facingtarget0").val("entity"):$("#facingtarget0").val("player"),$("#facingtarget0").trigger("change"),loadTargetSelectorsFromCommandGeneric(this.preParts[7],"facingtarget0"))));else if(-1!=this.preParts[0].indexOf("rotate"))loadForm("rotate"),-1!=this.preParts[1].indexOf("@e")&&($("#entity0").val("entity"),$("#entity0").trigger("change")),loadTargetSelectorsFromCommandGeneric(this.preParts[1],"entity0"),4==this.preParts.length?($("#rotationType").val("rotation"),$("#rotationType").trigger("change"),$("#Yaw0").val(this.preParts[2]),$("#Pitch0").val(this.preParts[3])):"facing"==this.preParts[2]&&("entity"==this.preParts[3]?($("#rotationType").val("facingEntity"),$("#rotationType").trigger("change"),$("#facingtarget0").val("e"==this.preParts[4].charAt(1)?"entity":"player"),$("#facingtarget0").trigger("change"),loadTargetSelectorsFromCommandGeneric(this.preParts[4],"facingtarget0"),6==this.preParts.length&&$("#Anchor0").val(this.preParts[5])):($("#rotationType").val("facingCoords"),$("#facingType").trigger("change"),$("#RotationFacingCoords").val(this.preParts[3]+" "+this.preParts[4]+" "+this.preParts[5])));else if(-1!=this.preParts[0].indexOf("tp")||-1!=this.preParts[0].indexOf("teleport")){loadForm("teleport");try{-1!=this.preParts[1].indexOf("@e")&&($("#entity0").val("entity"),$("#entity0").trigger("change")),loadTargetSelectorsFromCommandGeneric(this.preParts[1],"entity0"),3<this.preParts.length?($("#target0").val("block"),$("#target0").trigger("change"),$("#Block").val(this.preParts[2]+" "+this.preParts[3]+" "+this.preParts[4]),5<this.preParts.length&&("facing"==this.preParts[5]?"entity"==this.preParts[6]?($("#facingType").val("facingEntity"),$("#facingType").trigger("change"),$("#facingtarget0").val("e"==this.preParts[7].charAt(1)?"entity":"player"),$("#facingtarget0").trigger("change"),loadTargetSelectorsFromCommandGeneric(this.preParts[7],"facingtarget0"),9==this.preParts.length&&$("#Anchor0").val(this.preParts[8])):($("#facingType").val("facingCoords"),$("#facingType").trigger("change"),$("#FacingCoords").val(this.preParts[6]+" "+this.preParts[7]+" "+this.preParts[8])):($("#facingType").val("rotation"),$("#facingType").trigger("change"),$("#Yaw0").val(this.preParts[5]),$("#Pitch0").val(this.preParts[6])))):($("#target0").val("e"==this.preParts[2].charAt(1)?"entity":"player"),$("#target0").trigger("change"),loadTargetSelectorsFromCommandGeneric(this.preParts[2],"target0"))}catch(e){throw e}}else if(-1!=this.preParts[0].indexOf("replaceitem")){if(loadForm("item"),"entity"==this.preParts[1]){-1!=this.preParts[2].indexOf("@e")?$("#replaceitem").val("entity"):$("#replaceitem").val("player"),$("#replaceitem").trigger("change");n=this.preParts[2];for(l=3;-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;loadTargetSelectorsFromCommandGeneric(n,"replaceitem"),$("#Slot0").val(this.preParts[l]),l++}else $("#Block").val(this.preParts[2]+" "+this.preParts[3]+" "+this.preParts[4]),$("#Slot0").val(this.preParts[5].substr(this.preParts[5].lastIndexOf(".")+1)),l=6;r={},c=extractMinecraftID113(this.preParts[l]);if(r.Count={type:"raw",val:this.preParts[++l]},r.tag={type:"compound",val:this.root},!$("#GiveItem0 option[value='"+c+"']").length)throw new MCSException(c+" is not a valid item id");$("#GiveItem0").val(c),$("#GiveItem0").trigger("change"),loadItemNBTIntoSlot(r,c,"GiveItem0",this)}else if(-1!=this.preParts[0].indexOf("item")){loadForm("item");l=1;if("replace"==this.preParts[1]?($("#itemCmdMode").val("replace"),$("#itemCmdMode").trigger("replace")):"modify"==this.preParts[1]&&($("#itemCmdMode").val("modify"),$("#itemCmdMode").trigger("change")),"entity"==this.preParts[2]){-1!=this.preParts[3].indexOf("@e")?$("#replaceitem").val("entity"):$("#replaceitem").val("player"),$("#replaceitem").trigger("change");n=this.preParts[3];for(l=4;-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;loadTargetSelectorsFromCommandGeneric(n,"replaceitem"),"horse.armor"==this.preParts[l]?$("#Slot0").val("armor.body"):"horse.saddle"==this.preParts[l]?$("#Slot0").val("saddle"):$("#Slot0").val(this.preParts[l]),l++}else $("#Block").val(this.preParts[3]+" "+this.preParts[4]+" "+this.preParts[5]),$("#Slot0").val(this.preParts[6].substr(this.preParts[6].lastIndexOf(".")+1)),l=7;if("modify"==this.preParts[1])$("#ItemModifier0").val(this.preParts[l]);else if("with"==this.preParts[l]){var r={},c=extractMinecraftID113(this.preParts[++l]),p=-1!=this.preParts[l].indexOf(c+"[")||-1!=this.preParts[l].indexOf("minecraft:"+c+"["),e=p?extractSegment("[","]",this.preParts[l].indexOf("["),this.preParts[l]):"";if(l++,isNaN(this.preParts[l])?r.count={type:"raw",val:1}:r.count={type:"raw",val:this.preParts[l]},r.tag={type:"compound",val:this.root},$("#GiveItem0").length){if(!$("#GiveItem0 option[value='"+c+"']").length)throw new MCSException(c+" is not a valid item id");$("#GiveItem0").val(c),$("#GiveItem0").trigger("change"),p?loadComponentNBTIntoSlotForGive(e.substring(1,e.length-1),c,"GiveItem0",this,r):loadItemNBTIntoSlot(r,c,"GiveItem0",this)}}else if("from"==this.preParts[l])if($("#itemCmdMode").val("copy"),$("#itemCmdMode").trigger("change"),"entity"==this.preParts[++l]){-1!=this.preParts[++l].indexOf("@e")?$("#itemCopyType").val("entity"):$("#itemCopyType").val("player"),$("#itemCopyType").trigger("change");var d=this.preParts[l];for(l++;-1!=d.indexOf("[")&&-1==d.indexOf("]")&&l<this.preParts.length;)d+=" "+this.preParts[l],l++;loadTargetSelectorsFromCommandGeneric(d,"itemCopyType"),$("#SlotCopy0").val(this.preParts[l]),l++}else $("#BlockCopy").val(this.preParts[l+1]+" "+this.preParts[l+2]+" "+this.preParts[l+3]),l+=4,$("#SlotCopy0").val(this.preParts[l].substr(this.preParts[l].lastIndexOf(".")+1))}else if(-1!=this.preParts[0].indexOf("setblock")){loadForm("setblock"),$("#Block").val(this.preParts[1]+" "+this.preParts[2]+" "+this.preParts[3]);o=extractMinecraftID113(this.preParts[4]);if(!$("#block0 option[value='"+o+"']").length)throw new MCSException(o+" is not a block id");$("#block0").val(o),$("#block0").trigger("change"),this.parseBlockState113(this.preParts[4],"BS0"),0<$("#blockHandle option[value='"+this.preParts[5]+"']").length&&$("#blockHandle").val(this.preParts[5]),this.loadBlockDataFromNBT($("#block0").val(),0)}else if(-1!=this.preParts[0].indexOf("loot")){loadForm("loot");l=2;if("replace"==this.preParts[1]&&(this.preParts[1]=this.preParts[1]+" "+this.preParts[2],this.preParts.splice(2,1)),$("#targetType").val(this.preParts[1]),$("#targetType").trigger("change"),"spawn"==this.preParts[1]||"insert"==this.preParts[1]||"replace block"==this.preParts[1])$("#Loot").val(this.preParts[l]+" "+this.preParts[l+1]+" "+this.preParts[l+2]),l+=3;else if("give"==this.preParts[1]||"replace entity"==this.preParts[1]){for(n=this.preParts[l];-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;loadTargetSelectorsFromCommandGeneric(n,"entity0"),l++}if("replace entity"!=this.preParts[1]&&"replace block"!=this.preParts[1]||("horse.armor"==this.preParts[l]?$("#slot").val("armor.body"):"horse.saddle"==this.preParts[l]?$("#slot").val("saddle"):$("#slot").val(this.preParts[l]),l++),$("#sourceType").val(this.preParts[l]),$("#sourceType").trigger("change"),"loot"==this.preParts[l]||"fish"==this.preParts[l]){if(l++,$("#LootTable").val(this.preParts[l]),"fish"==this.preParts[l-1]){$("#Fishing").val(this.preParts[l+1]+" "+this.preParts[l+2]+" "+this.preParts[l+3]);r={},c=extractMinecraftID113(this.preParts[l+=4]);if(r.Count={type:"raw",val:1},r.tag={type:"compound",val:this.root},!$("#FishingTool0 option[value='"+c+"']").length)throw new MCSException(c+" is not a valid item id");$("#FishingTool0").val(c),$("#FishingTool0").trigger("change"),loadItemNBTIntoSlot(r,c,"FishingTool0",this)}}else if("mine"==this.preParts[l]){$("#Mining").val(this.preParts[l+1]+" "+this.preParts[l+2]+" "+this.preParts[l+3]);r={},c=extractMinecraftID113(this.preParts[l+=4]);if(r.Count={type:"raw",val:1},r.tag={type:"compound",val:this.root},!$("#MiningTool0 option[value='"+c+"']").length)throw new MCSException(c+" is not a valid item id");$("#MiningTool0").val(c),$("#MiningTool0").trigger("change"),loadItemNBTIntoSlot(r,c,"MiningTool0",this)}else if("kill"==this.preParts[l]){for(n=this.preParts[++l];-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;loadTargetSelectorsFromCommandGeneric(n,"kill0")}}else if(-1!=this.preParts[0].indexOf("bossbar"))if(loadForm("bossbar"),$("#action").val(this.preParts[1]),$("#ID0").val(this.preParts[2]),"set"==this.preParts[1]){if($("#action").trigger("change"),$("#set").val(this.preParts[3]),"name"==this.preParts[3])importTellrawJSON("bossbarPane",m=JSON.parse(this.nbt));else if("players"==this.preParts[3]){$("#set").trigger("change");for(n=this.preParts[4],l=5;-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;loadTargetSelectorsFromCommand113(n)}}else"add"==this.preParts[1]&&importTellrawJSON("bossbarPane",m=JSON.parse(this.nbt));else if(-1!=this.preParts[0].indexOf("scoreboard"))loadForm("scoreboard"),$("#add_modify").val(this.preParts[2]),$("#add_modify").trigger("change"),$("#objective").val(this.preParts[3]),"add"==this.preParts[2]&&$("#Criteria0").val(this.preParts[4]),importTellrawJSON("scoreboardPane",m=JSON.parse(this.nbt));else if(-1!=this.preParts[0].indexOf("team"))loadForm("team"),$("#add_modify").val(this.preParts[1]),$("#add_modify").trigger("change"),$("#team").val(this.preParts[2]),"modify"==this.preParts[1]&&$("#Part0").val(this.preParts[3]),importTellrawJSON("teamPane",m=JSON.parse(this.nbt));else if(-1!=this.preParts[0].indexOf("tellraw")||-1!=this.preParts[0].indexOf("title")){for(var m,n=this.preParts[1],l=2;-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;if(-1!=this.preParts[0].indexOf("tellraw")?loadForm("tellraw"):(loadForm("title"),$("#titleType").val(this.preParts[l])),loadTargetSelectorsFromCommand113(n),null==(m=JSON.parse(this.nbt))){let t=this.preParts[2];for(let e=3;e<this.preParts.length;e++)t+=" "+this.preParts[e];m=[JSON.parse(t)]}importTellrawJSON("tellrawPane",m)}else if(-1!=this.preParts[0].indexOf("particle")){loadForm("particle");var p=extractMinecraftID113(p=null!=this.nbt?this.preParts[1].substring(0,this.preParts[1].indexOf("{")):this.preParts[1]),l=($("#name").val(p),$("#name").trigger("change"),1),_=8;if(null!=this.nbt){let e;switch(p){case"dust":null!=this.root.color&&(e=floatToHex(this.root.color.val[0])+floatToHex(this.root.color.val[1])+floatToHex(this.root.color.val[2]),new jscolor.color(document.getElementById("mobSpell_color"),{}).fromString(e.toUpperCase())),null!=this.root.scale&&$("#dustSize").val(this.root.scale.val);break;case"trail":var g=new jscolor.color(document.getElementById("trail_color"),{});Array.isArray(this.root.color.val)?(e=floatToHex(this.root.color.val[0])+floatToHex(this.root.color.val[1])+floatToHex(this.root.color.val[2]),g.fromString(e.toUpperCase())):g.fromString(getHexColor(this.root.color.val)),$("#targetX0").val(parseFloat(this.root.target.val[0])),$("#targetY0").val(parseFloat(this.root.target.val[1])),$("#targetZ0").val(parseFloat(this.root.target.val[2])),null!=this.root.duration&&$("#duration0").val(this.root.duration.val);break;case"dust_color_transition":null!=this.root.from_color&&(e=floatToHex(this.root.from_color.val[0])+floatToHex(this.root.from_color.val[1])+floatToHex(this.root.from_color.val[2]),new jscolor.color(document.getElementById("mobSpell_color"),{}).fromString(e.toUpperCase())),null!=this.root.to_color&&(e=floatToHex(this.root.to_color.val[0])+floatToHex(this.root.to_color.val[1])+floatToHex(this.root.to_color.val[2]),new jscolor.color(document.getElementById("mobSpell_color_to"),{}).fromString(e.toUpperCase())),null!=this.root.scale&&$("#dustSize").val(this.root.scale.val);break;case"entity_effect":case"tinted_leaves":null!=this.root.color&&(e=floatToHex(this.root.color.val[0])+floatToHex(this.root.color.val[1])+floatToHex(this.root.color.val[2]),new jscolor.color(document.getElementById("mobSpell_color"),{}).fromString(e.toUpperCase()),$("#alpha0").val(this.root.color.val[3]));break;case"block":case"block_crumble":case"block_marker":case"falling_dust":case"dust_pillar":if(null!=this.root.block_state){let e;if(e=null!=this.root.block_state.val.Name?extractMinecraftID113(this.root.block_state.val.Name.val):extractMinecraftID113(this.root.block_state.val),!$("#block0 option[value='"+e+"']").length)throw new MCSException(e+" is not a block id");if($("#block0").val(e),$("#block0").trigger("change"),null!=this.root.block_state.val.Properties)for(var u in this.root.block_state.val.Properties.val)$(`#${u}BS0`).val(this.root.block_state.val.Properties.val[u].val)}break;case"shriek":null!=this.root.delay&&$("#delay").val(this.root.delay.val);break;case"sculk_charge":null!=this.root.roll&&$("#roll").val(this.root.roll.val);break;case"vibration":if(null!=this.root.arrival_in_ticks&&$("#travelTime0").val(this.root.arrival_in_ticks.val),null!=this.root.destination&&null!=this.root.destination.val.pos){const o=null!=this.root.destination&&this.root.destination.val.pos.val;$("#ToCoords").val(`${o[0]} ${o[1]} `+o[2])}$("#FromCoords").val(this.preParts[++l]+" "+this.preParts[++l]+" "+this.preParts[++l]);break;case"item":null!=this.root.item&&$("#item0").val(extractMinecraftID((null!=this.root.item.val.id?this.root.item.val.id:this.root.item).val))}}else if("dust"==p||"dust_color_transition"==p||"entity_effect"==p){e=0==p.indexOf("dust")?floatToHex(this.preParts[2])+floatToHex(this.preParts[3])+floatToHex(this.preParts[4]):floatToHex(this.preParts[5])+floatToHex(this.preParts[6])+floatToHex(this.preParts[7]);new jscolor.color(document.getElementById("mobSpell_color"),{}).fromString(e.toUpperCase()),"entity_effect"==p?(l=1,_=8):(l=5,_=12,changeParticelXdYdZd($("#mobSpell_color_to").val()),$("#dustSize").val(this.preParts[5])),"dust_color_transition"==p&&(l=8,_=15,r=floatToHex(this.preParts[6])+floatToHex(this.preParts[7])+floatToHex(this.preParts[8]),new jscolor.color(document.getElementById("mobSpell_color_to"),{}).fromString(r.toUpperCase()))}else if("vibration"==p)$("#FromCoords").val(this.preParts[++l]+" "+this.preParts[++l]+" "+this.preParts[++l]),$("#ToCoords").val(this.preParts[++l]+" "+this.preParts[++l]+" "+this.preParts[++l]),$("#travelTime0").val(this.preParts[++l]),l=8,_=15;else if("tinted_leaves"==p)l=1,_=8;else if("item"==p)$("#item0").val(extractMinecraftID(this.preParts[2])),l=6,_=9;else if("block"==p||"block_marker"==p||"falling_dust"==p||"dust_pillar"==p){o=extractMinecraftID113(this.preParts[2]);if(!$("#block0 option[value='"+o+"']").length)throw new MCSException(o+" is not a block id");$("#block0").val(o),$("#block0").trigger("change"),this.parseBlockState113(this.preParts[2],"BS0"),l=2,_=9}else"shriek"==p?($("#delay").val(this.preParts[2]),l=2,_=9):"tinted_leaves"==p?(l=5,_=8):"sculk_charge"==p?($("#roll").val(this.preParts[2]),l=2,_=9):l=1;if("vibration"!=p&&$("#Location").val(this.preParts[++l]+" "+this.preParts[++l]+" "+this.preParts[++l]),"entity_effect"==p?null!=this.nbt&&(l=4,$("#xd").val(this.preParts[++l]),$("#yd").val(this.preParts[++l]),$("#zd").val(this.preParts[++l])):($("#xd").val(this.preParts[++l]),$("#yd").val(this.preParts[++l]),$("#zd").val(this.preParts[++l])),$("#speed").val(this.preParts[_]),9<this.preParts.length&&($("#count").val(this.preParts[++_]),10<this.preParts.length&&"force"==this.preParts[++_]&&$("#mode").val("force"),this.preParts.length-1>_)){for(n=this.preParts[++_];-1!=n.indexOf("[")&&-1==n.indexOf("]")&&_<this.preParts.length;)n+=" "+this.preParts[_],_++;showHide("TSPane","TSPaneSH"),loadTargetSelectorsFromCommand113(n)}}else if(-1!=this.preParts[0].indexOf("playsound")){loadForm("playsound"),$("#sound").val(this.preParts[1]),$("#source").val(this.preParts[2]);for(n=this.preParts[3],l=4;-1!=n.indexOf("[")&&-1==n.indexOf("]")&&l<this.preParts.length;)n+=" "+this.preParts[l],l++;loadTargetSelectorsFromCommand113(n);try{$("#Position").val(this.preParts[l]+" "+this.preParts[l+1]+" "+this.preParts[l+2]),$("#volume").val(this.preParts[l+3]),$("#pitch").val(this.preParts[l+4]),$("#minvolume").val(this.preParts[l+5])}catch(e){}}else{if(-1==this.preParts[0].indexOf("fill"))throw new MCSException("MCStacker can't import '"+this.preParts[0]+"' commands .");loadForm("fill"),$("#Corner").val(this.preParts[1]+" "+this.preParts[2]+" "+this.preParts[3]),$("#Opposite").val(this.preParts[4]+" "+this.preParts[5]+" "+this.preParts[6]);o=extractMinecraftID113(this.preParts[7]);if(!$("#block0 option[value='"+o+"']").length)throw new MCSException(o+" is not a block id");if($("#block0").val(o),$("#block0").trigger("change"),this.parseBlockState113(this.preParts[7],"BS0"),this.nbt=extractSegment("{","}",this.preParts[7].indexOf("{"),this.preParts[7]),this.root=this.parseCompound(this.nbt),this.loadBlockDataFromNBT($("#block0").val(),0),0<$("#blockHandle option[value='"+this.preParts[8]+"']").length&&($("#blockHandle").val(this.preParts[8]),"replace"!=this.preParts[8])&&$("#blockHandle").trigger("change"),9<this.preParts.length){if(o=extractMinecraftID113(this.preParts[9]),!$("#block1 option[value='"+o+"']").length)throw new MCSException(o+" is not a valid block id.");$("#block1").val(o),$("#block1").trigger("change"),this.parseBlockState113(this.preParts[9],"BS1"),this.nbt=extractSegment("{","}",this.preParts[9].indexOf("{"),this.preParts[9]),this.root=this.parseCompound(this.nbt),this.loadBlockDataFromNBT($("#block1").val(),1)}}null!=t&&(createExecuteForm(),$("#exeString").val(t+" run")),$("#disableOutput").prop("checked",!1),generateCommand()}parseBlockState113(e,t){for(var a="",o=0;o<e.length;o++){if("{"==e.charAt(o))return;if("["==e.charAt(o)){a=(a=e.substr(o+1)).substr(0,a.indexOf("]"));break}}if(a.length)for(var n=a.split(","),o=0;o<n.length;o++){var s=n[o].split("=");$("#"+s[0]+t).val(s[1])}}loadBlockDataFromNBT(e,t=0,a=this.root){var o;if(null!=a.lock&&setupItemSlotForNBT("lock"+t,a.lock.val,this),-1!=e.indexOf("_banner"))null!=a.Patterns&&(o=compoundToNBTString(a),$("#BlockEntityTag"+t).val("Patterns:"+extractSegment("[","]",o.indexOf("Patterns")+9,o))),this.loadBlockDataCommand(a,e,t);else if("player_head"==e||"player_wall_head"==e){if(null!=a.SkullOwner){let e=a.SkullOwner.val;null!=e.Properties&&-1!=(e="SkullOwner:"+compoundToNBTString(e)).indexOf("Id:[")&&-1==e.indexOf("Id:[I;")&&(e=replaceAll("Id:[","Id:[I;",e)),$("#SkullOwner"+t).val(e)}if(null!=a.profile){let e=a.profile.val;null!=e.properties&&-1!=(e="profile="+compoundToNBTString(e)).indexOf("id:[")&&-1==e.indexOf("id:[I;")&&(e=replaceAll("id:[","id:[I;",e)),$("#SkullOwner"+t).val(e)}null!=a.note_block_sound&&$("#blockSpec"+t+"sound").val(extractMinecraftID(a.note_block_sound.val))}else if("campfire"==e||"soul_campfire"==e){if(this.loadBlockDataCommand(a,e,t),null!=a.CookingTimes)for(var n=0;n<4&&n<a.CookingTimes.val.length;n++)$("#"+n+"CookingTime"+t).val(a.CookingTimes.val[n].trim());if(null!=a.CookingTotalTimes)for(n=0;n<4&&n<a.CookingTotalTimes.val.length;n++)$("#"+n+"CookingTotalTime"+t).val(a.CookingTotalTimes.val[n].trim())}else"furnace"==e||"blast_furnace"==e||"smoker"==e?(null!=a.RecipesUsed&&loadRecipedUsedFromNBT("RecipesUsed"+t,a.RecipesUsed.val),this.loadBlockDataCommand(a,e,t)):"decorated_pot"==e?(null!=a.sherds&&loadPotterySherds("Sherd",t,a.sherds.val),null!=a.item&&(showHide("item"+t+"Pane","item"+t+"SH"),setupItemSlotForNBT("item"+t,a.item.val,this)),null!=a.LootTable&&$("#LootTable"+t).val(a.LootTable.val)):"suspicious_sand"==e||"suspicious_gravel"==e?(null!=a.item&&(showHide("item"+t+"Pane","item"+t+"SH"),setupItemSlotForNBT("item"+t,a.item.val,this)),null!=a.LootTable&&$("#LootTable"+t).val(a.LootTable.val)):"jukebox"==e?null!=a.RecordItem&&(showHide("RecordItem"+t+"Pane","RecordItem"+t+"SH"),setupItemSlotForNBT("RecordItem"+t,a.RecordItem.val,this)):"end_gateway"==e?(loadEndGateWayNBT(this,a,t),this.loadBlockDataCommand(a,e,t)):"lectern"==e?(null!=a.Book&&(showHide("Book"+t+"Pane","Book"+t+"SH"),setupItemSlotForNBT("Book"+t,a.Book.val,this)),null!=a.Page&&$("#Page"+t).val(a.Page.val)):"vault"==e?loadVaultFromNBT(this,a,"blockSpec"+t):"crafter"==e?loadCrafterFromNBT(this,a,"blockSpec"+t):"trial_spawner"==e?loadTrialSpawnerFromNBT(this,a,"blockSpec"+t):"spawner"==e?loadMonsterSpawnerFromNBT(this,a,"blockSpec"+t):"beehive"==e||"bee_nest"==e?loadBeeHiveNestFromNBT(this,a,t):"sculk_catalyst"==e?loadSculkCatalystFromNBT(this,a,t):(-1!=e.indexOf("sign")&&(null==(o=parseNewFormatSign(extractSegment("{","}",this.nbt.indexOf("{"),this.nbt)))?loadSignFromNBT("blockSpec"+t+"SignPane",a):loadSignFromNBTNewFormat("blockSpec"+t+"SignPane",o)),this.loadBlockDataCommand(a,e,t))}loadPosition(e,t,a){a&&1<t.length?$("#"+e).val(t.substr(1)):a||$("#"+e).val(t)}padding(){return"<span style='padding-left:"+50*this.level+"px'></span>"}loadBlockDataCommand(e,t,a=0){for(var o in e){var n=e[o];"compound"==n.type?this.loadBlockDataCommand(n.val,t,a):blocks[a].loadValue(this,o,n.val,a)}}loadSummonCommand(e,t){for(var a in e){var o=e[a];if("raw"==o.type||"string"==o.type)entityDescriptors["e"+t].loadValue(this,a,o.val,t);else if("compound"==o.type)if("equipment"==a)for(var n in o.val)setupItemSlotForNBT(n+t,o.val[n].val,this);else if("drop_chances"==a)for(var n in o.val)cachedNBT.dropChance[n+t]=parseFloat(o.val[n].val),null!=cachedNBT.dropChance[n+t]&&""!=cachedNBT.dropChance[n+t]?$("#"+n+t+"dropChancePart").html("Drop Chance="+cachedNBT.dropChance[n+t]):$("#"+n+t+"dropChancePart").html(""),$("#"+n+t+"DropChance").val(parseFloat(o.val[n].val));else if("item"==a||"Item"==a)-1!=entityDescriptors["e"+t].entityType.indexOf("potion")?entityDescriptors["e"+t].loadPotionNBT(o.val):(setupItemSlotForNBT(a+t,o.val,this),show(a+t+"Pane",a+t+"SH"));else if("Trident"==a||"trident"==entityDescriptors["e"+t].entityType&&"item"==a)showHide("Trident"+t+"Pane","Trident"+t+"SH"),setupItemSlotForNBT("Trident"+t,o.val,this);else if("respawn"==a)null!=o.val.pos&&($("#SpawnX"+t).val(o.val.pos.val[0]),$("#SpawnY"+t).val(o.val.pos.val[1]),$("#SpawnZ"+t).val(o.val.pos.val[2])),null!=o.val.angle&&$("#SpawnAngle"+t).val(o.val.angle.val),null!=o.val.dimension&&$("#SpawnDimension"+t).val(extractMinecraftID(o.val.dimension.val)),null!=o.val.forced&&$("#SpawnForced"+t).val("true"==o.val.forced.val?1:0);else if("Particle"==a)entityDescriptors["e"+t].loadNewParticleFormat(o.val);else if("SelectedItem"==a)setupItemSlotForNBT("SelectedItem"+t,o.val,this);else if("item"==a)showHide("Item"+t+"Pane","Item"+t+"SH"),setupItemSlotForNBT("Item"+t,o.val,this);else if("Pose"==a)entityDescriptors["e"+t].loadPoseNBT(o.val);else if("Offers"==a)entityDescriptors["e"+t].loadVillagerTradesNBT(o.val,this);else if("VillagerData"==a)loadVillagerData(o.val,t);else if("leash"==a)entityDescriptors["e"+t].load_leash_NBT(o.val);else if("Leash"==a)entityDescriptors["e"+t].loadLeashNBT(o.val);else if("SaddleItem"==a)setupItemSlotForNBT("saddle"+t,o.val,this);else if("body_armor_item"==a||"ArmorItem"==a||"DecorItem"==a)entityDescriptors["e"+t].loadValue(this,"body_armor_item",o.val,t);else if("potion_contents"==a)null!=o.val.custom_effects&&loadCustomEffectsNBT("Effects"+t,o.val.custom_effects.val),null!=o.val.potion&&$("#Potion"+t).val(extractMinecraftID(o.val.potion.val)),null!=o.val.custom_color&&loadColorIntNBT("Color"+t,o.val.custom_color.val);else if("Potion"==a)entityDescriptors["e"+t].loadPotionNBT(o.val);else if("BeamTarget"==a)entityDescriptors["e"+t].loadBeamTargetNBT(o.val);else if("data"==a)entityDescriptors["e"+t].loadCustomData(o.val);else if("transformation"==a)entityDescriptors["e"+t].loadTransformationData(o.val);else if("attack"==a||"interaction"==a)entityDescriptors["e"+t].loadInteractionPart(a,o.val);else if("brightness"==a)entityDescriptors["e"+t].loadBrightnessData(o.val);else if("PatrolTarget"==a)entityDescriptors["e"+t].loadPatrolTargetNBT(o.val);else if("WanderTarget"==a)entityDescriptors["e"+t].loadWanderTargetNBT(o.val);else if("FlowerPos"==a||"HivePos"==a)entityDescriptors["e"+t].loadFlowerOrHivePos(o.val,a);else if("Owner"==a||"owner"==a)entityDescriptors["e"+t].loadOwnerNBT(o.val);else if("Target"==a)entityDescriptors["e"+t].loadTargetNBT(o.val);else if("Brain"==a)"allay"==entityDescriptors["e"+t].entityType?entityDescriptors["e"+t].loadLikedPlayer(o.val):"warden"==entityDescriptors["e"+t].entityType?entityDescriptors["e"+t].loadWardenDigCooldown(o.val):loadMemories(o.val,t);else if("FireworksItem"==a)if(null!=o.val.components)try{for(var s=o.val.components.val["minecraft:fireworks"].val.explosions.val,i=0;i<s.length;i++)addExplosion("Explosion"+t+"Pane"),loadComponentFireworkExplosion("Explosion"+t+"Pane_exp_"+i,s[i])}catch(e){}else null!=o.val.tag&&null!=o.val.tag.val.Fireworks&&loadFireworksItemNBT("Explosion"+t+"Pane",o.val.tag.val.Fireworks.val);else"BlockState"==a||"block_state"==a||"inBlockState"==a||"carriedBlockState"==a||"DisplayState"==a?entityDescriptors["e"+t].loadBlockStateFallingBlock(o.val):"TileEntityData"==a?entityDescriptors["e"+t].loadFallingBlockEntityData(o.val,this):"Properties"==a?entityDescriptors["e"+t].loadFallingBlockBSProperties(o.val):"abilities"==a?entityDescriptors["e"+t].loadAbilities(this,o.val):"SpawnData"==a?loadSpawnPotentialFromNBT(this,"spawnerMinecart"+t,[o.val],"spawn_data"):this.loadSummonCommand(o.val,t);else if("arrayOfStrings"==o.type||"arrayOfVals"==o.type||"arrayOfCustomName"==o.type)entityDescriptors["e"+t].loadValue(this,a,o.val,t);else if("arrayOfArrays"==o.type){if("Trusted"==a)for(let e=0;e<o.val.length;e++)addFoxTrusts("Trusts",t),loadUUIDArrayNBT("Trusts"+t+"_"+e,o.val[e])}else"arrayOfCompounds"==o.type?"Gossips"==a?loadGossips(o.val,t):"Inventory"==a||"EnderItems"==a?"player"==entityDescriptors["e"+t].entityType?entityDescriptors["e"+t].loadPlayerInventory(this,o.val,t):"piglin"==entityDescriptors["e"+t].entityType?entityDescriptors["e"+t].loadPiglinInventory(this,o.val,t):loadInventory(o.val,t,this):"suspects"==a?entityDescriptors["e"+t].loadSuspects(o.val):"SpawnPotentials"==a?loadSpawnPotentialFromNBT(this,`spawnerMinecart${t}_spawn_potentials`,o.val,"spawn_potential"):entityDescriptors["e"+t].loadValue(this,a,o.val,t):entityDescriptors["e"+t].loadValue(this,a,o.val,t)}}traverseObjectToNBT(e,t){for(var a in e){t+=",";var o=e[a];if(-1!=a.indexOf("minecraft:")&&(a=`"${a}"`),"raw"==o.type)t+=a+":"+o.val;else if("string"==o.type)-1==o.val.indexOf('"')?t+=a+':"'+o.val+'"':t+=a+":'"+o.val+"'";else if("compound"==o.type)t+=a+":{"+this.traverseObjectToNBT(o.val,"")+"}";else if("arrayOfStrings"==o.type){t+=a+":[";let e="";for(var n=0;n<o.val.length;n++)e+=',"'+o.val[n]+'"';t+=e.substr(1)+"]"}else if("arrayOfVals"==o.type){this.isArrayOfInts(o.val)?t+=a+":[I;":t+=a+":[";let e="";for(n=0;n<o.val.length;n++)e+=","+o.val[n];t+=e.substr(1)+"]"}else if("arrayOfCompounds"==o.type){let e="";for(n=0;n<o.val.length;n++)e+=",{"+this.traverseObjectToNBT(o.val[n],"")+"}";t+=a+":["+e.substr(1)+"]"}else if("arrayOfArrays"==o.type){let e="";for(n=0;n<o.val.length;n++)e+=",[I;"+o.val[n]+"]";t+=a+":["+e.substr(1)+"]"}}return t.substr(1)}isArrayOfInts(t){for(let e=0;e<t.length;e++)if(!Number.isInteger(parseInt(t[e],10)))return!1;return!0}traverseObject(e,t){for(var a in this.level++,$("#"+t).append("{"),e){var o=e[a];if("raw"==o.type)$("#"+t).append("<br>"+this.padding()+"<span class='nbtKey'>"+a+"</span>:<span class='nbtVal'>"+o.val+"</span>");else if("string"==o.type)$("#"+t).append("<br>"+this.padding()+"<span class='nbtKey'>"+a+"</span>:<span class='nbtVal'>"+o.val+"</span>");else if("compound"==o.type)$("#"+t).append("<br>"+this.padding()+"<span class='nbtKey'>"+a+"</span>"),this.traverseObject(o.val,t);else if("arrayOfVals"==o.type||"arrayOfStrings"==o.type){$("#"+t).append("<br>"+this.padding()+"<span class='nbtKey'>"+a+"</span>:["),this.level++;for(var n=0;n<o.val.length;n++)$("#"+t).append("<br>"+this.padding()+"<span class='nbtVal'>"+o.val[n]+"</span>");this.level--,$("#"+t).append("<br>"+this.padding()+"]")}else if("arrayOfCompounds"==o.type){$("#"+t).append("<br>"+this.padding()+"<span class='nbtKey'>"+a+"</span>:["),this.level++;for(n=0;n<o.val.length;n++)this.traverseObject(o.val[n],t);this.level--,$("#"+t).append("<br>"+this.padding()+"]")}}this.level--,$("#"+t).append("<br>"+this.padding()+"}")}parseCompoundStringToJSObject(e){var t=0,a={};if(null==e)return{};do{if(t++,t=this.skipSpaces(t,e),'"'==e.charAt(t)?(t++,m=this.getStringToNextSymbol('"',e,t),t++):m=this.getStringToNextSymbol(":}",e,t),t+=m.length,m.length){var o=m.trim();if(t++,t=this.skipSpaces(t,e),"{"==e.charAt(t))t+=(n=extractSegment("{","}",t,e)).length,s=this.parseCompoundStringToJSObject(n),this.getStringToNextSymbol(",",e,t),a[o]=s;else if("["==e.charAt(t)){var n,s=[];if(t+=(m=replaceAll("}, {","},{",m=extractSegment("[","]",t,e))).length,"loot_table"!=currentCommand||"messages"!=o&&"CustomName"!=o)if("{"==m.charAt(1)){for(var i,l=1;l+=(i=extractSegment("{","}",l,m)).length,s.push(this.parseCompoundStringToJSObject(i)),","==m.charAt(l)&&l++,"{"==m.charAt(l););a[o]=s}else if('"'==m.charAt(1)){for(var l=1,r=[];"]"!=m.charAt(l)&&l<m.length;)","==m.charAt(l)&&l++,l+=(s=this.getStringToNextSymbolInsideString(",}",m,l)).length,""!=s.substr(1,s.length-2)&&r.push(s.substr(1,s.length-2));a[o]=r}else if("'"==m.charAt(1)){n=(n=replaceAll("', '","','",n=extractSegment("[","]",l=1,m))).split("','");for(var c=0;c<n.length;c++)0==c&&(n[c]=n[c].substr(1)),c==n.length-1&&(n[c]=n[c].slice(0,-2)),n[c]=n[c].replace(/\\'/g,"'").replace(/"/g,'\\"');a[o]=n}else if("["==m.charAt(1)){var p,l=1,d=[];do{l+=(p=extractSegment("[","]",l,m)).length;let e=p.substr(1,p.length-2).trim();"I"==e.charAt(0)&&";"==e.charAt(1)&&(e=e.substr(2)),d.push(e.split(",")),","==m.charAt(l)&&l++}while("["==m.charAt(l));a[o]=d}else{var m,_=(m="I"==(m=m.substr(1,m.length-2).trim()).charAt(0)&&";"==m.charAt(1)?m.substr(2):m).split(",").map(function(e){return parseInt(e,10)});a[o]=_}else try{s=JSON.parse(m.replace(/([a-zA-Z0-9_]+):/g,'"$1":').replace(/0b/g,"'0b'").replace(/1b/g,"'1b'").replace(/'/g,'"')),a[o]=s}catch(e){0}}else'"'==e.charAt(t)?(s=this.getStringToNextSymbolInsideString(",}",e,t),a[o]=s.substring(1,s.lastIndexOf('"')),t+=s.length):"'"==e.charAt(t)?(s=this.getStringToNextSymbolInsideString_SingleQuoteSurounds(",}",e,t),a[o]=s.substring(s.indexOf("'")+1,s.lastIndexOf("'")),t+=s.length):(t+=(s=this.getStringToNextSymbol(",}",e,t)).length,"true"==s||"false"==s?a[o]=s:"0b"==s?a[o]=!1:"1b"==s?a[o]=!0:isNaN(s)||isNaN(parseFloat(s))?a[o]=s:-1==s.indexOf(".")?a[o]=parseInt(s):a[o]=parseFloat(s))}}while("}"!=e.charAt(t)&&t<e.length);return a}parseCompound(e){var a,o,n,s=0,i={};if(null==e)return{};do{if(s++,s=this.skipSpaces(s,e),'"'==e.charAt(s)?(s++,o=this.getStringToNextSymbol('"',e,s),s++):o=this.getStringToNextSymbol(":}",e,s),s+=o.length,o.length){a=o.trim();let t;if(s++,s=this.skipSpaces(s,e),"{"==e.charAt(s))if(s+=(n=extractSegment("{","}",s,e)).length,"CustomName"==a)try{t=JSON.parse(n.replace(/'/g,'"')),i[a]={type:"arrayOfCustomName",val:t}}catch(e){}else p=this.parseCompound(n),this.getStringToNextSymbol(",",e,s),i[a]={type:"compound",val:p};else if("["==e.charAt(s)){if(p=[],s+=(o=extractSegment("[","]",s,e)).length,o=replaceAll("}, {","},{",o),"messages"==a||"CustomName"==a)try{t=JSON.parse(o.replace(/0b/g,"'0b'").replace(/1b/g,"'1b'").replace(/'/g,'"'))}catch(e){t=null}else if("pages"==a)try{t=JSON.parse(o)}catch(e){t=null}else if(-1!=a.indexOf("lore"))try{t=JSON.parse(o);for(let e=0;e<t.length;e++)try{t[e]=JSON.parse(t[e])}catch(e){}}catch(e){t=null}if(-1!=a.indexOf("lore")&&null!=t)i[a]={type:"arrayOfLore",val:t},i.preParsed=!0;else if("pages"==a&&null!=t)i[a]={type:"arrayOfPages",val:t},i.preParsed=!0;else if("CustomName"==a&&null!=t)i[a]={type:"arrayOfCustomName",val:t};else if("messages"==a&&null!=t)i[a]={type:"arrayOfSignLines",val:t};else if("{"==o.charAt(1)){for(var l,r=1;r+=(l=extractSegment("{","}",r,o)).length,p.push(this.parseCompound(l)),","==o.charAt(r)&&r++,"{"==o.charAt(r););i[a]={type:"arrayOfCompounds",val:p}}else if('"'==o.charAt(1)){for(var r=1,c=[],p="dummy";"]"!=o.charAt(r)&&0<p.length;)","==o.charAt(r)&&r++,r+=(p=this.getStringToNextSymbolInsideString(",}",o,r)).length,""!=p.substr(1,p.length-2)&&c.push(p.substr(1,p.length-2));try{t=JSON.parse(o.replace(/([a-zA-Z0-9_]+):/g,'"$1":').replace(/0b/g,"'0b'").replace(/1b/g,"'1b'").replace(/'/g,'"')),i[a]={type:"arrayOfStrings",val:c,jsObject:t}}catch(e){i[a]={type:"arrayOfStrings",val:c}}}else if("'"==o.charAt(1)){n=(n=replaceAll("', '","','",n=extractSegment("[","]",r=1,o))).split("','");for(var d=0;d<n.length;d++)0==d&&(n[d]=n[d].substr(1)),d==n.length-1&&(n[d]=n[d].slice(0,-2)),n[d]=n[d].replace(/\\'/g,"'").replace(/"/g,'\\"');i[a]={type:"arrayOfStrings",val:n}}else if("["==o.charAt(1)){var m,r=1,_=[];do{r+=(m=extractSegment("[","]",r,o)).length;let e=m.substr(1,m.length-2).trim();"I"==e.charAt(0)&&";"==e.charAt(1)&&(e=e.substr(2)),_.push(e.split(",")),","==o.charAt(r)&&r++}while("["==o.charAt(r));i[a]={type:"arrayOfArrays",val:_}}else"I"==(o=o.substr(1,o.length-2).trim()).charAt(0)&&";"==o.charAt(1)&&(o=o.substr(2)),i[a]={type:"arrayOfVals",val:o.split(",")}}else'"'==e.charAt(s)?(p=this.getStringToNextSymbolInsideString(",}",e,s),i[a]={type:"string",val:p.substr(1,p.length-2)},s+=p.length):"'"==e.charAt(s)?(p=this.getStringToNextSymbolInsideString_SingleQuoteSurounds(",}",e,s),i[a]={type:"string",val:p.substr(1,p.length-2)},s+=p.length):(s+=(p=this.getStringToNextSymbol(",}",e,s)).length,i[a]={type:"raw",val:p})}}while("}"!=e.charAt(s)&&s<e.length);return i}skipSpaces(e,t){for(;e<t.length&&" "==t.charAt(e);)e++;return e}getStringToNextSymbolInsideString(e,t,a){for(var o=!0,n="";a<t.length&&o;)n+=t.charAt(a),'"'==t.charAt(++a)&&"\\"!=t.charAt(a-1)&&(o=!1,n+=t.charAt(a));return this.getStringToNextSymbol(e,t,a),n}getStringToNextSymbolInsideString_SingleQuoteSurounds(e,t,a){for(var o=!0,n="";a<t.length&&o;)n+=t.charAt(a),"'"==t.charAt(++a)&&"\\"!=t.charAt(a-1)&&(o=!1,n+=t.charAt(a));return this.getStringToNextSymbol(e,t,a),n}getStringToNextSymbol(e,t,a){for(;","==t.charAt(a)||"{"==t.charAt(a);)a++;for(var o="";a<t.length&&-1==e.indexOf(t.charAt(a));)o+=t.charAt(a),a++;return o}}function extractSegment(e,t,a,o){var n=1,s=e;for(a+=1;0!=n&&a<o.length;a++)o.charAt(a)==e?n++:o.charAt(a)==t&&n--,s+=o.charAt(a);return s}class Entity{constructor(e,t){this.stackPos=e,this.entityType=t,this.passengersAllowed=!0,this.entityNBT={MotionX:{type:"text",format:"special",tip:"entity.Motion"},MotionY:{type:"text",format:"special",tip:"entity.Motion"},MotionZ:{type:"text",format:"special",tip:"entity.Motion"},Yaw:{type:"text",format:"special",tip:"entity"},Pitch:{type:"text",format:"special",tip:"entity"},Fire:{type:"ticks",tip:"entity"},HasVisualFire:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},Air:{type:"ticks",tip:"axolotl"==t?"axolotl":"entity"},OnGround:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},NoGravity:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},Silent:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},Invulnerable:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},Glowing:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},UUID:{type:"UUIDArray",format:"intArray",align:"R",tip:"entity"},CustomNameVisible:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},CustomName:{type:"customNameJSON",format:"special",tip:"entity"},data:{type:"text",format:"special",fwClass:"verybigTF",tip:"entity.data"},Tags:{type:"text",format:"special",tip:"entity",fwClass:"bigTF"}}}addSpawnPotentialFields(e){this.spNBT={PosX:{type:"text",label:"Pos X",format:"special",tip:"entity.Pos"},PosY:{type:"text",label:"Pos Y",format:"special"},PosZ:{type:"text",label:"Pos Z",format:"special"},Weight:{type:"text",format:"special",tip:"entity"},panelCSR:{panelID:"csr"+e,type:"panel",htmlContent:"<br>Custom Spawn Rules",tip:"spawner.custom_spawn_rules"},min_sky_light_limit:{label:"Min Sky Light Limit",type:"text",format:"special",tip:"spawner.sky_light_limit"},max_sky_light_limit:{label:"Max Sky Light Limit",type:"text",format:"special",tip:"spawner.sky_light_limit"},min_block_light_limit:{label:"Min Block Light Limit",type:"text",format:"special",tip:"spawner.block_light_limit"},max_block_light_limit:{label:"Max Block Light Limit",type:"text",format:"special",tip:"spawner.block_light_limit"},panelSDC:{panelID:"sdc"+e,type:"panel",htmlContent:"<br>Equipment and Slot Drop Chances",tip:"spawner.slot_drop_chance"},equip_loot:{label:"Equipment Loot Table",type:"text",format:"special",fwClass:"bigTF",tip:"spawner.equipment_loot_table"}};for(const t of slots)this.spNBT[t+"_sdc"]={label:t,type:"text",format:"special",tip:"spawner.slot_"+t};Object.assign(this.entityNBT,this.spNBT)}loadCustomData(e){$("#data"+this.stackPos).val(compoundToNBTString(e))}getCustomDataNBT(){return $("#data"+this.stackPos).val().length?",data:"+$("#data"+this.stackPos).val():""}getEntityNBT(){var e,t="";for(e in this.entityNBT)t+=getNBTforKey(e,this.entityNBT[e],this.stackPos);return t=(t=(t=(t=(t+=getMotion(this.stackPos,"Motion")+getRotation(this.stackPos))+getTargetingTags(this.stackPos))+getPassengersNBT(this.stackPos))+getCustomNameAndColor("#CustomName",this.stackPos))+this.getCustomDataNBT()}loadBlockStateFallingBlock(e){if(null!=e.Name&&($("#block"+this.stackPos).val(extractMinecraftID(e.Name.val)),$("#block"+this.stackPos).trigger("change")),null!=e.Properties)for(var t in e.Properties.val)$("#"+t+"BS"+this.stackPos).val(e.Properties.val[t].val)}generateForm(){for(var e in"entitydata"!=currentCommand&&"data merge entity"!=currentCommand&&this.passengersAllowed&&(this.entityNBT.Passengers={type:"passenger",format:"special",tip:"entity",cssClass:"dummy",align:"B"}),this.entityNBT)createComponent("entityPane"+this.stackPos,e,this.entityNBT[e],this.stackPos)}loadOwnerNBT(e){"evoker_fangs"==this.entityType||"llama_spit"==this.entityType?convertLeastMostToArray("Owner"+this.stackPos,parseInt(e.OwnerUUIDLeast.val),parseInt(e.OwnerUUIDMost.val)):null!=e.L&&null!=e.M&&convertLeastMostToArray("Owner"+this.stackPos,parseInt(e.L.val),parseInt(e.M.val))}loadTargetNBT(e){null!=e.L&&null!=e.M&&convertLeastMostToArray("Target"+this.stackPos,parseInt(e.L.val),parseInt(e.M.val))}loadValue(e,t,a,o){if(null==this.entityNBT[t])switch(t){case"HandItems":case"ArmorItems":for(var n="HandItems"==t?["mainhand","offhand"]:["feet","legs","chest","head"],s=0;s<a.length;s++)setupItemSlotForNBT(n[s]+o,a[s],e);break;case"body_armor_item":setupItemSlotForNBT("body"+o,a,e);break;case"Saddle":setupItemSlotForNBT("saddle"+o,{id:{val:"saddle"}},e);break;case"body_armor_drop_chance":cachedNBT.dropChance["body"+o]=parseFloat(a),null!=cachedNBT.dropChance["body"+o]&&""!=cachedNBT.dropChance["body"+o]?$("#body"+o+"dropChancePart").html("Drop Chance="+cachedNBT.dropChance["body"+o]):$("#body"+o+"dropChancePart").html(""),$("#body"+o+"DropChance").val(parseFloat(a));break;case"HandDropChances":case"ArmorDropChances":for(n="HandDropChances"==t?["mainhand","offhand"]:["feet","legs","chest","head"],s=0;s<a.length;s++)cachedNBT.dropChance[n[s]+o]=parseFloat(a[s]),null!=cachedNBT.dropChance[n[s]+o]&&""!=cachedNBT.dropChance[n[s]+o]?$("#"+n[s]+o+"dropChancePart").html("Drop Chance="+cachedNBT.dropChance[n[s]+o]):$("#"+n[s]+o+"dropChancePart").html(""),$("#"+n[s]+o+"DropChance").val(parseFloat(a[s]));break;case"Items":for(s=0;s<a.length;s++)setupItemSlotForNBT(replaceAll("b","",a[s].Slot.val)+"Slot"+o,a[s],e);break;case"Size":$("#size"+o).val(a);break;case"HasEgg":$("#has_egg"+o).val(parseInt(a));break;case"LifeTicks":$("#life_ticks"+o).val(parseInt(a));break;case"Motion":case"power":case"sleeping_pos":$("#SleepingX"+o).val(a[0]),$("#SleepingY"+o).val(a[1]),$("#SleepingZ"+o).val(a[2]);break;case"bound_pos":$("#BoundX"+o).val(a[0]),$("#BoundY"+o).val(a[1]),$("#BoundZ"+o).val(a[2]);break;case"anchor_pos":$("#AX"+o).val(a[0]),$("#AY"+o).val(a[1]),$("#AZ"+o).val(a[2]);break;case"Pos":$("#"+t+"X"+o).val(parseFloat(a[0])),$("#"+t+"Y"+o).val(parseFloat(a[1])),$("#"+t+"Z"+o).val(parseFloat(a[2]));break;case"FallDistance":$("#fall_distance"+o).val(parseFloat(a));break;case"Rotation":$("#Yaw"+o).val(parseFloat(a[0])),$("#Pitch"+o).val(parseFloat(a[1]));break;case"DisabledSlots":this.loadDisabledSlotsNBT(a);break;case"Attributes":for(s=0;s<a.length;s++){var i=(i=a[s].Name.val).substr(i.indexOf(".")+1);$("#attrib_"+i+o).val(parseFloat(a[s].Base.val))}break;case"attributes":for(s=0;s<a.length;s++){var l=(l=extractMinecraftID(a[s].id.val)).substr(l.indexOf(".")+1);$("#attrib_"+l+o).val(parseFloat(a[s].base.val))}break;case"OwnerUUID":convertHexUUIDToArray("Owner"+o,a);break;case"UUIDMost":convertMostToArray("UUID"+o,a);break;case"UUIDLeast":convertLeastToArray("UUID"+o,a);break;case"OwnerUUIDMost":convertMostToArray("Owner"+o,a);break;case"OwnerUUIDLeast":convertLeastToArray("Owner"+o,a);break;case"ConversionPlayerMost":convertMostToArray("ConversionPlayer"+o,a);break;case"ConversionPlayerLeast":convertLeastToArray("ConversionPlayer"+o,a);break;case"LoveCauseMost":convertMostToArray("LoveCause"+o,a);break;case"LoveCauseLeast":convertLeastToArray("LoveCause"+o,a);break;case"leash":this.load_leash_NBT(a);break;case"flower_pos":case"hive_pos":this.load_flower_pos_Or_hive_pos(a,t);break;case"home_pos":this.load_home_pos(a);break;case"beam_target":this.loadBeamTargetNBT(a);break;case"patrol_target":this.loadPatrolTargetNBT(a);break;case"wander_target":this.loadWanderTargetNBT(a);break;case"Particle":this.loadParticleAndOptions(a);break;case"effects":loadCustomEffectsNBT("Effects"+o,a);break;case"custom_potion_effects":case"Potion":case"Color":"tipped_arrow"!=$("#Item"+o).val()&&($("#Item"+o).val("tipped_arrow"),$("#Item"+o).trigger("change")),"custom_potion_effects"==t?loadCustomEffectsNBT(`Item${o}CustomPotionEffects`,a):"Potion"==t?$(`#Item${o}Potion`).val(extractMinecraftID(a)):"Color"==t&&loadColorIntNBT(`Item${o}CustomPotionColor`,a);break;case"active_effects":loadCustomEffectsNBT("ActiveEffects"+o,a);break;case"Fuse":this.loadOldFuse(a);break;case"transformation":this.loadTransformationArray(a);break;default:return void(-1!=["SpawnCount","SpawnRange","Delay","MinSpawnDelay","MaxSpawnDelay","MaxNearbyEntities","RequiredPlayerRange"].indexOf(t)&&$("#spawnerMinecart"+o+t).val(parseInt(a)))}else if($("#"+t+o).length)if("text"==this.entityNBT[t].type||"choice"==this.entityNBT[t].type||"makeSelect"==this.entityNBT[t].type||"makeSelectWithIndexAndValues"==this.entityNBT[t].type||"makeSelectWithIndexes"==this.entityNBT[t].type){if("string"==this.entityNBT[t].format)"Potion"==t?$("#"+t+o).val(extractMinecraftID(a)):$("#"+t+o).val(a.replace(/\\"/g,'"').replace(/\\\\\\"/g,'\\"').replace(/\\'/g,"'"));else if("b"==this.entityNBT[t].format||"short"==this.entityNBT[t].format||"long"==this.entityNBT[t].format||"int"==this.entityNBT[t].format){var r=parseInt(a);"text"!=this.entityNBT[t].type&&!$("#"+t+o+" option[value='"+r+"']").length||$("#"+t+o).val(r)}else if("f"==this.entityNBT[t].format||"d"==this.entityNBT[t].format)$("#"+t+o).val(parseFloat(a));else if("special"==this.entityNBT[t].format)if("Tags"==t){for(var c="",s=0;s<a.length;s++)c+=","+a[s];$("#Tags"+o).val(c.substr(1))}else"Variant"==t?this.loadVariantNBT(a):"HomePosX"==t||"HomePosY"==t||"HomePosZ"==t||"BoundX"==t||"BoundY"==t||"BoundZ"==t||"SleepingX"==t||"SleepingY"==t||"SleepingZ"==t||"AX"==t||"AY"==t||"AZ"==t||"SpawnX"==t||"SpawnY"==t||"SpawnZ"==t?$("#"+t+o).val(a):"Dimension"==t?$("#Dimension"+o).val(extractMinecraftID(a)):"SpawnDimension"==t?$("#SpawnDimension"+o).val(extractMinecraftID(a)):"SpawnAngle"==t?$("#SpawnAngle"+o).val(parseFloat(a)):"SpawnForced"==t?$("#SpawnForced"+o).val("1b"==a?1:0):"variant"==t?$("#variant"+o).val(extractMinecraftID(a)):"SoundEvent"==t?$("#SoundEvent"+o).val(a):"Potion"==t&&$("#Potion"+o).val(extractMinecraftID(a))}else"ticks"==this.entityNBT[t].type&&$("#"+t+o).val(a);else if("glow_color_override"==t)loadColorIntNBT(t+o,a);else if("background"==t)this.loadTextDisplayBackground(a);else if("CustomName"!=t&&"text"!=t||"customNameJSON"!=this.entityNBT[t].type)if("Passengers"==t)for(s=0;s<a.length;s++){addPassenger("Passengers"+o+"Pane");var p=a[s],d=extractMinecraftID(p.id.val);if($("#entity"+entityIndex+" option[value='"+d+"']").length)$("#entity"+entityIndex).val(d),$("#entity"+entityIndex).trigger("change"),e.loadSummonCommand(p,entityIndex);else{let e=!1;if("potion"==d?($("#entity"+entityIndex).val("splash_potion"),$("#entity"+entityIndex).trigger("change"),e=!0):-1!=d.indexOf("boat")&&null!=p.Type&&(p=p.Type.val+"_"+d,$("#entity"+entityIndex+" option[value='"+p+"']").length)&&($("#entity"+entityIndex).val(p),$("#entity"+entityIndex).trigger("change"),e=!0),!e)throw new MCSException(d+" is not a valid entity id")}}else"stew_effects"==t?loadStewEffectsNBT(t+o,a):"ActiveEffects"==t||"Effects"==t||"CustomPotionEffects"==t?loadCustomEffectsNBT(t+o,a):"Color"==t&&"colorChooser"==this.entityNBT[t].type?loadColorIntNBT(t+o,a):"AngryAt"==t?(Array.isArray(a)?loadUUIDArrayNBT:convertHexUUIDToArray)(t+o,a):"UUIDArray"==this.entityNBT[t].type&&loadUUIDArrayNBT(t+o,a);else{var m;deferOutput=deferJSONOutput=!0;try{m="object"==typeof a?a:JSON.parse(JSON.parse('"'+a+'"'))}catch(e){try{m=JSON.parse(JSON.parse('"'+a.replace(/"/g,'\\"').replace(/\\'/g,"'")+'"'))}catch(e){m=a}}importTellrawJSON(t+o,m),showHide(t+o+"EntityName",t+o+"EntityNameSH"),deferOutput=deferJSONOutput=!1,tellrawPreview(t+o)}}}function loadUUIDArrayNBT(t,a){for(let e=0;e<4;e++)$("#"+t+e).val(a[e])}function loadCustomEffectsNBT(a,o,e){showHide(a+"Pane",a+"SH");for(var n,s=0;s<o.length;s++){let t;if(null!=e&&null!=o[s].effect?(n=extractMinecraftID(o[s].effect.val.id.val),t=addEffectFromUIorImport(a,n,"hasProbability"),$("#"+a+"Prob_"+t).val(parseFloat(o[s].probability.val)),o[s]=o[s].effect.val):(n=extractMinecraftID((null!=o[s].id?o[s].id:o[s].Id).val),t=addEffectFromUIorImport(a,n)),null!=o[s].id){let e=!1;null!=o[s].amplifier&&($("#"+a+"Amp_"+t).val(parseInt(o[s].amplifier.val)),e=!0),null!=o[s].duration&&($("#"+a+"Ticks_"+t).val(parseInt(o[s].duration.val)),e=!0),null!=o[s].show_particles&&$("#"+a+"ShowParticles_"+t).val(o[s].show_particles.val),null!=o[s].show_icon&&$("#"+a+"ShowIcon_"+t).val(o[s].show_icon.val),null!=o[s].ambient&&$("#"+a+"ambient_"+t).val(o[s].ambient.val),e||"execute if entity"!=currentCommand||$("#"+a+"Detect_"+t).prop("checked",!0)}else if(null!=o[s].Id){let e=!1;null!=o[s].Amplifier&&($("#"+a+"Amp_"+t).val(parseInt(o[s].Amplifier.val)),e=!0),null!=o[s].Duration&&($("#"+a+"Ticks_"+t).val(parseInt(o[s].Duration.val)),e=!0),null!=o[s].ShowParticles&&$("#"+a+"ShowParticles_"+t).val(o[s].ShowParticles.val),null!=o[s].Ambient&&$("#"+a+"ambient_"+t).val(o[s].Ambient.val),e||"execute if entity"!=currentCommand||$("#"+a+"Detect_"+t).prop("checked",!0)}}}function loadStewEffectsNBT(e,t){for(var a,o=0;o<t.length;o++)null!=t[o].id?(addStewEffectFromUIorImport(e,a=extractMinecraftID(t[o].id.val)),null!=t[o].duration&&$("#"+e+"Ticks_"+a).val(parseInt(t[o].duration.val))):null!=t[o].EffectId&&(addStewEffectFromUIorImport(e,a=parseInt(t[o].EffectId.val)),null!=t[o].EffectDuration)&&$("#"+e+"Ticks_"+a).val(parseInt(t[o].EffectDuration.val));show(e+"Pane",e+"SH")}class Mob extends Entity{constructor(e,t,a){super(e,t),this.mobNBT={fall_distance:{type:"text",format:"f",tip:"mob",align:"R"},PortalCooldown:{type:"ticks",tip:"mob",align:"R"},HurtTime:{type:"ticks",tip:"mob",align:"R"},DeathTime:{type:"ticks",tip:"mob",align:"R"},DeathLootTable:{type:"text",format:"string",tip:"mob",align:"R"},LeftHanded:{type:"choice",values:unsetTrueFalse,format:"b",tip:"mob",align:"R"},Team:{type:"text",format:"string",tip:"mob",align:"R"},Leash:{label:"Leashed To",type:"UUIDArray",format:"special",align:"R",tip:"mob"},LeashedToPostX:{type:"text",format:"special",tip:"mob",align:"R"},LeashedToPostY:{type:"text",format:"special",tip:"mob",align:"R"},LeashedToPostZ:{type:"text",format:"special",tip:"mob",align:"R"},FallFlying:{type:"choice",values:unsetTrueFalse,format:"b",tip:"mob",align:"R"},ActiveEffects:{type:"statusEffects",format:"special",tip:"mob",align:"R"},PersistenceRequired:{type:"choice",values:unsetTrueFalse,format:"b",tip:"mob",align:"R"},NoAI:{type:"choice",values:unsetTrueFalse,format:"b",tip:"mob",align:"R"},CanPickUpLoot:{type:"choice",values:unsetTrueFalse,format:"b",tip:"mob",align:"R"},mainhand:{type:"itemselect",format:"special",doDropChance:!0,hide:!0,tip:"mob.mainhand",align:"R"},offhand:{type:"itemselect",format:"special",doDropChance:!0,hide:!0,tip:"mob.offhand",align:"R"},head:{type:"itemselect",format:"special",doDropChance:!0,hide:!0,tip:"mob.head",align:"R"},chest:{type:"itemselect",format:"special",doDropChance:!0,hide:!0,tip:"mob.chest",align:"R"},legs:{type:"itemselect",format:"special",doDropChance:!0,hide:!0,tip:"mob.legs",align:"R"},feet:{type:"itemselect",format:"special",doDropChance:!0,hide:!0,tip:"mob.feet",align:"R"},body:{type:"itemselect",format:"special",doDropChance:!0,hide:!0,tip:"mob.body",align:"R"},saddle:{type:"itemselect",format:"special",doDropChance:!0,hide:!0,tip:"mob.saddle",align:"R"},AbsorptionAmount:{type:"text",format:"f",tip:"mob",align:"R"},Health:{type:"text",format:"f",tip:"mob",align:"R"},SleepingX:{type:"text",format:"special",tip:"mob.sleeping",align:"R"},SleepingY:{type:"text",format:"special",tip:"mob.sleeping",align:"R"},SleepingZ:{type:"text",format:"special",tip:"mob.sleeping",align:"R"}};for(var o=0;o<attributeModifiers116.length;o++)"generic"==getAttributeType(attributeModifiers116[o])&&(this.mobNBT["attrib_"+attributeModifiers116[o]]={label:attributeModifiers116[o],type:"text",format:"special",tip:"mob."+attributeModifiers116[o],align:"R"});"zombie"==this.entityType||"husk"==this.entityType||"drowned"==this.entityType?this.mobNBT.attrib_spawn_reinforcements={label:"spawn_reinforcements",type:"text",format:"special",tip:"mob.spawn_reinforcements",align:"R"}:"parrot"!=this.entityType&&"bee"!=this.entityType&&"wither"!=this.entityType||(this.mobNBT.attrib_flying_speed={label:"flying_speed",type:"text",format:"special",tip:"mob.flying_speed",align:"R"}),null!=a&&Object.assign(this.mobNBT,a)}load_leash_NBT(e){Array.isArray(e)&&3==e.length?($("#LeashedToPostX"+this.stackPos).val(parseInt(e[0])),$("#LeashedToPostY"+this.stackPos).val(parseInt(e[1])),$("#LeashedToPostZ"+this.stackPos).val(parseInt(e[2]))):null!=e.UUID?($("#Leash"+this.stackPos+0).val(e.UUID.val[0]),$("#Leash"+this.stackPos+1).val(e.UUID.val[1]),$("#Leash"+this.stackPos+2).val(e.UUID.val[2]),$("#Leash"+this.stackPos+3).val(e.UUID.val[3])):null!=e.UUIDLeast&&null!=e.UUIDMost&&convertLeastMostToArray("Leash"+this.stackPos,parseInt(e.UUIDLeast.val),parseInt(e.UUIDMost.val))}loadLeashNBT(e){null!=e.UUIDLeast&&null!=e.UUIDMost?convertLeastMostToArray("Leash"+this.stackPos,parseInt(e.UUIDLeast.val),parseInt(e.UUIDMost.val)):null!=e.X&&null!=e.Y&&null!=e.Z&&($("#LeashedToPostX"+this.stackPos).val(parseInt(e.X.val)),$("#LeashedToPostY"+this.stackPos).val(parseInt(e.Y.val)),$("#LeashedToPostZ"+this.stackPos).val(parseInt(e.Z.val)))}getEntitySpecificCommand(e){return this.getMobNBT()}getMobNBT(){return super.getEntityNBT()+getHandAndArmorItems(this.stackPos)+getStatusEffectsNBT("active_effects","ActiveEffects"+this.stackPos)+this.getMobAttributes()+this.getLeashedTo()+getTargetCompoundWithKey(this.stackPos,"Sleeping","sleeping_pos")}generateForm(){Object.assign(this.entityNBT,this.mobNBT),super.generateForm()}getLeashedTo(){return $("#Leash"+this.stackPos+0).val()&&$("#Leash"+this.stackPos+1).val()&&$("#Leash"+this.stackPos+2).val()&&$("#Leash"+this.stackPos+3).val()?",leash:{UUID:[I;"+$("#Leash"+this.stackPos+0).val()+","+$("#Leash"+this.stackPos+1).val()+","+$("#Leash"+this.stackPos+2).val()+","+$("#Leash"+this.stackPos+3).val()+"]}":$("#LeashedToPostX"+this.stackPos).val().length&&$("#LeashedToPostY"+this.stackPos).val().length&&$("#LeashedToPostZ"+this.stackPos).val().length?",leash:[I;"+$("#LeashedToPostX"+this.stackPos).val()+","+$("#LeashedToPostY"+this.stackPos).val()+","+$("#LeashedToPostZ"+this.stackPos).val()+"]":""}getMobAttributes(){for(var e="",t=0;t<attributeModifiers116.length;t++)"generic"==getAttributeType(attributeModifiers116[t])&&0<$("#attrib_"+attributeModifiers116[t]+this.stackPos).val().length&&(e+=`,{id:"minecraft:${attributeModifiers116[t]}",base:${$("#attrib_"+attributeModifiers116[t]+this.stackPos).val()}}`);return"zombie"!=this.entityType&&"husk"!=this.entityType&&"drowned"!=this.entityType||!$("#attrib_spawn_reinforcements"+this.stackPos).val().length?"parrot"!=this.entityType&&"bee"!=this.entityType&&"wither"!=this.entityType||!$("#attrib_flying_speed"+this.stackPos).val().length||(e+=`,{id:"minecraft:flying_speed",base:${$("#attrib_flying_speed"+this.stackPos).val()}}`):e+=`,{id:"minecraft:spawn_reinforcements",base:${$("#attrib_spawn_reinforcements"+this.stackPos).val()}}`,e.length?",attributes:["+e.substring(1)+"]":e}}class SimpleEntity extends Entity{constructor(e,t,a){super(e,t),this.entityNBT={MotionX:{type:"text",format:"special",tip:"entity.Motion"},MotionY:{type:"text",format:"special",tip:"entity.Motion"},MotionZ:{type:"text",format:"special",tip:"entity.Motion"},Yaw:{type:"text",format:"special",tip:"entity"},Pitch:{type:"text",format:"special",tip:"entity"},NoGravity:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},Silent:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},Fire:{type:"ticks",tip:"entity"},HasVisualFire:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},Glowing:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},UUID:{type:"UUIDArray",format:"intArray",align:"R",tip:"entity"},CustomName:{type:"customNameJSON",format:"special",tip:"entity"},CustomNameVisible:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},data:{type:"text",format:"special",fwClass:"verybigTF",tip:"entity.data"},Tags:{type:"text",format:"special",tip:"entity",fwClass:"bigTF"}},null!=a&&Object.assign(this.entityNBT,a)}getEntityNBT(){var e,t="";for(e in this.entityNBT)t+=getNBTforKey(e,this.entityNBT[e],this.stackPos);return t=(t=(t=(t=(t+=getMotion(this.stackPos,"Motion")+getRotation(this.stackPos))+getTargetingTags(this.stackPos))+getPassengersNBT(this.stackPos))+getCustomNameAndColor("#CustomName",this.stackPos))+this.getCustomDataNBT()}getEntitySpecificCommand(e){return this.getEntityNBT()}generateForm(){super.generateForm()}}class falling_block extends SimpleEntity{constructor(e,t){super(e,t),delete this.entityNBT.CustomName,delete this.entityNBT.CustomNameVisible,Object.assign(this.entityNBT,{Time:{type:"ticks",value:"1",tip:t,align:"R"},DropItem:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"},CancelDrop:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"},HurtEntities:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"},FallHurtMax:{type:"text",format:"int",tip:t,align:"R"},fall_distance:{type:"text",format:"f",tip:"mob",align:"R"},FallHurtAmount:{type:"text",format:"f",tip:t,align:"R"}})}generateForm(){var e,t="<br><span class='fLabel200'>Block</span>";for(e in t+="<select id='block"+this.stackPos+"' onchange='javascript:fallingBlockChange("+this.stackPos+");'>",itemsAndBlocks)"i"!=itemsAndBlocks[e].c&&(t+="<option value='"+e+"'>"+itemsAndBlocks[e].d+"</option>");t+="</select><input type='text' id='block_filter"+this.stackPos+"' placeholder='Filter' class='medTF' onkeyup=\"updateFallingBlockOptions('block',"+this.stackPos+")\"><div id='blockSpec"+this.stackPos+"'></div>",super.generateForm(),$("#entityPane"+this.stackPos+"R").append(t)}getEntitySpecificCommand(e){var t="";if(-1!=$("#block"+e).val()){if(t=',BlockState:{Name:"minecraft:'+$("#block"+e).val()+'"',$("#block"+e).val()in blockStates){var a,o="";for(a in blockStates[$("#block"+e).val()])"unset"!=$("#"+a+"BS"+e).val()&&(o+=","+a+':"'+$("#"+a+"BS"+e).val()+'"');0!=o.length&&(t+=",Properties:{"+o.substr(1)+"}")}t+="}";var n=blocks[e].getBlockNBT(e);n.length&&(t+=",TileEntityData:"+n)}for(a in this.entityNBT)t+=getNBTforKey(a,this.entityNBT[a],e);return t=(t=(t+=getMotion(e,"Motion"))+getTargetingTags(e))+getPassengersNBT(e)}loadFallingBlockEntityData(e,t){t.loadBlockDataFromNBT(blocks[this.stackPos].bType,this.stackPos,e)}}class tnt extends SimpleEntity{constructor(e,t){super(e,t),Object.assign(this.entityNBT,{fuse:{type:"ticks",tip:"tnt.Fuse",align:"R"},explosion_power:{type:"text",format:"short",tip:"tnt.explosion_power",align:"R"}})}loadOldFuse(e){$("#fuse"+this.stackPos).val(e)}generateForm(){var e,t="<br><span class='fLabel200'>Render Block</span>";for(e in t+="<select id='block"+this.stackPos+"' onchange='javascript:fallingBlockChange("+this.stackPos+");'>",itemsAndBlocks)"i"!=itemsAndBlocks[e].c&&(t+="<option value='"+e+"'>"+itemsAndBlocks[e].d+"</option>");t+="</select><input type='text' id='block_filter"+this.stackPos+"' placeholder='Filter' class='medTF' onkeyup=\"updateFallingBlockOptions('block',"+this.stackPos+')">'+makeTip("tnt.block_state")+"<span id='blockSpec"+this.stackPos+"'></span>",super.generateForm(),$("#entityPane"+this.stackPos+"R").append(t)}getEntitySpecificCommand(e){var t="";if(-1!=$("#block"+e).val()){if(t=',block_state:{Name:"minecraft:'+$("#block"+e).val()+'"',$("#block"+e).val()in blockStates){var a,o="";for(a in blockStates[$("#block"+e).val()])"unset"!=$("#"+a+"BS"+e).val()&&(o+=","+a+':"'+$("#"+a+"BS"+e).val()+'"');0!=o.length&&(t+=",Properties:{"+o.substr(1)+"}")}t+="}"}return super.getEntitySpecificCommand()+t}}class InteractionEntity extends SimpleEntity{constructor(e,t){super(e,t),Object.assign(this.entityNBT,{width:{type:"text",format:"f",tip:t,align:"R"},height:{type:"text",format:"f",tip:t,align:"R"},response:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"},attackUUID:{label:"Attack UUID",type:"UUIDArray",format:"special",align:"R",tip:t,playerLookup:!0},attackTimestamp:{label:"Attack Timestamp",type:"text",format:"special",tip:t,align:"R"},interactionUUID:{label:"Interaction UUID",type:"UUIDArray",format:"special",align:"R",tip:t,playerLookup:!0},interactionTimestamp:{label:"Interaction Timestamp",type:"text",format:"special",tip:t,align:"R"}})}loadInteractionPart(e,t){null!=t.timestamp&&$("#"+e+"Timestamp"+this.stackPos).val(parseFloat(t.timestamp.val)),null!=t.player&&loadUUIDArrayNBT(e+"UUID"+this.stackPos,t.player.val)}getEntitySpecificCommand(e){let t="";for(const a of["attack","interaction"]){let e="";$("#"+a+"UUID"+this.stackPos+0).val()&&$("#"+a+"UUID"+this.stackPos+1).val()&&$("#"+a+"UUID"+this.stackPos+2).val()&&$("#"+a+"UUID"+this.stackPos+3).val()&&(e+=",player:[I;"+$("#"+a+"UUID"+this.stackPos+0).val()+","+$("#"+a+"UUID"+this.stackPos+1).val()+","+$("#"+a+"UUID"+this.stackPos+2).val()+","+$("#"+a+"UUID"+this.stackPos+3).val()+"]"),$("#"+a+"Timestamp"+this.stackPos).val().length&&(e+=",timestamp:"+$("#"+a+"Timestamp"+this.stackPos).val()),0<e.length&&(t+=","+a+":{"+e.substring(1)+"}")}return super.getEntityNBT()+t}}class DisplayEntity extends SimpleEntity{constructor(e,t){super(e,t),this.displayNBT={view_range:{type:"text",format:"f",tip:"display",align:"R"},shadow_radius:{type:"text",format:"f",tip:"display",align:"R"},shadow_strength:{type:"text",format:"f",tip:"display",align:"R"},glow_color_override:{type:"colorChooser",format:"special",tip:"display",align:"R"},brightness:{type:"genericArrayOfType",labels:["sky","block"],defaults:[10,10],format:"special",tip:"display",align:"R"},width:{type:"text",format:"f",tip:"display",align:"R"},height:{type:"text",format:"f",tip:"display",align:"R"},billboard:{type:"makeSelect",hasUnset:!0,values:["fixed","vertical","horizontal","center"],format:"string",tip:"display",align:"R"},start_interpolation:{type:"text",format:"long",tip:"display",align:"R"},interpolation_duration:{type:"ticks",tip:"display",align:"R"},teleport_duration:{type:"ticks",tip:"display",align:"R"},right_rotation:{type:"genericArrayOfType",labels:["x","y","z","a"],defaults:[0,0,0,1],format:"special",tip:"display",align:"R"},left_rotation:{type:"genericArrayOfType",labels:["x","y","z","a"],defaults:[0,0,0,1],format:"special",tip:"display",align:"R"},translation:{type:"genericArrayOfType",labels:["x","y","z"],defaults:[0,0,0],format:"special",tip:"display",align:"R"},scale:{type:"genericArrayOfType",labels:["x","y","z"],defaults:[1,1,1],format:"special",tip:"display",align:"R"},transformationValues:{label:"Transformation Values",fwClass:"verybigTF",type:"text",format:"special",tip:"display",align:"R"}},"item_display"==t?Object.assign(this.displayNBT,{item_display:{type:"makeSelect",hasUnset:!0,values:["none","thirdperson_lefthand","thirdperson_righthand","firstperson_lefthand","firstperson_righthand","head","gui","ground","fixed"],format:"string",tip:"display",align:"R"},item:{type:"itemselect",label:"item",format:"special",forceConstruct:!0,noCount:!0,tip:"display",align:"R"}}):"text_display"==t&&Object.assign(this.displayNBT,{line_width:{type:"text",format:"short",tip:t,align:"R"},text_opacity:{type:"text",format:"short",tip:t,align:"R"},background:{type:"colorChooser",format:"special",hasAlpha:!0,tip:t,align:"R"},default_background:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"},shadow:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"},see_through:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"},alignment:{type:"makeSelect",hasUnset:!0,values:["center","left","right"],format:"string",tip:t,align:"R"},text:{type:"customNameJSON",format:"special",tip:t,align:"R",complexOptions:!0}}),Object.assign(this.entityNBT,this.displayNBT)}generateForm(){if(super.generateForm(),"block_display"==this.entityType){let e="<br><span class='fLabel200'>block state</span>";for(var t in e+="<select id='block"+this.stackPos+"' onchange='javascript:fallingBlockChange("+this.stackPos+");'>",itemsAndBlocks)"i"!=itemsAndBlocks[t].c&&(e+="<option value='"+t+"'>"+itemsAndBlocks[t].d+"</option>");e+="</select><input type='text' id='block_filter"+this.stackPos+"' placeholder='Filter' class='medTF' onkeyup=\"updateFallingBlockOptions('block',"+this.stackPos+')">'+makeTip("display","block_state")+"<span id='blockSpec"+this.stackPos+"'></span>",$("#entityPane"+this.stackPos+"R").append(e)}}getBlockDisplayBlockState(e){let t="";if(-1!=$("#block"+e).val()){if(t=',block_state:{Name:"minecraft:'+$("#block"+e).val()+'"',$("#block"+e).val()in blockStates){var a,o="";for(a in blockStates[$("#block"+e).val()])"unset"!=$("#"+a+"BS"+e).val()&&(o+=","+a+':"'+$("#"+a+"BS"+e).val()+'"');0!=o.length&&(t+=",Properties:{"+o.substr(1)+"}")}t+="}"}return t}getEntitySpecificCommand(e){let a="";if("block_display"==this.entityType)a=this.getBlockDisplayBlockState(e);else if("item_display"==this.entityType){e=getItemNBT("item"+e);a="{}"!=e?",item:"+e:""}else if("text_display"==this.entityType&&(a=getCustomNameAndColor("#text",this.stackPos,"text"),$("#background"+this.stackPos+"_customcol").is(":checked"))){e=$("#background"+this.stackPos+"_color").val();let t;try{(t=parseFloat($("#background"+this.stackPos+"_alpha").val()))<0?t=0:255<t&&(t=255)}catch(e){t=0}a+=",background:"+(t<<24|hexToR(e)<<16|hexToG(e)<<8|hexToB(e))}return super.getEntityNBT()+getColorInteger("glow_color_override"+this.stackPos,"glow_color_override")+this.getBrightnessNBT()+this.getTransformationDataNBT()+a}loadTextDisplayBackground(e){loadColorIntNBT("background"+this.stackPos,e),$("#background"+this.stackPos+"_alpha").val(e>>24&255)}loadTransformationArray(e){let t="";for(const a of e)t+=","+a;$("#transformationValues"+this.stackPos).val(t.substring(1))}loadTransformationData(e){for(const a of["left_rotation","right_rotation","translation","scale"])if(a in e)for(var t=0;t<this.displayNBT[a].labels.length;t++)$("#"+a+this.stackPos+this.displayNBT[a].labels[t]).val(parseFloat(e[a].val[t]))}loadBrightnessData(e){for(var t=0;t<this.displayNBT.brightness.labels.length;t++)$("#brightness"+this.stackPos+this.displayNBT.brightness.labels[t]).val(e[this.displayNBT.brightness.labels[t]].val)}getBrightnessNBT(){let e="",t=!1;for(var a=0;a<this.displayNBT.brightness.labels.length;a++)$("#brightness"+this.stackPos+this.displayNBT.brightness.labels[a]).val()?(t=!0,e+=","+this.displayNBT.brightness.labels[a]+":"+$("#brightness"+this.stackPos+this.displayNBT.brightness.labels[a]).val()):e+=","+this.displayNBT.brightness.labels[a]+":"+this.displayNBT.brightness.defaults[a];return t?",brightness:{"+e.substring(1)+"}":""}getTransformationDataNBT(){let t="",a=!1;for(const n of["left_rotation","right_rotation","translation","scale"]){let e="";for(var o=0;o<this.displayNBT[n].labels.length;o++)$("#"+n+this.stackPos+this.displayNBT[n].labels[o]).val()?(a=!0,e+=","+$("#"+n+this.stackPos+this.displayNBT[n].labels[o]).val()+"f"):e+=","+this.displayNBT[n].defaults[o]+"f";t+=","+n+":["+e.substr(1)+"]"}return a?",transformation:{"+t.substring(1)+"}":$("#transformationValues"+this.stackPos).val()?",transformation:["+$("#transformationValues"+this.stackPos).val()+"]":""}}class lightning_bolt extends Entity{constructor(e,t){super(e,t),this.passengersAllowed=!1,this.entityNBT={Tags:{type:"text",format:"special",tip:"entity",fwClass:"bigTF"}}}getEntitySpecificCommand(e){return getTargetingTags(this.stackPos)}}class fishing_bobber extends Entity{constructor(e,t){super(e,t),this.passengersAllowed=!1,this.entityNBT={OnGround:{type:"choice",values:unsetTrueFalse,format:"b",tip:t}}}getEntitySpecificCommand(e){return-1!=$("#OnGround"+e).val()?",OnGround:"+$("#OnGround"+e).val()+"b":""}}class pillager extends Mob{constructor(e,t,a){super(e,t,a),this.myNBT={PatrolLeader:{type:"choice",values:unsetTrueFalse,format:"b",tip:"pillager.PatrolLeader",align:"R"},Patrolling:{type:"choice",values:unsetTrueFalse,format:"b",tip:"pillager.Patrolling",align:"R"},CanJoinRaid:{type:"choice",values:unsetTrueFalse,format:"b",tip:"pillager.CanJoinRaid",align:"R"},patrol_targetX:{type:"text",format:"special",tip:"pillager.PatrolTarget",align:"R"},patrol_targetY:{type:"text",format:"special",align:"R"},patrol_targetZ:{type:"text",format:"special",align:"R"},Wave:{type:"text",format:"int",tip:"pillager.Wave",align:"R"},RaidId:{type:"text",format:"int",tip:"pillager.RaidId",align:"R"}},null!=this.specificNBT&&Object.assign(this.myNBT,this.specificNBT)}getEntitySpecificCommand(e){return super.getEntityNBT()+getTargetCompound(this.stackPos,"patrol_target")+getHandAndArmorItems(this.stackPos)+getStatusEffectsNBT("active_effects","ActiveEffects"+this.stackPos)+this.getMobAttributes()+this.getLeashedTo()}loadPatrolTargetNBT(e){Array.isArray(e)?($("#patrol_targetX"+this.stackPos).val(parseInt(e[0])),$("#patrol_targetY"+this.stackPos).val(parseInt(e[1])),$("#patrol_targetZ"+this.stackPos).val(parseInt(e[2]))):null!=e.X&&($("#patrol_targetX"+this.stackPos).val(parseInt(e.X.val)),$("#patrol_targetY"+this.stackPos).val(parseInt(e.Y.val)),$("#patrol_targetZ"+this.stackPos).val(parseInt(e.Z.val)))}generateForm(){Object.assign(this.mobNBT,this.myNBT),super.generateForm()}}class ender_crystal extends Entity{constructor(e,t){super(e,t),this.myNBT={ShowBottom:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"},beam_targetX:{type:"text",format:"special",tip:"ender_crystal.BeamTarget",align:"R"},beam_targetY:{type:"text",format:"special",align:"R"},beam_targetZ:{type:"text",format:"special",align:"R"}}}getEntitySpecificCommand(e){return super.getEntityNBT()+getTargetCompound(this.stackPos,"beam_target")}loadBeamTargetNBT(e){Array.isArray(e)?($("#beam_targetX"+this.stackPos).val(parseInt(e[0])),$("#beam_targetY"+this.stackPos).val(parseInt(e[1])),$("#beam_targetZ"+this.stackPos).val(parseInt(e[2]))):null!=e.X&&($("#beam_targetX"+this.stackPos).val(parseInt(e.X.val)),$("#beam_targetY"+this.stackPos).val(parseInt(e.Y.val)),$("#beam_targetZ"+this.stackPos).val(parseInt(e.Z.val)))}generateForm(){Object.assign(this.entityNBT,this.myNBT),super.generateForm()}}class evoker_fangs extends Entity{constructor(e,t){super(e,t),this.myNBT={Warmup:{type:"ticks",tip:t,align:"R"},Owner:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:t}}}getEntitySpecificCommand(e){return super.getEntityNBT()}generateForm(){Object.assign(this.entityNBT,this.myNBT),super.generateForm()}}class llama_spit extends SimpleEntity{constructor(e,t){super(e,t),this.myNBT={Owner:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:t}}}getEntitySpecificCommand(e){return super.getEntityNBT()}generateForm(){Object.assign(this.entityNBT,this.myNBT),super.generateForm()}}class ominous_item_spawner extends SimpleEntity{constructor(e,t){super(e,t),this.myNBT={item:{type:"itemselect",format:"special",hide:!1,tip:t,align:"R",forceConstruct:!0},spawn_item_after_ticks:{type:"ticks",tip:t,align:"R"}}}getEntitySpecificCommand(e){return super.getEntityNBT()+",item:"+getItemNBT("item"+e)}generateForm(){Object.assign(this.entityNBT,this.myNBT),super.generateForm()}}class item extends SimpleEntity{constructor(e,t){super(e,t),this.myNBT={Item:{type:"itemselect",format:"special",hide:!1,tip:t,align:"R",forceConstruct:!0},Age:{type:"ticks",tip:t,align:"R"},Health:{type:"text",format:"short",tip:t,align:"R"},PickupDelay:{type:"ticks",tip:t,align:"R"},Thrower:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:t},Owner:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:t},Invulnerable:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"}}}getEntitySpecificCommand(e){return super.getEntityNBT()+",Item:"+getItemNBT("Item"+e)}generateForm(){Object.assign(this.entityNBT,this.myNBT),super.generateForm()}}class painting extends SimpleEntity{getEntitySpecificCommand(e){return super.getEntityNBT()+',variant:"minecraft:'+$("#variant"+e).val()+'"'}}class item_frame extends SimpleEntity{constructor(e,t){super(e,t),this.myNBT={Item:{type:"itemselect",format:"special",hide:!1,tip:"item",align:"R",forceConstruct:!0},ItemDropChance:{type:"text",format:"f",tip:"item_frame",align:"R"},Facing:{type:"choice",values:[[-1,"unset"],["0","Down"],["1","Up"],["2","North"],["3","South"],["4","West"],["5","East"]],format:"b",tip:"item_frame",align:"R"},ItemRotation:{type:"choice",values:[[-1,"unset"],["1","45&deg;"],["2","90&deg;"],["3","135&deg;"],["4","180&deg;"],["5","225&deg;"],["6","270&deg;"],["7","315&deg;"]],format:"b",tip:"item_frame",align:"R"},Invulnerable:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity",align:"R"},Invisible:{type:"choice",values:unsetTrueFalse,format:"b",tip:"item_frame",align:"R"},Fixed:{type:"choice",values:unsetTrueFalse,format:"b",tip:"item_frame",align:"R"}}}getEntitySpecificCommand(e){return super.getEntityNBT()+",Item:"+getItemNBT("Item"+e)}generateForm(){Object.assign(this.entityNBT,this.myNBT),super.generateForm()}}class shulker_bullet extends SimpleEntity{constructor(e,t){super(e,t),this.myNBT={Owner:{type:"UUIDArray",format:"intArray",align:"R",tip:"shlkrblt116"},Target:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:"shlkrblt116"},TXD:{type:"text",format:"d",tip:"shulker_bullet.offset",align:"R"},TYD:{type:"text",format:"d",align:"R"},TZD:{type:"text",format:"d",align:"R"},Steps:{type:"text",format:"int",tip:t,align:"R"}}}getEntitySpecificCommand(e){return super.getEntityNBT()}generateForm(){Object.assign(this.entityNBT,this.myNBT),super.generateForm()}}class Player extends Entity{constructor(e,t){super(e,t),this.stackPos=e,this.entityType=t,this.entityNBT={FallFlying:{type:"choice",values:unsetTrueFalse,format:"b",tip:"mob"},ActiveEffects:{type:"statusEffects",format:"special",tip:"mob"},AbsorptionAmount:{type:"text",format:"f",tip:"mob"},Health:{type:"text",format:"f",tip:"mob"},fall_distance:{type:"text",format:"f",tip:"mob"},PortalCooldown:{type:"ticks",tip:"mob"},DataVersion:{type:"text",format:"int",tip:t},Dimension:{type:"makeSelect",values:["unset","overworld","the_end","the_nether"],format:"special",tip:t},Score:{type:"text",format:"int",tip:t},SelectedItemSlot:{type:"text",format:"int",tip:t},SelectedItem:{type:"itemselect",format:"special",hide:!0,tip:t},Inventory:{type:"multiitem",hide:!0,slotNumbers:!0,wildcardSlots:!0,tip:t},EnderItems:{type:"multiitem",hide:!0,slotNumbers:!0,wildcardSlots:!0,tip:t},SpawnX:{type:"text",format:"special",tip:"player.spawn"},SpawnY:{type:"text",format:"special"},SpawnZ:{type:"text",format:"special"},SpawnAngle:{type:"text",format:"special",tip:t},SpawnDimension:{type:"makeSelect",values:["unset","overworld","the_end","the_nether"],format:"special",tip:t},SpawnForced:{type:"choice",values:unsetTrueFalse,format:"special",tip:t},Sleeping:{type:"choice",values:unsetTrueFalse,format:"b",tip:t},foodLevel:{type:"text",format:"int",tip:t,align:"R"},XpLevel:{type:"text",format:"int",tip:t,align:"R"},XpP:{type:"text",format:"f",tip:t,align:"R"},XpTotal:{type:"text",format:"int",tip:t,align:"R"},walkSpeed:{type:"text",format:"special",tip:t,align:"R"},flySpeed:{type:"text",format:"special",tip:t,align:"R"},mayfly:{type:"choice",values:unsetTrueFalse,format:"special",tip:t,align:"R"},flying:{type:"choice",values:unsetTrueFalse,format:"special",tip:t,align:"R"},invulnerable:{type:"choice",values:unsetTrueFalse,format:"special",tip:t,align:"R"},mayBuild:{type:"choice",values:unsetTrueFalse,format:"special",tip:t,align:"R"},instaBuild:{type:"choice",values:unsetTrueFalse,format:"special",tip:t,align:"R"},seenCredits:{type:"choice",values:unsetTrueFalse,format:"b",tip:t,align:"R"}}}loadAbilities(e,t){for(var a in t)-1!=t[a].val.indexOf("b")?$("#"+a+this.stackPos).val(parseInt(t[a].val)):$("#"+a+this.stackPos).val(parseFloat(t[a].val))}loadPlayerInventory(t,a,e){var o="Inventory"+e+"MultiItem";showHide(o+"Pane",o+"PaneSH");for(let e=0;e<a.length;e++)null!=a[e].id?(addMultiItem(o+"Pane",!0),showHide(o+"Pane_"+e+"Pane",o+"Pane_"+e+"PaneSH"),setupItemSlotForNBT(o+"Pane_"+e,a[e],t),null!=a[e].Slot&&$("#"+o+"Pane_"+e+"Slot").val(parseInt(a[e].Slot.val))):null!=a[e].Slot&&(addWildcardSlot(o+"Pane"),$("#"+o+"Pane_"+e).val(parseInt(a[e].Slot.val)))}getAbilities(e){var t="";return $("#walkSpeed"+e).val().length&&(t+=",walkSpeed:"+$("#walkSpeed"+e).val()+"f"),$("#flySpeed"+e).val().length&&(t+=",flySpeed:"+$("#flySpeed"+e).val()+"f"),-1!=$("#mayfly"+e).val()&&(t+=",mayfly:"+$("#mayfly"+e).val()+"b"),-1!=$("#flying"+e).val()&&(t+=",flying:"+$("#flying"+e).val()+"b"),-1!=$("#invulnerable"+e).val()&&(t+=",invulnerable:"+$("#invulnerable"+e).val()+"b"),-1!=$("#mayBuild"+e).val()&&(t+=",mayBuild:"+$("#mayBuild"+e).val()+"b"),-1!=$("#instaBuild"+e).val()&&(t+=",instaBuild:"+$("#instaBuild"+e).val()+"b"),t.length?",abilities:{"+t.substr(1)+"}":t}getEntitySpecificCommand(e){var t="",a=getItemNBT("SelectedItem"+e);"{}"!=a&&(t+=",SelectedItem:"+a),"unset"!=$("#Dimension"+e).val()&&(t+=',Dimension:"minecraft:'+$("#Dimension"+e).val()+'"');let o="",n=($("#Inventory"+e+"MultiItemPane  > .itemSelectControl").each(function(e){var t=this.id.substr(0,this.id.lastIndexOf("Pane"));"-1"!=$("#"+t).val()&&(o+=","+getItemNBT(t,"CountOptional"))}),$("#Inventory"+e+"MultiItemPane  > .wildcardSlot").each(function(e){var t=this.id.substr(0,this.id.lastIndexOf("Panel"));$("#"+t).val().length&&(o+=",{Slot:"+$("#"+t).val()+"b}")}),o.length&&(t+=",Inventory:["+o.substr(1)+"]"),""),s=($("#EnderItems"+e+"MultiItemPane  > .itemSelectControl").each(function(e){var t=this.id.substr(0,this.id.lastIndexOf("Pane"));"-1"!=$("#"+t).val()&&(n+=","+getItemNBT(t,"CountOptional"))}),$("#EnderItems"+e+"MultiItemPane  > .wildcardSlot").each(function(e){var t=this.id.substr(0,this.id.lastIndexOf("Panel"));$("#"+t).val().length&&(n+=",{Slot:"+$("#"+t).val()+"b}")}),n.length&&(t+=",EnderItems:["+n.substr(1)+"]"),getTargetCompoundWithKey(e,"Spawn","pos"));return $("#SpawnAngle"+e).val().length&&(s+=",angle:"+$("#SpawnAngle"+e).val()),"unset"!=$("#SpawnDimension"+e).val()&&(s+=',dimension:"minecraft:'+$("#SpawnDimension"+e).val()+'"'),"-1"!=$("#SpawnForced"+e).val()&&(s+=",forced:"+(1==$("#SpawnForced"+e).val())),s.length&&(t+=",respawn:{"+s.substring(1)+"}"),(t+=this.getAbilities(e))+this.getEntityNBT()+getStatusEffectsNBT("active_effects","ActiveEffects"+this.stackPos)}getEntityNBT(){var e,t="";for(e in this.entityNBT)t+=getNBTforKey(e,this.entityNBT[e],this.stackPos);return t}generateForm(){for(var e in this.entityNBT)createComponent("entityPane"+this.stackPos,e,this.entityNBT[e],this.stackPos)}}var booksJson,quillsJson,tellrawJson,signJson,jsonColors=["unset","Hex Code","white","black","dark_blue","dark_green","dark_aqua","dark_red","dark_purple","gold","gray","dark_gray","blue","green","aqua","red","light_purple","yellow"];class Book{constructor(){this.formats=["bold","italic","underlined","strikethrough","obfuscated"],this.books=[],this.context="book",this.htmlColorMap={reset:"#000000","-1":"#000000",unset:"#000000",black:"#000000",dark_blue:"#0000aa",dark_green:"#00aa00",dark_aqua:"#00aaaa",dark_red:"#aa0000",dark_purple:"#aa00aa",purple:"#A020F0",gold:"#ffaa00",cyan:"#00FFFF",gray:"#aaaaaa",pink:"#FFC0CB",brown:"#964B00",light_gray:"#D3D3D3",dark_gray:"#555555",blue:"#5555ff",light_blue:"#ADD8E6",green:"#55ff55",aqua:"#55ffff",red:"#ff5555",light_purple:"#ff55ff",lime:"#32CD32",magenta:"#FF00FF",yellow:"#ffff55",orange:"#FFA500",white:"#ffffff"}}cuttoJSONClipboard(e,t){let a,o;var n;o=this.books[e].cSection<this.books[e].cSectionLast?(a=this.books[e].cSection,this.books[e].cSectionLast):(a=this.books[e].cSectionLast,this.books[e].cSection),(a==o&&1<this.sectionsLength(e)||0!=a||o<this.sectionsLength(e)-1)&&(n=JSON.stringify(this.books[e].pages[this.books[e].cPage].splice(a,o-a+1)),this.books[e].cSectionLast=0,this.books[e].cSection=0,displaySectionValues(e,this.books[e].pages[this.books[e].cPage][this.books[e].cSection].data,t),copyToClipboard(n))}copytoJSONClipboard(e){let t,a;a=this.books[e].cSection<this.books[e].cSectionLast?(t=this.books[e].cSection,this.books[e].cSectionLast):(t=this.books[e].cSectionLast,this.books[e].cSection),copyToClipboard(JSON.stringify(this.books[e].pages[this.books[e].cPage].slice(t,a+1)))}pastetoJSONClipboard(a,o){navigator.clipboard.readText().then(e=>{if(e.length){var t=JSON.parse(e);for(let e=0;e<t.length;e++)this.books[a].cSection++,this.books[a].pages[this.books[a].cPage].splice(this.books[a].cSection,0,t[e]);displaySectionValues(a,this.books[a].pages[this.books[a].cPage][this.books[a].cSection].data,o)}})}makeNewBook(e){this.books[e]={pages:[],cPage:0,cSection:0,cSectionLast:0,cHoverEvent:0},this.books[e].pages.push([]),this.books[e].pages[0].push(new Section)}getLineSection(e,t,a){a=null==a?this.books[e].cSection:a;return this.books[e].pages[t][a].data}flipSection(e,t){t+this.books[e].cSection>=this.sectionsLength(e)?this.books[e].cSection=0:t+this.books[e].cSection<0?this.books[e].cSection=this.sectionsLength(e)-1:this.books[e].cSection+=t,this.books[e].cHoverEvent=0,displaySectionValues(e,this.getSection(e),this.context)}goToPage(e,t){t<this.books[e].pages.length&&(this.books[e].cPage=t,this.books[e].cSection=0,this.books[e].cHoverEvent=0,displaySectionValues(e,this.getSection(e),this.context))}gradientMaker(e,t){""==$(`#${e}gradientPane`).html()&&($(`#${e}gradientPane`).append(`<span class='fLabel100'>Gradient Text</span><input type='text' id='${e}GradientText'>${makeTip("json.gradientText")}<button id='hide${e}' class='redX'>X</button>
	...
	<input class='ds' type='checkbox' id='${e}ds8'>`),$(".ds").bind("change",function(){generateCommand()})}function createVaultUI(e,t){createComponent(e,"config",{type:"panel",panelID:e+"config",htmlContent:"config"},t),createComponent(e+"config","loot_table",{id:e+"loot_table",type:"text",format:"string",tip:"vault"},t),createComponent(e+"config","override_loot_table_to_display",{id:e+"override_loot_table_to_display",type:"text",format:"string",tip:"vault"},t),createComponent(e+"config","activation_range",{id:e+"activation_range",type:"text",format:"float",tip:"vault"},t),createComponent(e+"config","deactivation_range",{id:e+"deactivation_range",type:"text",format:"float",tip:"vault"},t),createComponent(e+"config","key_item",{id:e+"key_item",type:"itemselect",tip:"vault",hide:!0},t),createComponent(e,"server_data",{type:"panel",panelID:e+"server_data",htmlContent:"<br>server_data"},t),createComponent(e+"server_data","rewarded_players",{label:"rewarded_players",type:"panel",panelID:e+"rewarded_players"+t},t),$("#"+e+"rewarded_players"+t).html("<a href=\"javascript:addRegisteredPlayer('"+e+"rewarded_players',"+t+")\" class='greenPlus'>+</a>"+makeTip("vault.rewarded_players")),createComponent(e+"server_data","state_updating_resumes_at",{id:e+"state_updating_resumes_at",type:"text",format:"long",tip:"vault"},t),createComponent(e+"server_data","items_to_eject",{id:e+"items_to_eject",type:"multiitem",tip:"vault",slotNumbers:!1,hide:!0},t),createComponent(e+"server_data","total_ejections_needed",{id:e+"total_ejections_needed",type:"text",format:"long",tip:"vault"},t),createComponent(e,"shared_data",{type:"panel",panelID:e+"shared_data",htmlContent:"<br>shared_data"},t),createComponent(e+"shared_data","display_item",{id:e+"display_item",type:"itemselect",tip:"vault",hide:!0},t),createComponent(e+"shared_data","connected_players",{label:"connected_players",type:"panel",panelID:e+"connected_players"+t},t),$("#"+e+"connected_players"+t).html("<a href=\"javascript:addRegisteredPlayer('"+e+"connected_players',"+t+")\" class='greenPlus'>+</a>"+makeTip("vault.connected_players")),createComponent(e+"shared_data","connected_particles_range",{id:e+"connected_particles_range",type:"text",format:"float",tip:"vault"},t)}function createMonsterSpawnerUI(e,t){createComponent(e,"SpawnCount",{id:e+"SpawnCount",type:"text",format:"short",tip:"mob_spawner"},t),createComponent(e,"SpawnRange",{id:e+"SpawnRange",type:"text",format:"short",tip:"mob_spawner"},t),createComponent(e,"Delay",{id:e+"Delay",type:"ticks",format:"short",tip:"mob_spawner"},t),createComponent(e,"MinSpawnDelay",{id:e+"MinSpawnDelay",type:"ticks",format:"short",tip:"mob_spawner"},t),createComponent(e,"MaxSpawnDelay",{id:e+"MaxSpawnDelay",type:"ticks",format:"short",tip:"mob_spawner"},t),createComponent(e,"MaxNearbyEntities",{id:e+"MaxNearbyEntities",type:"text",format:"short",tip:"mob_spawner"},t),createComponent(e,"RequiredPlayerRange",{id:e+"RequiredPlayerRange",type:"text",format:"short",tip:"mob_spawner"},t),createComponent(e,"SpawnPotential",{id:e+"_spawn_potentials",type:"spawnPotential",format:"special",tip:"mob_spawner.SpawnPotential1p20"},t),createComponent(e,"SpawnData",{id:e+"SpawnData",type:"spawnData",format:"special",tip:"mob_spawner.SpawnData1p20"},t)}function createTrialSpawnerUI(e,t){createComponent(e,"normal_config",{type:"panel",panelID:e+"normal_config",htmlContent:"Normal Config"},t),createComponent(e+"normal_config","spawn_range",{id:e+"n_spawn_range",type:"text",format:"short",tip:"trial_spawner"},t),createComponent(e+"normal_config","total_mobs",{id:e+"n_total_mobs",type:"text",format:"float",tip:"trial_spawner"},t),createComponent(e+"normal_config","simultaneous_mobs",{id:e+"n_simultaneous_mobs",type:"text",format:"float",tip:"trial_spawner"},t),createComponent(e+"normal_config","total_mobs_added_per_player",{id:e+"n_total_mobs_added_per_player",type:"text",format:"float",tip:"trial_spawner"},t),createComponent(e+"normal_config","simultaneous_mobs_added_per_player",{id:e+"n_simultaneous_mobs_added_per_player",type:"text",format:"float",tip:"trial_spawner"},t),createComponent(e+"normal_config","ticks_between_spawn",{id:e+"n_ticks_between_spawn",type:"ticks",format:"short",tip:"trial_spawner"},t),createComponent(e+"normal_config","spawn_potentials",{id:e+"n_spawn_potentials",type:"spawnPotential",format:"special",tip:"trial_spawner.spawn_potentials"},t),createComponent(e+"normal_config","loot_tables_to_eject",{id:e+"o_loot_tables_to_eject",label:"loot_tables_to_eject",type:"panel",panelID:e+"n_loot_table_eject"},t),$("#"+e+"n_loot_table_eject").html("<a href=\"javascript:addLootTableEject('"+e+"n_loot_table_eject')\" class='greenPlus'>+</a>"+makeTip("trial_spawner.loot_tables_to_eject")),createComponent(e,"ominous_config",{type:"panel",panelID:e+"ominous_config",tip:"trial_spawner",htmlContent:"<br>Ominous Config"},t),createComponent(e+"ominous_config","spawn_range",{id:e+"o_spawn_range",type:"text",format:"short",tip:"trial_spawner"},t),createComponent(e+"ominous_config","total_mobs",{id:e+"o_total_mobs",type:"text",format:"float",tip:"trial_spawner"},t),createComponent(e+"ominous_config","simultaneous_mobs",{id:e+"o_simultaneous_mobs",type:"text",format:"float",tip:"trial_spawner"},t),createComponent(e+"ominous_config","total_mobs_added_per_player",{id:e+"o_total_mobs_added_per_player",type:"text",format:"float",tip:"trial_spawner"},t),createComponent(e+"ominous_config","simultaneous_mobs_added_per_player",{id:e+"o_simultaneous_mobs_added_per_player",type:"text",format:"float",tip:"trial_spawner"},t),createComponent(e+"ominous_config","ticks_between_spawn",{id:e+"o_ticks_between_spawn",type:"ticks",format:"short",tip:"trial_spawner"},t),createComponent(e+"ominous_config","spawn_potentials",{id:e+"o_spawn_potentials",type:"spawnPotential",format:"special",tip:"trial_spawner.spawn_potentials"},t),createComponent(e+"ominous_config","loot_tables_to_eject",{id:e+"n_loot_tables_to_eject",label:"loot_tables_to_eject",type:"panel",panelID:e+"o_loot_table_eject"},t),$("#"+e+"o_loot_table_eject").html("<a href=\"javascript:addLootTableEject('"+e+"o_loot_table_eject')\" class='greenPlus'>+</a>"+makeTip("trial_spawner.loot_tables_to_eject")),createComponent(e+"ominous_config","items_to_drop_when_ominous",{id:e+"o_items_to_drop_when_ominous",type:"text",format:"string",tip:"trial_spawner"},t),createComponent(e,"blank",{type:"panel",panelID:e+"blank",tip:"trial_spawner",htmlContent:"<br>Options"},t),createComponent(e,"required_player_range",{id:e+"required_player_range",type:"text",format:"short",tip:"trial_spawner"},t),createComponent(e,"target_cooldown_length",{id:e+"target_cooldown_length",type:"text",format:"short",tip:"trial_spawner"},t),createComponent(e,"registered_players",{label:"registered_players",type:"panel",panelID:e+"registered_players"+t},t),$("#"+e+"registered_players"+t).html("<a href=\"javascript:addRegisteredPlayer('"+e+"registered_players',"+t+")\" class='greenPlus'>+</a>"+makeTip("trial_spawner.registered_players")),createComponent(e,"current_mobs",{label:"current_mobs",type:"panel",panelID:e+"current_mobs"+t},t),$("#"+e+"current_mobs"+t).html("<a href=\"javascript:addCurrentMobs('"+e+"current_mobs',"+t+")\" class='greenPlus'>+</a>"+makeTip("trial_spawner.current_mobs")),createComponent(e,"cooldown_ends_at",{id:e+"cooldown_ends_at",type:"text",format:"long",tip:"trial_spawner"},t),createComponent(e,"next_mob_spawns_at",{id:e+"next_mob_spawns_at",type:"text",format:"long",tip:"trial_spawner"},t),createComponent(e,"total_mobs_spawned",{id:e+"total_mobs_spawned",type:"text",format:"short",tip:"trial_spawner"},t),createComponent(e,"ejecting_loot_table",{id:e+"ejecting_loot_table",type:"text",format:"string",tip:"trial_spawner"},t),createComponent(e,"spawn_data",{id:e+"SpawnData",type:"spawnData",format:"special",tip:"trial_spawner"},t)}function addLootTableEject(e){let t=0;for(;$(`#${e}_`+t).length;)t++;$("#"+e).append(`<span id='${e}_${t}' class='ltEject'><span class='fLabel200'></span></span>`),$(`#${e}_`+t).append(`<br><span class='fLabel200'>Loot Table</span><input type='text' id='LT${e}_${t}'> Weight<input type='text' id='W${e}_${t}' class="medTF"><a href="javascript:removeContainer('${e}_${t}')" class='redX'>x</a>`),bindGenCom(`LT${e}_`+t,"keyup"),bindGenCom(`W${e}_`+t,"keyup")}function addRegisteredPlayer(e,t){let a=0;for(;$("#"+e+t+"_"+a).length;)a++;$("#"+e+t).append("<span id='"+e+t+"_"+a+"' class='regPlayer'><span class='fLabel200'></span></span>"),createComponent(e+t+"_"+a,"Player UUID",{id:e+t+"_"+a,type:"UUIDArray",format:"intArray",playerLookup:!0,align:"R"},t),$("#"+e+t+"_"+a).append("<a href=\"javascript:removeContainer('"+e+t+"_"+a+"')\" class='redX'>x</a>")}function addCurrentMobs(e,t){let a=0;for(;$("#"+e+t+"_"+a).length;)a++;$("#"+e+t).append("<span id='"+e+t+"_"+a+"' class='currentMob'><span class='fLabel200'></span></span>"),createComponent(e+t+"_"+a,"Mob UUID",{id:e+t+"_"+a,type:"UUIDArray",format:"intArray",align:"R"},t),$("#"+e+t+"_"+a).append("<a href=\"javascript:removeContainer('"+e+t+"_"+a+"')\" class='redX'>x</a>")}function createEntityTagNBT_In_Item(e,t,a,o){o.includes("Invisible")&&createComponent(t,"Invisible",{id:e+"Invisible",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity",cssClass:"fLabel100"},a),o.includes("Silent")&&createComponent(t,"Silent",{id:e+"Silent",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity",cssClass:"fLabel100"},a),o.includes("Invulnerable")&&createComponent(t,"Invulnerable",{id:e+"Invulnerable",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity",cssClass:"fLabel100"},a),o.includes("Glowing")&&createComponent(t,"Glowing",{id:e+"Glowing",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity",cssClass:"fLabel100"},a),o.includes("UUID")&&createComponent(t,"UUID",{id:e+"UUID",type:"UUIDArray",format:"intArray",align:"R",tip:"entity",cssClass:"fLabel100"},a),o.includes("CustomNameVisible")&&createComponent(t,"CustomNameVisible",{id:e+"CustomNameVisible",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity",cssClass:"fLabel100"},a),o.includes("CustomName")&&createComponent(t,"CustomName",{id:e+"CustomNameEntData",type:"customNameJSON",format:"special",tip:"entity",cssClass:"fLabel100"},a),o.includes("Tags")&&createComponent(t,"Tags",{id:e+"Tags",type:"text",format:"special",tip:"entity",fwClass:"bigTF",cssClass:"fLabel100"},a)}function addCrossbowProjectile(e){for(var t=0;$("#"+e+"_prj_"+t).length;)t++;var a=e+"_prj_"+t;return $("#"+e).append("<span id='"+a+"' class='cb_projectile roundedDiv' style='display:block;margin-left:50px;margin-bottom:2px'></span>"),$("#"+a).append("<a class='redX' href=\"javascript:removeContainer('"+a+"')\">&#9747;</a>"),createComponent(a,"Projectile",{id:a+"Projectile",cssClass:"fLabel100",type:"makeSelect",values:projectiles,format:"special"},-1),$("#"+a).append(`<br><div id='${a}ProjectilePane'></div>`),$("#"+a+"Projectile").bind("change",function(){updateCrossbowForm(a+"Projectile",-1)}),$("#"+a+"Projectile").trigger("change"),generateCommand(),a}function updateCrossbowForm(e,t){$("#"+e+"Pane").empty(),"arrow"==$("#"+e).val()||"spectral_arrow"==$("#"+e).val()?createComponent(e+"Pane","Intangible",{id:e+"Intangible",type:"cb",cssClass:"fLabel100",tip:"crossbow.intangible"},t):"tipped_arrow"==$("#"+e).val()?(createComponent(e+"Pane","Intangible",{id:e+"Intangible",type:"cb",cssClass:"fLabel100",tip:"crossbow.intangible"},t),createComponent(e+"Pane","Potion",{id:e+"Potion",cssClass:"fLabel100",type:"makeSelectWithIndexAndValues",values:potions,format:"string",tip:"potion"},t),createComponent(e+"Pane","CustomPotionColor",{id:e+"CustomPotionColor",cssClass:"fLabel100",type:"colorChooser",format:"long",tip:"potion"},t),createComponent(e+"Pane","CustomPotionEffects",{id:e+"CustomPotionEffects",cssClass:"fLabel100",type:"statusEffects",format:"special",tip:"potion"},t)):"firework_rocket"==$("#"+e).val()&&(createComponent(e+"Pane","Flight",{id:e+"Flight",type:"text",cssClass:"fLabel100",format:"b",tip:"rocket"},t),createComponent(e+"Pane","Explosion",{type:"fwExplosion",id:e+"Explosion",forItem:!0,entDescID:"e"+entityIndex+"_"+e,format:"special",cssClass:"fLabel100",tip:"fireworks_rocket.Explosion"},entityIndex)),$("#"+e+"Pane br:first").remove()}function addMapDecoration(e){for(var t=0;$("#"+e+"_dec_"+t).length;)t++;var a=e+"_dec_"+t;return $("#"+e).append("<span id='"+a+"' class='map_decoration roundedDiv' style='display:block;width:230px;margin-bottom:2px'></span>"),$("#"+a).append("<a class='redX' style='float:right' href=\"javascript:removeContainer('"+a+"')\">&#9747;</a>"),createComponent(a,"ID",{id:a+"id",type:"text",fwClass:"bigTF",format:"string",cssClass:"fLabel70",tip:"mapdecoration",noBR:!0,value:getRandomInt(1,99999999)},-1),createComponent(a,"Type",{id:a+"Type",type:"makeSelect",values:mapMarkers,format:"b",hasUnset:!1,cssClass:"fLabel70",tip:"mapdecoration"},-1),createComponent(a,"X",{id:a+"x",type:"text",fwClass:"medTF",format:"int",cssClass:"fLabel70",tip:"mapdecoration"},-1),createComponent(a,"Z",{id:a+"z",type:"text",fwClass:"medTF",format:"int",cssClass:"fLabel70",tip:"mapdecoration"},-1),createComponent(a,"Rotation",{id:a+"rot",type:"text",fwClass:"medTF",format:"int",cssClass:"fLabel70",value:180,tip:"mapdecoration"},-1),a}function updateItemFilteredComponents(e){var t=$("#"+e).val(),a=[];if(null!=t){if(isLeatherArmor(t)&&a.push("dyed_color"),trimables.includes(t))a.push("trim");else if(-1!=t.indexOf("_banner"))a.push("banner_patterns");else if(-1!=t.indexOf("sign")||["command_block","repeating_command_block","chain_command_block"].includes(t)||"lectern"==t||"crafter"==t||"vault"==t||"trial_spawner"==t||"spawner"==t||"suspicious_sand"==t||"suspicious_gravel"==t)a.push("block_entity_data");else if(-1!=t.indexOf("spawn_egg")||"armor_stand"==t||"painting"==t||"item_frame"==t||"glow_item_frame"==t)a.push("entity_data");else if(-1!=t.indexOf("bundle"))a.push("bundle_contents");else if(-1!=t.indexOf("campfire")||"barrel"==t||"chest"==t||"trapped_chest"==t||"brewing_stand"==t||"dispenser"==t||"dropper"==t||"furnace"==t||"blast_furnace"==t||"smoker"==t||"hopper"==t||"chiseled_bookshelf"==t||-1!=t.indexOf("shulker_box"))a.push("container"),"chiseled_bookshelf"!=t&&-1==t.indexOf("campfire")&&a.push("lock"),"barrel"==t||"chest"==t||"trapped_chest"==t||"dispenser"==t||"dropper"==t||"hopper"==t||-1!=t.indexOf("shulker_box")?(a.push("container_loot"),"hopper"==t&&a.push("block_entity_data")):-1==t.indexOf("campfire")&&"brewing_stand"!=t&&"furnace"!=t&&"blast_furnace"!=t&&"smoker"!=t||a.push("block_entity_data");else switch(t){case"enchanted_book":a.push("stored_enchantments");break;case"player_head":a.push("profile"),a.push("note_block_sound");break;case"writable_book":a.push("writable_book_content");break;case"written_book":a.push("written_book_content");break;case"beehive":case"bee_nest":a.push("bees"),a.push("block_entity_data");break;case"compass":a.push("lodestone_tracker");break;case"filled_map":a.push("map_id"),a.push("map_color"),a.push("map_decorations");break;case"firework_rocket":a.push("fireworks");break;case"firework_star":a.push("firework_explosion");break;case"crossbow":a.push("charged_projectiles");break;case"goat_horn":a.push("instrument");break;case"tadpole_bucket":case"tropical_fish_bucket":case"cod_bucket":case"pufferfish_bucket":case"salmon_bucket":case"axolotl_bucket":a.push("bucket_entity_data");break;case"decorated_pot":a.push("pot_decorations"),a.push("container"),a.push("block_entity_data");break;case"shield":a.push("banner_patterns"),a.push("base_color");break;case"knowledge_book":a.push("recipes")}t in blockStates&&-1==itemIgnoreBlockStates.indexOf(t)&&a.push("block_state"),a=a.concat(["tooltip_display","blocks_attacks","break_sound","provides_trim_material","provides_banner_patterns","enchantment_glint_override","max_stack_size","custom_name","item_name","lore","max_damage","damage","repair_cost","repairable","unbreakable","damage_resistant","rarity","custom_model_data","item_model","custom_data","tooltip_style","can_place_on","can_break","enchantments","enchantable","equippable","food","consumable","use_remainder","use_cooldown","jukebox_playable","glider","potion_contents","potion_duration_scale","ominous_bottle_amplifier","suspicious_stew_effects","tool","death_protection","attribute_modifiers","weapon"].sort()),globalComponentList=a;for(var o=$("#"+e+"component_filter").val(),n=[],s=0;s<a.length;s++)0!=o.length&&-1==a[s].indexOf(o)||n.push('<option value="',a[s],'">',a[s],"</option>");if(0==n.length)for(s=0;s<a.length;s++)n.push('<option value="',a[s],'">',a[s],"</option>");$(`#${e}component`).html(n.join(""))}}function createComponentChooser(a){$(`#${a}ItemPane`).append(`<br><span class='fLabel100'>component</span><select id='${a}component'></select><input type='text' id='${a}component_filter' placeholder='Filter' class='medTF'>
		<button id='${a}_add' class='greenPlus'>+</button>
		<button id='${a}_add_not' class='greenPlus'>+ Not</button>
		<button id='${a}_add_all' class='greenPlus'>+ All</button>
		<button id='${a}_remove_all' class='redX'>X All</button>
		<button id='${a}_showhide_all' class='showHide'>H All</button>
		 `+makeTip("item","component")),$(`#${a}component_filter`).on("keyup",function(){updateItemFilteredComponents(a)}),$(`#${a}_add`).on("click",function(){loadAddComponentUI(a,$(`#${a}component`).val()),"S"==$(`#${a}_showhide_all`).html().charAt(0)&&hide(a+"inner_"+$(`#${a}component`).val(),`${a}inner_${$(`#${a}component`).val()}SH`)}),$(`#${a}_add_not`).on("click",function(){loadAddComponentUI(a,$(`#${a}component`).val(),!0),"S"==$(`#${a}_showhide_all`).html().charAt(0)&&hide(a+"inner_"+$(`#${a}component`).val(),`${a}inner_${$(`#${a}component`).val()}SH`),generateCommand()}),$(`#${a}_add_all`).on("click",function(){deferOutput=!0,$(`#${a}component > option`).each(function(){loadAddComponentUI(a,this.value),"S"==$(`#${a}_showhide_all`).html().charAt(0)&&hide(a+"inner_"+this.value,`${a}inner_${this.value}SH`)}),deferOutput=!1}),$(`#${a}_showhide_all`).on("click",function(){let t=a+"ui_";"H"==$(`#${a}_showhide_all`).html().charAt(0)?($(`#${a}_showhide_all`).html("S All"),$("#"+a+"ItemPane > .inner_component").each(function(){var e=this.id.substring(t.length);hide(a+"inner_"+e,a+`inner_${e}SH`)})):($(`#${a}_showhide_all`).html("H All"),$("#"+a+"ItemPane > .inner_component").each(function(){var e=this.id.substring(t.length);show(a+"inner_"+e,a+`inner_${e}SH`)}))}),$(`#${a}_remove_all`).on("click",function(){deferOutput=!0,$(`#${a}component > option`).each(function(){removeContainer(a+"ui_"+this.value)}),deferOutput=!1,generateCommand()}),updateItemFilteredComponents(a)}function loadAddNotComponentUI(e,t){$(`#${e}ui_not_`+t).length||($(`#${e}ItemPane`).append(`<div id='${e}ui_${t}' class='inner_component'><span class='fLabel150'>${t}</span>${mkShowHide(e+"inner_"+t,e+`inner_${t}SH`)}<div id='${e}inner_${t}' style='display:inline-block;vertical-align:text-top;'></div>${makeTip("item",t)}<button id='${e}remove_${t}' class='redX'>X</div>`),$(`#${e}remove_`+t).on("click",function(){removeContainer(e+"ui_"+t)}))}function loadAddComponentUI(t,e,a){if(!$(`#${t}ui_`+e).length){$(`#${t}ItemPane`).append(`<div id='${t}ui_${e}' class='inner_component'><span class='fLabel150'>${e}</span>${mkShowHide(t+"inner_"+e,t+`inner_${e}SH`)}<div id='${t}inner_${e}' style='display:inline-block;vertical-align:text-top;'></div>${makeTip("item",e)}<button id='${t}remove_${e}' class='redX'>X</div>`),$(`#${t}remove_`+e).on("click",function(){removeContainer(t+"ui_"+e)});var o=$("#"+t).val();if(null!=a&&a)$(`#${t}inner_`+e).append("component removed");else{var n;switch(e){case"max_damage":createComponent(t+"inner_"+e,"max_damage",{id:t+"max_damage",type:"text",noLabel:!0},0);break;case"max_stack_size":createComponent(t+"inner_"+e,"max_stack_size",{id:t+"max_stack_size",type:"text",noLabel:!0},0);break;case"custom_name":$(`#${t}inner_`+e).append("<div id='"+t+"CustomName' class='roundedDiv JSONEditor'></div>"),createTellrawForm(t,0,"CustomName",!1,"CustomName"),$("#"+t+"CustomName br:first").remove(),$("#"+t+"CustomName br:first").remove();break;case"item_name":$(`#${t}inner_`+e).append("<div id='"+t+"ItemName' class='roundedDiv JSONEditor'></div>"),createTellrawForm(t,0,"ItemName",!1,"ItemName"),$("#"+t+"ItemName br:first").remove(),$("#"+t+"ItemName br:first").remove();break;case"lore":$(`#${t}inner_`+e).append("<div id='"+t+"Lore' class='roundedDiv JSONEditor'></div>"),createTellrawForm(t,0,"Lore",!1,"Lore"),$("#"+t+"Lore br:first").remove(),$("#"+t+"Lore br:first").remove();break;case"can_place_on":$(`#${t}inner_`+e).append("<div id='"+t+"cpoPanel' class='roundedDiv AMControl'></div>"),createComponent(t+"cpoPanel","can_place_on",{id:t+"CanPlaceOn",type:"tileselect",cssClass:"fLabel100",tip:"item.AddCanPlaceOn"},0);break;case"can_break":$(`#${t}inner_`+e).append("<div id='"+t+"cbPanel' class='roundedDiv AMControl'></div>"),createComponent(t+"cbPanel","can_break",{id:t+"CanDestroy",type:"tileselect",cssClass:"fLabel100",tip:"item.AddCanDestroy"},0);break;case"damage":createComponent(t+"inner_"+e,"damage",{id:t+"Damage",type:"text",noLabel:!0},0),o in durabilities&&$(`#${t}inner_`+e).append("max "+durabilities[o]);break;case"repair_cost":createComponent(t+"inner_"+e,"repair_cost",{id:t+"RepairCost",type:"text",noLabel:!0},0);break;case"unbreakable":createComponent(t+"inner_"+e,"unbreakable",{id:t+"Unbreakable",type:"choice",cssClass:"fLabel100",values:unsetTrueFalse,format:"b",noLabel:!0},0);break;case"repairable":$(`#${t}inner_`+e).append("<div id='"+t+"Repairable' class='AMControl roundedDiv'></div>"),makeRepairableUI(t+"Repairable");break;case"enchantment_glint_override":createComponent(t+"inner_"+e,"enchantment_glint_override",{id:t+"enchantment_glint_override",type:"choice",values:unsetTrueFalse,format:"b",noLabel:!0},0);break;case"tooltip_display":$(`#${t}inner_`+e).append("<div id='"+t+"TooltipDisplay' class='AMControl roundedDiv'></div>"),makeTooltipDisplayUI(t+"TooltipDisplay");break;case"tooltip_style":createComponent(t+"inner_"+e,"tooltip_style",{id:t+"tooltip_style",type:"text",noLabel:!0,fwClass:"verybigTF"},0);break;case"damage_resistant":createComponent(t+"inner_"+e,"damage_resistant",{id:t+"damage_resistant",type:"makeSelect",values:damageTypeTagsList,hasUnset:!0,noLabel:!0},0);break;case"rarity":createComponent(t+"inner_"+e,"rarity",{id:t+"rarity",type:"makeSelect",values:["common","uncommon","rare","epic"],format:"b",hasUnset:!0,noLabel:!0},0);break;case"custom_model_data":$(`#${t}inner_`+e).append("<div id='"+t+"CustomModelData' class='AMControl roundedDiv'></div>"),makeCustomModelDataUI(t+"CustomModelData");break;case"item_model":createComponent(t+"inner_"+e,"item_model",{id:t+"item_model",type:"text",noLabel:!0,fwClass:"verybigTF"},0);break;case"custom_data":createComponent(t+"inner_"+e,"custom_data",{id:t+"CustomTags",type:"text",noLabel:!0,fwClass:"verybigTF"},0);break;case"enchantments":$(`#${t}inner_`+e).append("<div id='"+t+"Enchantments' class='EnchantmentsControlSingle AMControl roundedDiv'></div>"),makeEnchantments(t+"Enchantments",!1,$("#"+t).val());break;case"equippable":$(`#${t}inner_`+e).append("<div id='"+t+"Equippable' class='AMControl roundedDiv'></div>"),makeEquippableUI(t+"Equippable");break;case"food":$(`#${t}inner_`+e).append("<div id='"+t+"Food' class='AMControl roundedDiv'></div>"),makeFoodUI(t+"Food");break;case"consumable":$(`#${t}inner_`+e).append("<div id='"+t+"Consumable' class='AMControl roundedDiv'></div>"),makeConsumableUI(t+"Consumable");break;case"enchantable":createComponent(t+"inner_"+e,"enchantable",{id:t+"enchantable",type:"text",fwClass:"medTF",noLabel:!0},0);break;case"use_remainder":createComponent(t+"inner_"+e,"use_remainder",{id:t+"use_remainder",type:"itemselect",format:"special",noShowHideButton:!0,noLabel:!0},-1);break;case"glider":createComponent(t+"inner_"+e,"glider",{id:t+"glider",type:"cb",noLabel:!0},-1);break;case"potion_contents":$(`#${t}inner_`+e).append("<div id='"+t+"PC' class='AMControl roundedDiv'></div>"),createComponent(t+"PC","potion",{id:t+"Potion",type:"makeSelectWithIndexAndValues",cssClass:"fLabel100",values:potions,format:"string",tip:"potion.Potion",noBR:!0},-1),createComponent(t+"PC","custom_color",{id:t+"CustomPotionColor",type:"colorChooser",cssClass:"fLabel100",format:"long",tip:"potion.CustomPotionColor"},-1),createComponent(t+"PC","custom_effects",{id:t+"CustomPotionEffects",type:"statusEffects",cssClass:"fLabel100",format:"special",tip:"potion.CustomPotionEffects"},-1);break;case"potion_duration_scale":createComponent(t+"inner_"+e,"potion_duration_scale",{id:t+"potion_duration_scale",type:"text",format:"f",noLabel:!0,align:"R"},-1);break;case"ominous_bottle_amplifier":createComponent(t+"inner_"+e,"ominous_bottle_amplifier",{id:t+"ominous_bottle_amplifier",type:"text",format:"int",noLabel:!0,align:"R"},-1);break;case"suspicious_stew_effects":createComponent(t+"inner_"+e,"suspicious_stew_effects",{id:t+"StewEffects",type:"stewEffects",format:"special",noLabel:!0,noShowHideButton:!0},-1);break;case"use_cooldown":$(`#${t}inner_`+e).append("<div id='"+t+"UseCooldown' class='AMControl roundedDiv'></div>"),makeUseCooldownUI(t+"UseCooldown");break;case"jukebox_playable":createComponent(t+"inner_"+e,"song",{id:t+"song",type:"text",fwClass:"bigTF",cssClass:"fLabel100",noLabel:!0},-1);break;case"blocks_attacks":$(`#${t}inner_`+e).append("<div id='"+t+"BlocksAttacks' class='AMControl roundedDiv'></div>"),makeBlocksAttacksUI(t+"BlocksAttacks");break;case"tool":$(`#${t}inner_`+e).append("<div id='"+t+"Tool' class='AMControl roundedDiv'></div>"),makeToolUI(t+"Tool");break;case"weapon":$(`#${t}inner_`+e).append("<div id='"+t+"Weapon' class='AMControl roundedDiv'></div>"),makeWeaponUI(t+"Weapon");break;case"death_protection":$(`#${t}inner_`+e).append("<div id='"+t+"DeathProtection' class='AMControl roundedDiv'></div>"),makeDeathProtectionUI(t+"DeathProtection");break;case"attribute_modifiers":$(`#${t}inner_`+e).append("<div id='"+t+"AM' class=' AMControl roundedDiv'></div>"),makeAMUI(t+"AM");break;case"block_state":if(o in blockStates&&-1==itemIgnoreBlockStates.indexOf(o)){$(`#${t}inner_`+e).append("<div id='"+t+"BlockStates' class='AEControl roundedDiv'></div>");var s=blockStates[o];for(r in s){var i=s[r].slice();$.isArray(i[0])?(i.unshift(["unset","unset"]),createComponent(t+"BlockStates",r,{id:r+t,cssClass:"fLabel100",type:"choice",values:i},0)):(i.unshift("unset"),createComponent(t+"BlockStates",r,{id:r+t,cssClass:"fLabel100",type:"makeSelect",values:i},0))}$("#"+t+"BlockStates br:first").remove()}break;case"dyed_color":$(`#${t}inner_`+e).append("<div id='"+t+"dyedPanel' class='roundedDiv AMControl'></div>"),createComponent(t+"dyedPanel","color",{id:t+"Color",type:"colorChooser",cssClass:"fLabel100",tip:"item.leatherArmor",noBR:!0},0);break;case"provides_trim_material":createComponent(t+"inner_"+e,"provides_trim_material",{id:t+"provides_trim_material",type:"makeSelect",values:trims,noLabel:!0},0);break;case"provides_banner_patterns":createComponent(t+"inner_"+e,"provides_banner_patterns",{id:t+"provides_banner_patterns",type:"makeSelect",values:bannerPatternList,noLabel:!0},0);break;case"trim":$(`#${t}inner_`+e).append("<div id='"+t+"trimPanel' class='roundedDiv AMControl'></div>"),createComponent(t+"trimPanel","material",{id:t+"Material",type:"makeSelect",values:["unset","amethyst","copper","diamond","emerald","gold","iron","lapis","netherite","quartz","redstone","resin"],format:"special",cssClass:"fLabel100",tip:"armor.TrimMaterial",align:"R",noBR:!0},0),createComponent(t+"trimPanel","pattern",{id:t+"Pattern",type:"makeSelect",values:["unset","bolt","coast","dune","eye","flow","host","raiser","rib","sentry","shaper","silence","snout","spire","tide","vex","ward","wayfinder","wild"],format:"special",cssClass:"fLabel100",tip:"armor.TrimPattern",align:"R"},0);break;case"stored_enchantments":$(`#${t}inner_`+e).append("<div id='"+t+"StoredEnchantments' class='EnchantmentsControlSingle roundedDiv'></div>"),makeEnchantments(t+"StoredEnchantments",!0,o);break;case"profile":$(`#${t}inner_`+e).append("<div id='"+t+"Profile' class='AMControl roundedDiv'></div>"),createComponent(t+"Profile","Profile/Name",{noBR:!0,id:t+"SkullOwner",type:"text",cssClass:"fLabel100",fwClass:"bigTF",tip:"player_head.profile"},0),createComponent(t+"Profile","UUID",{id:t+"UUID",type:"UUIDArray",cssClass:"fLabel100",format:"special",align:"R",playerLookup:!0,loadTexture:!0,tip:"player_head.uuid"},0),createComponent(t+"Profile","Texture",{id:t+"Texture",type:"text",cssClass:"fLabel100",format:"special",align:"R",tip:"player_head.texture"},0);break;case"break_sound":$(`#${t}inner_`+e).append("<select id='"+t+"break_sound'></select><input type='text' id='"+t+"break_sound_filter' placeholder='Filter' class='medTF'>"),bindGenCom(t+"break_sound","change"),$(`#${t}break_sound_filter`).on("keyup",function(){updateSoundSelect(t+"break_sound",!0)}),updateSoundSelect(t+"break_sound",!0);break;case"note_block_sound":$(`#${t}inner_`+e).append("<select id='"+t+"sound'></select><input type='text' id='"+t+"sound_filter' placeholder='Filter' class='medTF'>"),bindGenCom(t+"sound","change"),$(`#${t}sound_filter`).on("keyup",function(){updateSoundSelect(t+"sound",!0)}),updateSoundSelect(t+"sound",!0);break;case"writable_book_content":$(`#${t}inner_`+e).append("<div id='"+t+"WBP' class='AMControl roundedDiv'></div>"),createWritableBookForm(t+"WBP",0);break;case"written_book_content":$(`#${t}inner_`+e).append("<div id='"+t+"WrittenBP' class='AMControl roundedDiv'></div>"),createWrittenBookForm(t+"WrittenBP",0);break;case"lodestone_tracker":$(`#${t}inner_`+e).append("<div id='"+t+"LodestoneTracker' class='AMControl roundedDiv'></div>"),createComponent(t+"LodestoneTracker","LodestoneDimension",{noBR:!0,id:t+"Dim",type:"makeSelect",values:["unset","overworld","the_end","the_nether"],format:"special",cssClass:"fLabel100",tip:o,align:"R"},0),createComponent(t+"LodestoneTracker","LodestoneTracked",{id:t+"Tracked",type:"choice",values:unsetTrueFalse,format:"special",cssClass:"fLabel100",tip:o,align:"R"},0),createComponent(t+"LodestoneTracker","X",{id:t+"X",type:"text",cssClass:"fLabel100",format:"int",fwClass:"medTF",tip:o},0),createComponent(t+"LodestoneTracker","Y",{id:t+"Y",type:"text",cssClass:"fLabel100",format:"int",fwClass:"medTF"},0),createComponent(t+"LodestoneTracker","Z",{id:t+"Z",type:"text",cssClass:"fLabel100",format:"int",fwClass:"medTF"},0);break;case"map_id":createComponent(t+"inner_"+e,"map",{id:t+"map",type:"text",fwClass:"medTF",format:"int",noLabel:!0},0);break;case"map_color":createComponent(t+"inner_"+e,"MapColor",{id:t+"MapColor",type:"colorChooser",noLabel:!0},0);break;case"map_decorations":$(`#${t}inner_`+e).append("<div id='"+t+"Decorations' class='AMControl roundedDiv'><button id='"+t+"addDecoration' class='greenPlus'>Add</button></div>"),$("#"+t+"addDecoration").bind("click",function(){addMapDecoration(t+"Decorations")});break;case"fireworks":$(`#${t}inner_`+e).append("<div id='"+t+"FWR' class='AMControl roundedDiv'></div>"),createComponent(t+"FWR","Flight",{id:t+"Flight",type:"text",cssClass:"fLabel100",format:"b",tip:"rocket",noBR:!0},0),createComponent(t+"FWR","Explosion",{type:"fwExplosion",id:t+"Explosion",forItem:!0,entDescID:"e"+entityIndex+"_"+t,format:"special",cssClass:"fLabel100",tip:"fireworks_rocket.Explosion"},entityIndex);break;case"firework_explosion":$(`#${t}inner_`+e).append("<div style='display:inline;white-space: nowrap;' id='"+t+"Explosion' class='ExplosionPane'></div>"),addExplosion(t+"Explosion",!0);break;case"entity_data":-1!=o.indexOf("spawn_egg")?(entityIndex++,$(`#${t}inner_`+e).append("<input type='hidden' id='"+t+"_entID' value='"+entityIndex+"'>"),makeAddEntityPaneforSpawnEgg(t+"inner_"+e,"spawnEggMob_"+entityIndex,!0,o.substr(0,o.indexOf("_spawn_egg")))):"armor_stand"==o?(entityIndex++,$(`#${t}inner_`+e).append("<input type='hidden' id='"+t+"_entID' value='"+entityIndex+"'>"),n=(n="<div id='"+("armorStand"+entityIndex)+"' class='spawnPotentialContainer roundedDiv stackerAltColorB'>")+"<input type='hidden' id='entity"+entityIndex+"' value='armor_stand'><div id='entityPane"+entityIndex+"' class='entityWrapper'></div></div>",$(`#${t}inner_`+e).html().length&&(n="<br>"+n),$(`#${t}inner_`+e).append(n),entityChangeSpawnEgg(entityIndex,!1)):"painting"==o?($(`#${t}inner_`+e).append("<div id='"+t+"Painting' class='AMControl roundedDiv'></div>"),(n=paintingMotives.slice()).unshift("unset"),createComponent(t+"Painting","variant",{id:t+"variant",type:"makeSelect",values:n,format:"special",tip:"painting",cssClass:"fLabel100",align:"R",noBR:!0},entityIndex),createEntityTagNBT_In_Item(t,t+"Painting",entityIndex,paintingEntityTagNBTForItem)):"item_frame"!=o&&"glow_item_frame"!=o||($(`#${t}inner_`+e).append("<div id='"+t+"ItemFrame' class='AMControl roundedDiv'></div>"),createComponent(t+"ItemFrame","Item",{id:t+"ItemInFrame",type:"itemselect",forceConstruct:settings.loadItemUI,tip:"item",cssClass:"fLabel100",noShowHideButton:!0,noBR:!0},entityIndex),createComponent(t+"ItemFrame","ItemDropChance",{id:t+"ItemDropChance",type:"text",format:"f",tip:"item_frame",align:"R",cssClass:"fLabel100"},entityIndex),createComponent(t+"ItemFrame","ItemRotation",{id:t+"ItemRotation",type:"choice",values:[[-1,"unset"],["1","45&deg;"],["2","90&deg;"],["3","135&deg;"],["4","180&deg;"],["5","225&deg;"],["6","270&deg;"],["7","315&deg;"]],format:"b",tip:"item_frame",cssClass:"fLabel100"},entityIndex),createComponent(t+"ItemFrame","Invisible",{id:t+"Invisible",type:"choice",values:unsetTrueFalse,format:"b",tip:"item_frame",cssClass:"fLabel100"},entityIndex),createComponent(t+"ItemFrame","Fixed",{id:t+"Fixed",type:"choice",values:unsetTrueFalse,format:"b",tip:"item_frame",cssClass:"fLabel100"},entityIndex),createEntityTagNBT_In_Item(t,t+"ItemFrame",entityIndex,itemFrameEntityTagNBTForItem));break;case"charged_projectiles":$(`#${t}inner_`+e).append("<div id='"+t+"Projectiles' class='AMControl roundedDiv'></div>"),$("#"+t+"Projectiles").append("<button id='"+t+"addProjectile' class='greenPlus'>Add</button>"),$("#"+t+"addProjectile").bind("click",function(){addCrossbowProjectile(t+"Projectiles")});break;case"instrument":$(`#${t}inner_`+e).append("<div id='"+t+"Instrument' class='AMControl roundedDiv'></div>"),createComponent(t+"Instrument","instrument",{id:t+"instrument",type:"makeSelect",hasUnset:!0,cssClass:"fLabel100",values:["Custom Sound","ponder_goat_horn","sing_goat_horn","seek_goat_horn","feel_goat_horn","admire_goat_horn","call_goat_horn","yearn_goat_horn","dream_goat_horn"],tip:"goat_horn",align:"R"},0),createComponent(t+"Instrument","",{type:"panel",panelID:t+"config"},0),createComponent(t+"config","use_duration",{id:t+"use_duration",type:"text",cssClass:"fLabel100",tip:"goat_horn",align:"R",value:5},0),createComponent(t+"config","range",{id:t+"range",type:"text",cssClass:"fLabel100",tip:"goat_horn",align:"R",value:100},0),createComponent(t+"config","resource",{id:t+"resource",label:"resource location",type:"text",cssClass:"fLabel100",fwClass:"verybigTF",tip:"goat_horn",align:"R"},0),$("#"+t+"config").append("<br><span class='fLabel100'>sound_event</span><select id='"+t+"sound'></select><input type='text' id='"+t+"sound_filter' placeholder='Filter' class='medTF'>"+makeTip("goat_horn","sound")),bindGenCom(t+"sound","change"),$(`#${t}sound_filter`).on("keyup",function(){updateSoundSelect(t+"sound",!0)}),updateSoundSelect(t+"sound",!0),$("#"+t+"config br:first").remove(),$(`#${t}config`).hide(),$(`#${t}instrument`).on("change",function(){"Custom Sound"==$(`#${t}instrument`).val()?$(`#${t}config`).show():$(`#${t}config`).hide()}),$("#"+t+"config").append("<br><span class='fLabel100'>description</span>"+mkShowHide(t+"description",t+"descriptionSH")+"<div id='"+t+"description' class='roundedDiv JSONEditor'></div>"+makeTip("instrument.description")),createTellrawForm(t,0,"description",!1,"description"),hide(t+"description",t+"descriptionSH"),$("#"+t+"description br:first").remove(),$("#"+t+"description br:first").remove(),$("#"+t+"Instrument br:first").remove();break;case"bucket_entity_data":$(`#${t}inner_`+e).append("<div id='"+t+"FishBucket' class='AMControl roundedDiv'></div>"),createComponent(t+"FishBucket","NoGravity",{id:t+"NoGravity",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity",noBR:!0},entityIndex),createComponent(t+"FishBucket","Silent",{id:t+"Silent",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},entityIndex),createComponent(t+"FishBucket","Invulnerable",{id:t+"Invulnerable",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},entityIndex),createComponent(t+"FishBucket","Glowing",{id:t+"Glowing",type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"},entityIndex),createComponent(t+"FishBucket","NoAI",{id:t+"NoAI",type:"choice",values:unsetTrueFalse,format:"b",tip:"mob",align:"R"},entityIndex),createComponent(t+"FishBucket","Health",{id:t+"Health",type:"text",format:"f",tip:"mob",align:"R"},entityIndex),"tadpole_bucket"==o?createComponent(t+"FishBucket","Age",{id:t+"Age",type:"ticks",tip:"tadpole",align:"R"},entityIndex):"tropical_fish_bucket"==o?(createComponent(t+"FishBucket","Variant",{id:t+"Variant",type:"choice",values:[[0,"Random"],[1,"Specified Below"]],format:"special",tip:"tropical_fish",align:"R"},entityIndex),createComponent(t+"FishBucket","Size",{id:t+"Size",type:"choice",values:[[0,"Small"],[1,"Big"]],format:"special",align:"R"},entityIndex),createComponent(t+"FishBucket","Pattern",{id:t+"Pattern",type:"makeSelect",values:[0,1,2,3,4,5],format:"special",align:"R"},entityIndex),createComponent(t+"FishBucket","BaseColor",{id:t+"BaseColor",type:"choice",values:colours1,format:"special",align:"R"},entityIndex),createComponent(t+"FishBucket","PatternColor",{id:t+"PatternColor",type:"choice",values:colours1,format:"special",align:"R"},entityIndex)):"axolotl_bucket"==o&&createComponent(t+"FishBucket","Variant",{id:t+"Variant",type:"choice",values:[[-1,"unset"],["0","Lucy (Pink)"],["1","Wild (Brown)"],["2","Gold/Yellow"],["3","Cyan"],["4","Blue (Rare)"]],format:"int",tip:"axolotl",align:"R"},entityIndex);break;case"bundle_contents":createComponent(t+"inner_"+e,"BundleItems",{type:"multiitem",slotNumbers:!1,cssClass:"fLabel100",noShowHideButton:!0,noLabel:!0,id:t+"BundleItems"},0);break;case"recipes":$(`#${t}inner_`+e).append("<div id='"+t+"RecipesPane' class='AMControl roundedDiv'></div>"),createComponent(t+"RecipesPane","Recipe",{noBR:!0,id:t+"Recipes",cssClass:"fLabel100",type:"itemForRecipes"},0);break;case"pot_decorations":$(`#${t}inner_`+e).append("<div id='"+t+"PotDecor' class='AMControl roundedDiv'></div>"),createComponent(t+"PotDecor","Sherd0",{id:t+"Sherd0",label:"Sherd 1",type:"makeSelect",cssClass:"fLabel100",values:potterySherds,hasUnset:!0,format:"special",tip:"decorated_pot.sherd",noBR:!0},entityIndex),createComponent(t+"PotDecor","Sherd1",{id:t+"Sherd1",label:"Sherd 2",type:"makeSelect",cssClass:"fLabel100",values:potterySherds,hasUnset:!0,format:"special"},entityIndex),createComponent(t+"PotDecor","Sherd2",{id:t+"Sherd2",label:"Sherd 3",type:"makeSelect",cssClass:"fLabel100",values:potterySherds,hasUnset:!0,format:"special"},entityIndex),createComponent(t+"PotDecor","Sherd3",{id:t+"Sherd3",label:"Sherd 4",type:"makeSelect",cssClass:"fLabel100",values:potterySherds,hasUnset:!0,format:"special"},entityIndex);break;case"bees":$(`#${t}inner_`+e).append("<div id='"+t+"AddBees' class='AMControl roundedDiv'></div>"),createComponent(t+"AddBees","Bees",{id:t+"Bees",type:"beeforHive",cssClass:"fLabel100",noBR:!0},entityIndex);break;case"block_entity_data":if($(`#${t}inner_`+e).append("<div id='"+t+"BEDPanel' class='AMControl roundedDiv'></div>"),-1!=o.indexOf("sign")){for(r in createComponent(t+"BEDPanel","is_waxed",{id:t+"is_waxed",type:"choice",values:unsetTrueFalse,format:"b",tip:"sign",align:"R"},0),p=getCommandStatsFormNBT()){var l={id:t+r};Object.assign(l,p[r]),createComponent(t+"BEDPanel",r,l,0)}createSignForm(t,t+"BEDPanel",0)}else if(["command_block","repeating_command_block","chain_command_block"].includes(o)){var r,c=getCommandBlockFieldsFormNBT(),p=(delete c.CustomName,getCommandStatsFormNBT());for(r in Object.assign(c,p),c){l={id:t+r};Object.assign(l,c[r]),createComponent(t+"BEDPanel",r,l,0)}}else if("decorated_pot"==o)createComponent(t+"BEDPanel","LootTable",{id:t+"LootTable",label:"LootTable",type:"text",cssClass:"fLabel100",fwClass:"bigTF",format:"string",tip:"decorated_pot.LootTable",noShowHideButton:!0},entityIndex);else if("lectern"==o)createComponent(t+"BEDPanel","Page",{id:t+"Page",cssClass:"fLabel40",type:"text",format:"int",tip:"lectern"},entityIndex),createComponent(t+"BEDPanel","Book",{id:t+"Book",cssClass:"fLabel40",type:"itemselect",forceConstruct:settings.loadItemUI,tip:"lectern",noShowHideButton:!0},entityIndex);else if("hopper"==o)createComponent(t+"BEDPanel","TransferCooldown",{id:t+"TransferCooldown",cssClass:"fLabel100",type:"ticks",format:"short",tip:"hopper.TransferCooldown"},entityIndex);else if("brewing_stand"==o)createComponent(t+"BEDPanel","BrewTime",{id:t+"BrewTime",cssClass:"fLabel100",type:"ticks",tip:"brewing_stand.BrewTime"},entityIndex),createComponent(t+"BEDPanel","Fuel",{id:t+"Fuel",cssClass:"fLabel100",type:"text",format:"b",tip:"brewing_stand.Fuel"},entityIndex);else if("furnace"==o||"blast_furnace"==o||"smoker"==o)createComponent(t+"BEDPanel","cooking_time_spent",{id:t+"cooking_time_spent",cssClass:"fLabel100",type:"ticks",tip:"furnace.cooking_time_spent"},entityIndex),createComponent(t+"BEDPanel","cooking_total_time",{id:t+"cooking_total_time",cssClass:"fLabel100",type:"ticks",tip:"furnace.cooking_total_time"},entityIndex),createComponent(t+"BEDPanel","lit_time_remaining",{id:t+"lit_time_remaining",cssClass:"fLabel100",type:"ticks",tip:"furnace.lit_time_remaining"},entityIndex),createComponent(t+"BEDPanel","lit_total_time",{id:t+"lit_total_time",cssClass:"fLabel100",type:"ticks",tip:"furnace.lit_total_time"},entityIndex),createComponent(t+"BEDPanel","RecipesUsed",{id:t+"RecipesUsed",cssClass:"fLabel100",type:"RecipesUsed",format:"special",tip:"furnace.RecipesUsed"},entityIndex);else if("crafter"==o)createCrafterUI(t+"BEDPanel",0);else if("vault"==o)createVaultUI(t+"BEDPanel",0);else if("trial_spawner"==o)createTrialSpawnerUI(t+"BEDPanel",0);else if("spawner"==o)createMonsterSpawnerUI(t+"BEDPanel",0);else if(-1!=o.indexOf("campfire"))for(let e=0;e<4;e++)createComponent(t+"BEDPanel","CookingTime"+e,{id:t+"CookingTime"+e,type:"ticks",format:"special",tip:"campfire.CookingTime",label:"CookingTime "+e}),createComponent(t+"BEDPanel","CookingTotalTime"+e,{id:t+"CookingTotalTime"+e,type:"ticks",format:"special",tip:"campfire.CookingTotalTime",label:"CookingTotalTime "+e});else"beehive"==o||"bee_nest"==o?(createComponent(t+"BEDPanel","flower_posX",{id:t+"flower_posX",type:"text",cssClass:"fLabel100",format:"special",align:"R",tip:"beehive.FlowerPos"},entityIndex),createComponent(t+"BEDPanel","flower_posY",{id:t+"flower_posY",type:"text",cssClass:"fLabel100",format:"special",align:"R"},entityIndex),createComponent(t+"BEDPanel","flower_posZ",{id:t+"flower_posZ",type:"text",cssClass:"fLabel100",format:"special",align:"R"},entityIndex)):"suspicious_sand"!=o&&"suspicious_gravel"!=o||(createComponent(t+"BEDPanel","item",{id:t+"item",cssClass:"fLabel100",type:"itemselect",forceConstruct:settings.loadItemUI,tip:"suspicious_sand.item",noShowHideButton:!0},entityIndex),createComponent(t+"BEDPanel","LootTable",{id:t+"LootTable",cssClass:"fLabel100",type:"text",fwClass:"bigTF",format:"string",tip:"suspicious_sand.LootTable"},entityIndex));$(`#${t}BEDPanel br:first`).remove();break;case"container":if($(`#${t}inner_`+e).append("<div id='"+t+"ContainerPanel' class='AMControl roundedDiv'></div>"),-1!=o.indexOf("campfire")||"barrel"==o||"chest"==o||"trapped_chest"==o||"brewing_stand"==o||"dispenser"==o||"dropper"==o||"furnace"==o||"blast_furnace"==o||"smoker"==o||"hopper"==o||"chiseled_bookshelf"==o||-1!=o.indexOf("shulker_box")){var d=slotCounts[o]||27;itemDuplicatorForContainer(t+"ContainerPanel",t,d);for(var m=0;m<d;m++)createComponent(t+"ContainerPanel",m+"Slot",{type:"itemselect",format:"special",cssClass:"fLabel100",hide:!0,label:"Slot "+m,id:t+"Slot"+m},entityIndex)}else"decorated_pot"==o&&createComponent(t+"ContainerPanel","0Slot",{noBR:!0,id:t+"Slot0",type:"itemselect",forceConstruct:!0,format:"special",cssClass:"fLabel40",noLabel:!0,tip:"decorated_pot.item",noShowHideButton:!0},entityIndex);break;case"lock":createComponent(t+"inner_"+e,"lock",{id:t+"lock",noLabel:!0,type:"itemselect",forceConstruct:settings.loadItemUI,noShowHideButton:!0},entityIndex);break;case"container_loot":createComponent(t+"inner_"+e,"LootTable",{noLabel:!0,noBR:!0,id:t+"LootTable",type:"text",cssClass:"fLabel100",fwClass:"bigTF",format:"string"},entityIndex);break;case"base_color":createComponent(t+"inner_"+e,"Base Color",{noLabel:!0,noBR:!0,id:t+"BaseColor",type:"makeSelect",values:signColors,hasUnset:!0,format:"string",cssClass:"fLabel100",fwClass:"bigTF"},0);break;case"banner_patterns":createComponent(t+"inner_"+e,"Patterns",{noLabel:!0,noBR:!0,id:t+"BannerPatterns",type:"text",cssClass:"fLabel100",fwClass:"bigTF"},0)}}}}function itemDuplicatorForBlocksWithSlots(e,s,i){$("#"+e).append(`<br><span class='fLabel200'></span><button class='mButton' id='${s}_DuplicateSlot'>Duplicate First Slot</button><input type='checkbox' id='${s}_DuplicateOverwrite'>Overwrite`+makeTip("slot.duplicate")),$(`#${s}_DuplicateSlot`).on("click",function(){deferOutput=deferJSONOutput=!0;var e=getItemNBT("Slot0"+s),t=$(`#${s}_DuplicateOverwrite`).is(":checked");if("{}"!=e){var o=new CMDParser(e);const n=o.parseCompound(e);for(let a=1;a<i;a++)if(t||"{}"==getItemNBT("Slot"+a+s)){let t=`Slot${a}${s}_ui`;setupItemSlotForNBT("Slot"+a+s,n,o),$(`#Slot${a}${s}ItemPane > .inner_component`).each(function(){var e=this.id.substring(t.length);(null==n.components||null!=n.components&&null==n.components.val[e]&&null==n.components.val["minecraft:"+e])&&$(`#Slot${a}${s}remove_`+e).trigger("click")})}}else for(let e=1;e<i;e++)!t&&"{}"!=getItemNBT("Slot"+e+s)||unsetItem("Slot"+e+s);deferOutput=deferJSONOutput=!1,generateCommand()})}function itemDuplicatorForMultiItem(e,a){$("#"+e).append(`<span class='fLabel100'></span><button class='mButton' id='${a}_DuplicateSlot'>Duplicate First Slot</button><input type='checkbox' id='${a}_DuplicateOverwrite'>Overwrite`+makeTip("slot.duplicate")),$(`#${a}_DuplicateSlot`).on("click",function(){deferOutput=deferJSONOutput=!0;let t=null;const o=$(`#${a}_DuplicateOverwrite`).is(":checked");let n,s;$("#"+a+"MultiItemPane  > .itemSelectControl").each(function(e){let a=this.id.substr(0,this.id.lastIndexOf("Pane"));if(null==t)t=getItemNBT(a),s=new CMDParser(t),n=s.parseCompound(t);else if("{}"!=t){if(o||"{}"==getItemNBT(a)){let t=a+"_ui";setupItemSlotForNBT(a,n,s),$(`#${a}ItemPane > .inner_component`).each(function(){var e=this.id.substring(t.length);(null==n.components||null!=n.components&&null==n.components.val[e]&&null==n.components.val["minecraft:"+e])&&$(`#${a}remove_`+e).trigger("click")})}}else!o&&"{}"!=getItemNBT(a)||unsetItem(""+a)}),deferOutput=deferJSONOutput=!1,generateCommand()})}function itemDuplicatorForContainer(e,s,i){$("#"+e).append(`<span class='fLabel100'></span><button class='mButton' id='${s}_DuplicateSlot'>Duplicate First Slot</button><input type='checkbox' id='${s}_DuplicateOverwrite'>Overwrite`+makeTip("slot.duplicate")),$(`#${s}_DuplicateSlot`).on("click",function(){deferOutput=deferJSONOutput=!0;var e=getItemNBT(s+"Slot0"),t=$(`#${s}_DuplicateOverwrite`).is(":checked");if("{}"!=e){var o=new CMDParser(e);const n=o.parseCompound(e);for(let a=1;a<i;a++)if(t||"{}"==getItemNBT(s+"Slot"+a)){let t=`${s}Slot${a}_ui`;setupItemSlotForNBT(s+"Slot"+a,n,o),$(`#${s}Slot${a}ItemPane > .inner_component`).each(function(){var e=this.id.substring(t.length);(null==n.components||null!=n.components&&null==n.components.val[e]&&null==n.components.val["minecraft:"+e])&&$(`#${s}Slot${a}remove_`+e).trigger("click")})}}else for(let e=1;e<i;e++)!t&&"{}"!=getItemNBT(s+"Slot"+e)||unsetItem(s+"Slot"+e);deferOutput=deferJSONOutput=!1,generateCommand()})}var entityDescriptors,mobSpawnerNBT,beeHiveNestNBT,sculkCatalystNBT,settings,globalComponentList=[],itemsAndBlocks={},linkMode=!0,desktopMode=!0,electronMode=!1,unsetTrueFalse=[[-1,"unset"],["1","True"],["0","False"]],paintingEntityTagNBTForItem=["Invulnerable","Silent","Glowing","CustomName","CustomNameVisible","Tags","UUID"],itemFrameEntityTagNBTForItem=["Invulnerable","Silent","Glowing","Tags","UUID"],slotCounts={soul_campfire:4,campfire:4,chest:27,trapped_chest:27,brewing_stand:5,dropper:9,dispenser:9,blast_furnace:3,smoker:3,furnace:3,hopper:5,barrel:27,chiseled_bookshelf:6},zIndex=11,entityIndex=0,mouse={x:0,y:0},currentCommand="",tsScoreObjectiveCount=0,processing=!1,formats=["Bold","Italic","Underlined","Strikethrough","Obfuscated"],blocks=[],cachedNBT=new CachedNBT,deferJSONOutput=!1,deferOutput=!1,deferHistoryOutput=!1,cmdHistory={MAX_COMMANDS:100,index:0,commands:[]},hasBlockData=[],structureBlockNBT={name:{type:"text",format:"string",tip:"structure_block"},author:{type:"text",format:"string",tip:"structure_block"},metadata:{type:"text",format:"string",tip:"structure_block"},posX:{type:"text",format:"int",tip:"structure_block"},posY:{type:"text",format:"int",tip:"structure_block"},posZ:{type:"text",format:"int",tip:"structure_block"},sizeX:{type:"text",format:"int",tip:"structure_block"},sizeY:{type:"text",format:"int",tip:"structure_block"},sizeZ:{type:"text",format:"int",tip:"structure_block"},rotation:{type:"makeSelect",values:["NONE","CLOCKWISE_90","CLOCKWISE_180","COUNTERCLOCKWISE_90"],format:"string",tip:"structure_block"},mirror:{type:"makeSelect",values:["NONE","LEFT_RIGHT","FRONT_BACK"],format:"string",tip:"structure_block"},mode:{type:"makeSelect",values:["SAVE","LOAD","CORNER","DATA"],format:"string",tip:"structure_block"},ignoreEntities:{type:"choice",values:unsetTrueFalse,format:"b",tip:"structure_block"},integrity:{type:"text",format:"f",tip:"structure_block"},seed:{type:"text",format:"int",tip:"structure_block"},showboundingbox:{type:"choice",values:unsetTrueFalse,format:"b",tip:"structure_block"},strict:{type:"choice",values:unsetTrueFalse,format:"b",tip:"structure_block"}};function createCommandButtons(){$("#nav").empty();for(const e of commandList)linkMode?$("#nav").append(`<a href="?cmd=${e.replaceAll(" ","_")}" class='mainButtons combut'>/${e}</a>`):$("#nav").append(`<a href="javascript:loadForm('${e}')" class='mainButtons combut'>/${e}</a>`);$("#nav").append("<select id='homePageCommandChooser' class='mainButtons'></select>");for(const t of commandList)$("#homePageCommandChooser").append(`<option value="/${t}">/${t}</option>`);$("#homePageCommandChooser").bind("change",function(){loadForm($("#homePageCommandChooser").val().substr(1))})}function loadItemsAndBlocks(a,e){function o(e,t){return e[1].length-t[1].length||e[1].localeCompare(t[1])}function n(e,t){return e[0].localeCompare(t[0])}function s(e,t){return e[1].localeCompare(t[1])}$.getJSON("./lang1.21.5/"+("ids"==a?"en":a)+".json",{async:!1},function(t){switch(itemsAndBlocks={},settings.sortMode){case"item_id":t=t.sort(n);break;case"item_desc":t=t.sort(s);break;default:t=t.sort(o)}t.unshift(["-1","unset","b"]);for(let e=0;e<t.length;e++)itemsAndBlocks[t[e][0]]={d:t[e]["ids"==a?0:1],c:t[e][2]};itemsAndBlocks[-1].d="unset",t=null,hasBlockData.length||buildListOfBlocksWithData(),null!=e&&loadForm(e)})}function addToHistory(e){var t;-1==e.indexOf("data merge block")&&(-1==(t=cmdHistory.commands.indexOf(e))?(cmdHistory.commands.length>=cmdHistory.MAX_COMMANDS&&cmdHistory.commands.shift(),cmdHistory.commands.push(e),cmdHistory.index=cmdHistory.commands.length-1,localStorage.cmdHistory=JSON.stringify(cmdHistory)):cmdHistory.index=t)}function loadFromHistory(e){deferHistoryOutput||(deferHistoryOutput=!0,0<=(e=cmdHistory.index+e)&&e<cmdHistory.commands.length&&(parseNBT(cmdHistory.commands[e],CURRENT_VERSION),cmdHistory.index=e),deferHistoryOutput=!1,generateCommand())}function initBeeHiveNestNBT(){null==beeHiveNestNBT&&(beeHiveNestNBT={flower_posX:{type:"text",format:"special",align:"R",tip:"beehive.FlowerPos"},flower_posY:{type:"text",format:"special",align:"R"},flower_posZ:{type:"text",format:"special",align:"R"},Bees:{type:"beeforHive",format:"special"}})}function initSculkCatalystNBT(){null==sculkCatalystNBT&&(sculkCatalystNBT={cursors:{type:"cursorsForCatalyst",format:"special"}})}function stripHTMLTags(e){return(new DOMParser).parseFromString(e,"text/html").body.textContent||""}function MCSException(e){this.value=e,this.toString=function(){return this.value}}function loadEntityClass(e,t){switch(e){case"bat":return new Mob(t,e,{BatFlags:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"dolphin":return new Mob(t,e,{CanFindTreasure:{type:"choice",values:unsetTrueFalse,tip:e,format:"b",align:"R"},Moistness:{type:"ticks",tip:e,align:"R"},GotFish:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},Age:{type:"ticks",tip:e,align:"R"}});case"pufferfish":return new Mob(t,e,{PuffState:{type:"choice",values:[[-1,"unset"],["0","Deflated"],["1","Half Puffed"],["2","Fully Puffed"]],format:"int",align:"R"}});case"axolotl":return new BreedableMob(t,e,{Variant:{type:"choice",values:[[-1,"unset"],["0","Lucy (Pink)"],["1","Wild (Brown)"],["2","Gold/Yellow"],["3","Cyan"],["4","Blue (Rare)"]],format:"int",tip:e,align:"R"},FromBucket:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"tadpole":return new Mob(t,e,{Age:{type:"ticks",tip:e,align:"R"},FromBucket:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"frog":return new BreedableMob(t,e,{variant:{type:"choice",values:biomeVariant,format:"string",tip:e,align:"R"}});case"bogged":return new Mob(t,e,{sheared:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"glow_squid":return new Mob(t,e,{DarkTicksRemaining:{type:"ticks",tip:e,align:"R"},Age:{type:"ticks",tip:"squid",align:"R"}});case"squid":return new Mob(t,e,{Age:{type:"ticks",tip:e,align:"R"}});case"armadillo":return new BreedableMob(t,e,{state:{type:"makeSelect",hasUnset:!0,values:["idle","scared"],format:"string",tip:e,align:"R"}});case"salmon":return new Mob(t,e,{type:{type:"makeSelect",hasUnset:!0,values:["small","medium","large"],format:"string",tip:e,align:"R"}});case"cave_spider":case"elder_guardian":case"guardian":case"silverfish":case"skeleton":case"giant":case"breeze":case"spider":case"stray":case"wither_skeleton":case"cod":case"strider":case"blaze":return new Mob(t,e);case"bee":return new Bee(t,e);case"creaking":return new Creaking(t,e);case"tropical_fish":return new tropical_fish(t,e);case"piglin":return new Piglin(t,e,{Inventory:{type:"multiitem",hide:!0,slotNumbers:!1,tip:e},IsBaby:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},IsImmuneToZombification:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},TimeInOverworld:{type:"ticks",tip:e,align:"R"},CannotHunt:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"zoglin":return new Mob(t,e,{IsBaby:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"piglin_brute":return new Piglin(t,e,{IsImmuneToZombification:{type:"choice",values:unsetTrueFalse,format:"b",tip:"piglin",align:"R"},TimeInOverworld:{type:"ticks",tip:"piglin",align:"R"}});case"husk":case"zombie":return new zombie(t,e,{DrownedConversionTime:{type:"ticks",tip:"zombie",align:"R"},InWaterTime:{type:"ticks",tip:"zombie",align:"R"}});case"drowned":return new zombie(t,e);case"zombified_piglin":return new zombie(t,e,{AngerTime:{type:"ticks",tip:e,align:"R"},AngryAt:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:e}});case"zombie_villager":return new zombie(t,e,{ConversionTime:{type:"ticks",tip:e,align:"R"},ConversionPlayer:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:e},profession:{type:"makeSelect",values:["unset","none","armorer","butcher","cartographer","cleric","farmer","fisherman","fletcher","leatherworker","librarian","mason","nitwit","shepherd","toolsmith","weaponsmith"],format:"special",tip:e,align:"R"},type:{type:"makeSelect",values:["unset","desert","jungle","plains","savanna","snow","swamp","taiga"],format:"special",tip:"villager.type",align:"R"},level:{type:"makeSelect",values:["unset",1,2,3,4,5,99],format:"special",tip:"villager.level",align:"R"},Trades:{type:"villTrade",format:"special",tip:"villager.Trades",align:"R"},Memories:{type:"memories",format:"special",tip:"villager.memories",align:"R"},Gossips:{type:"gossips",format:"special",tip:"villager.gossips",align:"R"},NoTrades:{label:"Untradable",type:"cb",format:"special",tip:"villager.NoTrades",align:"R"}});case"area_effect_cloud":return new area_effect_cloud(t,e);case"armor_stand":return new armor_stand(t,e);case"trident":return new trident(t,e);case"arrow":case"spectral_arrow":return new arrow(t,e);case"polar_bear":return new BreedableMob(t,e,{AngerTime:{type:"ticks",tip:e,align:"R"},AngryAt:{type:"UUIDArray",align:"R",playerLookup:!0,tip:e}});case"slime":return new Mob(t,e,{Size:{type:"text",format:"int",tip:e,align:"R"},wasOnGround:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"magma_cube":return new Mob(t,e,{Size:{type:"text",format:"int",tip:"slime",align:"R"},wasOnGround:{type:"choice",values:unsetTrueFalse,format:"b",tip:"slime",align:"R"}});case"firework_rocket":return new firework_rocket(t,e);case"warden":return new warden(t,e);case"phantom":return new Phantom(t,e);case"enderman":return new enderman(t,e,{AngerTime:{type:"ticks",tip:e,align:"R"},AngryAt:{type:"UUIDArray",align:"R",playerLookup:!0,tip:e}});case"witch":case"pillager":return new pillager(t,e);case"illusioner":return new pillager(t,e,{SpellTicks:{type:"ticks",tip:"evoker",align:"R"}});case"evoker":return new pillager(t,e,{SpellTicks:{type:"ticks",tip:e,align:"R"}});case"vindicator":return new pillager(t,e,{Johnny:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"ravager":return new pillager(t,e,{AttackTick:{type:"ticks",tip:e,align:"R"},RoarTick:{type:"ticks",tip:e,align:"R"},StunTick:{type:"ticks",tip:e,align:"R"}});case"endermite":return new Mob(t,e,{Lifetime:{type:"ticks",tip:e,align:"R"},PlayerSpawned:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"dragon_fireball":case"wither_skull":case"small_fireball":return new small_fireball(t,e);case"fireball":return new fireball(t,e);case"breeze_wind_charge":case"wind_charge":return new wind_charge(t,e);case"potion":case"splash_potion":case"lingering_potion":return new potion(t,e);case"eye_of_ender":return new eye_of_ender(t,e);case"ender_pearl":case"snowball":case"experience_bottle":case"egg":return new ThrownThings(t,e);case"end_crystal":return new ender_crystal(t,e);case"ender_dragon":return new Mob(t,e,{DragonPhase:{type:"choice",values:[[-1,"unset"],[1,"strafing(preparing to shoot a fireball)"],[2,"flying to the portal to land"],[3,"landing on the portal"],[4,"taking off from the portal"],[5,"landed, performing breath attack"],[6,"landed, looking for a player for breath attack"],[7,"landed, roar before beginning breath attack"],[8,"charging player"],[9,"flying to portal to die"],[10,"hovering with no AI (Default)"]],format:"int",tip:e,align:"R"}});case"evoker_fangs":return new evoker_fangs(t,e);case"falling_block":return new falling_block(t,e);case"ominous_item_spawner":return new ominous_item_spawner(t,e);case"item":return new item(t,e);case"glow_item_frame":case"item_frame":return new item_frame(t,e);case"oak_boat":case"spruce_boat":case"birch_boat":case"jungle_boat":case"acacia_boat":case"cherry_boat":case"pale_oak_boat":case"dark_oak_boat":case"mangrove_boat":case"bamboo_raft":return new Vehicle(t,e,{Fire:{type:"ticks",tip:"entity"},HasVisualFire:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"}});case"ghast":return new Mob(t,e,{ExplosionPower:{type:"text",format:"int",tip:e,align:"R"}});case"minecart":return new minecart(t,e);case"tnt_minecart":return new minecart(t,e,{fuse:{type:"ticks",tip:e,align:"R"},explosion_speed_factor:{type:"text",format:"f",tip:e,align:"R"}});case"chest_minecart":return new chest_minecart(t,e,27);case"oak_chest_boat":case"spruce_chest_boat":case"birch_chest_boat":case"jungle_chest_boat":case"acacia_chest_boat":case"cherry_chest_boat":case"pale_oak_chest_boat":case"dark_oak_chest_boat":case"mangrove_chest_boat":case"bamboo_chest_raft":return new chest_boat(t,e,27);case"hopper_minecart":return new hopper_minecart(t,e,5);case"furnace_minecart":return new minecart(t,e,{PushX:{type:"text",format:"d",tip:e,align:"R"},PushZ:{type:"text",format:"d",tip:e,align:"R"},Fuel:{type:"ticks",tip:e,align:"R"}});case"spawner_minecart":return new spawner_minecart(t,e);case"command_block_minecart":return new minecart(t,e,{Command:{type:"text",format:"string",tip:e,align:"R"},SuccessCount:{type:"text",format:"int",tip:e,align:"R"},LastOutput:{type:"text",format:"string",tip:e,align:"R"},TrackOutput:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"chicken":return new BreedableMob(t,e,{IsChickenJockey:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},EggLayTime:{type:"ticks",tip:e,align:"R"},variant:{type:"choice",values:biomeVariant,format:"string",tip:e,align:"R"}});case"creeper":return new Mob(t,e,{powered:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},ExplosionRadius:{type:"text",format:"b",tip:e,align:"R"},Fuse:{type:"ticks",tip:e,align:"R"},ignited:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"mooshroom":return new Mooshroom(t,e);case"goat":return new BreedableMob(t,e,{IsScreamingGoat:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},HasLeftHorn:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},HasRightHorn:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"sniffer":return new BreedableMob(t,e);case"cow":return new BreedableMob(t,e,{variant:{type:"choice",values:biomeVariant,format:"string",tip:e,align:"R"}});case"hoglin":return new BreedableMob(t,e,{IsImmuneToZombification:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},TimeInOverworld:{type:"ticks",tip:e,align:"R"},CannotBeHunted:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"lightning_bolt":return new lightning_bolt(t,e);case"fishing_bobber":return new fishing_bobber(t,e);case"horse":case"camel":case"llama":case"trader_llama":case"donkey":case"mule":case"zombie_horse":case"skeleton_horse":return new HorseMob(t,e);case"block_display":case"item_display":case"text_display":return new DisplayEntity(t,e);case"interaction":return new InteractionEntity(t,e);case"marker":case"leash_knot":return new SimpleEntity(t,e);case"llama_spit":return new llama_spit(t,e);case"turtle":return new Turtle(t,e);case"fox":return new Fox(t,e);case"wolf":return new BreedableMob(t,e,{Owner:{type:"UUIDArray",format:"intArray",align:"R",tip:"mob.Owner",playerLookup:!0},Sitting:{type:"choice",values:unsetTrueFalse,format:"b",tip:"tameable",align:"R"},AngerTime:{type:"ticks",tip:e,align:"R"},AngryAt:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:e},variant:{type:"makeSelect",hasUnset:!0,values:["pale","woods","ashen","black","chestnut","rusty","spotted","striped","snowy"],format:"string",tip:e,align:"R"},CollarColor:{type:"makeSelectWithIndexes",hasUnset:!0,values:woolDyes,format:"b",tip:e,align:"R"}});case"parrot":return new Mob(t,e,{Owner:{type:"UUIDArray",format:"intArray",align:"R",tip:"mob.Owner",playerLookup:!0},Sitting:{type:"choice",values:unsetTrueFalse,format:"b",tip:"tameable",align:"R"},Variant:{type:"choice",values:[[-1,"unset"],[0,"Red"],[1,"Blue"],[2,"Green"],[3,"Cyan"],[4,"Silver"]],format:"int",tip:e,align:"R"}});case"ocelot":return new BreedableMob(t,e,{Owner:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:"mob.Owner"},Sitting:{type:"choice",values:unsetTrueFalse,format:"b",tip:"tameable",align:"R"}});case"cat":return new BreedableMob(t,e,{Owner:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:"mob.Owner"},Sitting:{type:"choice",values:unsetTrueFalse,format:"b",tip:"tameable",align:"R"},variant:{type:"choice",values:[[-1,"unset"],["minecraft:all_black","Black"],["minecraft:british_shorthair","British Shorthair"],["minecraft:calico","Calico"],["minecraft:jellie","Jellie"],["minecraft:persian","Persian"],["minecraft:ragdoll","Ragdoll"],["minecraft:red","Red"],["minecraft:siamese","Siamese"],["minecraft:tabby","Tabby"],["minecraft:black","Tuxedo"],["minecraft:white","White"]],format:"string",tip:e,align:"R"},CollarColor:{type:"makeSelectWithIndexes",hasUnset:!0,values:woolDyes,format:"b",align:"R",tip:e}});case"pig":return new BreedableMob(t,e,{variant:{type:"choice",values:biomeVariant,format:"string",tip:e,align:"R"}});case"panda":return new BreedableMob(t,e,{MainGene:{type:"makeSelect",values:["normal","aggressive","weak","lazy","worried","playful","brown"],format:"string",tip:e,align:"R"},HiddenGene:{type:"makeSelect",values:["normal","aggressive","weak","lazy","worried","playful","brown"],format:"string",tip:e,align:"R"}});case"painting":return new painting(t,e,{facing:{type:"choice",values:[[-1,"unset"],["0","South"],["1","West"],["2","North"],["3","East"]],format:"b",tip:e,align:"R"},variant:{type:"makeSelect",values:paintingMotives,format:"special",tip:e,align:"R"},Invulnerable:{type:"choice",values:unsetTrueFalse,format:"b",tip:"entity"}});case"rabbit":return new BreedableMob(t,e,{RabbitType:{type:"choice",values:[[-1,"unset"],[0,"Brown"],[1,"White"],[2,"Black"],[3,"Black &amp; White"],[4,"Gold"],[5,"Salt &amp; Pepper"],[99,"Killer Bunny"]],format:"int",tip:e,align:"R"},MoreCarrotTicks:{type:"ticks",tip:e,align:"R"}});case"sheep":return new BreedableMob(t,e,{Sheared:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},Color:{type:"makeSelectWithIndexes",values:woolDyes,format:"b",tip:e,hasUnset:!0,align:"R"}});case"shulker":return new Mob(t,e,{Peek:{type:"text",format:"b",tip:e,align:"R"},AttachFace:{type:"choice",values:[[0,"Above"],[1,"Below"],[2,"South"],[3,"North"],[4,"East"],[5,"West"]],format:"b",tip:e,align:"R"},Color:{type:"makeSelectWithIndexes",values:woolDyes.concat("Default"),format:"b",tip:e,hasUnset:!0,align:"R"},APX:{type:"text",format:"int",tip:"shulker.AP",align:"R"},APY:{type:"text",format:"int",tip:"shulker.AP",align:"R"},APZ:{type:"text",format:"int",tip:"shulker.AP",align:"R"}});case"shulker_bullet":return new shulker_bullet(t,e);case"snow_golem":return new Mob(t,e,{Pumpkin:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"}});case"tnt":return new tnt(t,e);case"vex":return new Vex(t,e);case"wandering_trader":case"villager":return new villager(t,e);case"allay":return new allay(t,e);case"iron_golem":return new Mob(t,e,{PlayerCreated:{type:"choice",values:unsetTrueFalse,format:"b",tip:e,align:"R"},AngerTime:{type:"ticks",tip:e,align:"R"},AngryAt:{type:"UUIDArray",align:"R",playerLookup:!0,tip:e}});case"wither":return new Mob(t,e,{Invul:{type:"ticks",tip:e,align:"R"}});case"experience_orb":return new SimpleEntity(t,e,{Age:{type:"ticks",tip:"xp_orb",align:"R"},Count:{type:"text",format:"int",tip:"xp_orb",align:"R"},Health:{type:"text",format:"b",tip:"xp_orb",align:"R"},Value:{type:"text",format:"short",tip:"xp_orb",align:"R"}});case"player":return new Player(t,e)}return null}function loadBlockClass(e){if(null==e)return new Block(e,{});if(-1!=e.indexOf("shulker_box"))return new BlockWithSlots(e,{LootTable:{type:"text",fwClass:"bigTF",format:"string",tip:"chest.LootTable"}},27);switch(e){case"white_banner":case"orange_banner":case"magenta_banner":case"light_blue_banner":case"yellow_banner":case"lime_banner":case"pink_banner":case"gray_banner":case"light_gray_banner":case"cyan_banner":case"purple_banner":case"blue_banner":case"brown_banner":case"green_banner":case"red_banner":case"black_banner":case"white_wall_banner":case"orange_wall_banner":case"magenta_wall_banner":case"light_blue_wall_banner":case"yellow_wall_banner":case"lime_wall_banner":case"pink_wall_banner":case"gray_wall_banner":case"light_gray_wall_banner":case"cyan_wall_banner":case"purple_wall_banner":case"blue_wall_banner":case"brown_wall_banner":case"green_wall_banner":case"red_wall_banner":case"black_wall_banner":return new Banner(e,{BlockEntityTag:{type:"text",fwClass:"bigTF",format:"special",tip:"banner"},CustomName:{type:"customNameJSON",format:"special",tip:"banner.CustomName"}});case"enchanting_table":return new Block(e,{CustomName:{type:"customNameJSON",format:"special",tip:"enchanting_table.CustomName"}});case"sculk_shrieker":return new Block(e,{warning_level:{hasUnset:!0,type:"makeSelect",values:[0,1,2,3,4],format:"int",tip:"sculk_shrieker"}});case"beacon":return new Beacon(e);case"bee_nest":case"beehive":return new BeeHiveNest(e);case"chest":case"barrel":case"trapped_chest":return new BlockWithSlots(e,{LootTable:{type:"text",fwClass:"bigTF",format:"string",tip:"chest.LootTable"}},27);case"brewing_stand":return new BlockWithSlots(e,{BrewTime:{type:"ticks",tip:e},Fuel:{type:"text",format:"b",tip:e}},5);case"dropper":case"dispenser":return new BlockWithSlots(e,{LootTable:{type:"text",fwClass:"bigTF",format:"string",tip:"chest.LootTable"}},9);case"blast_furnace":case"smoker":case"furnace":return new BlockWithSlots(e,{cooking_time_spent:{type:"ticks",tip:"furnace.cooking_time_spent"},cooking_total_time:{type:"ticks",tip:"furnace.cooking_total_time"},lit_time_remaining:{type:"ticks",tip:"furnace.lit_time_remaining"},lit_total_time:{type:"ticks",tip:"furnace.lit_total_time"},RecipesUsed:{type:"RecipesUsed",tip:"furnace.RecipesUsed"}},3);case"soul_campfire":case"campfire":return new campfire(e,{},4);case"crafter":return new crafter(e);case"hopper":return new BlockWithSlots(e,{TransferCooldown:{type:"text",tip:e,format:"short"},LootTable:{type:"text",fwClass:"bigTF",format:"string",tip:"chest.LootTable"}},5);case"comparator":return new Block(e,{OutputSignal:{type:"text",tip:"comparator.OutputSignal",format:"int"}});case"command_block":case"repeating_command_block":case"chain_command_block":return new CommandBlock(e);case"decorated_pot":return new DecoratedPot(e,{});case"end_gateway":return new EndGateway(e,{Age:{type:"text",tip:e,format:"long"},ExactTeleport:{type:"choice",values:unsetTrueFalse,tip:e,format:"b"},exit_portalX:{type:"text",format:"special",tip:"end_gateway.ExitPortal",align:"R"},exit_portalY:{type:"text",format:"special",align:"R"},exit_portalZ:{type:"text",format:"special",align:"R"}});case"jukebox":return new JukeBox(e,{RecordItem:{type:"itemselect",forceConstruct:!0,tip:e}});case"suspicious_gravel":case"suspicious_sand":return new SusSand(e,{item:{type:"itemselect",forceConstruct:!0,tip:"suspicious_sand.item"},LootTable:{type:"text",fwClass:"bigTF",format:"string",tip:"suspicious_sand.LootTable"}});case"sculk_catalyst":return new SculkCatalyst(e);case"lectern":return new Lectern(e,{Page:{type:"text",format:"int",tip:e},Book:{type:"itemselect",forceConstruct:settings.loadItemUI,tip:e}});case"vault":return new Vault(e);case"trial_spawner":return new TrialSpawner(e);case"spawner":return new MobSpawner(e);case"piston":return new Block(e,{blockID:{type:"text",format:"int",tip:e},blockData:{type:"text",format:"int",tip:e},facing:{type:"choice",values:dunswe,format:"int",tip:e},progress:{type:"text",format:"f",tip:e},extending:{type:"choice",values:unsetTrueFalse,format:"b",tip:e},source:{type:"choice",values:unsetTrueFalse,format:"b",tip:e}});case"conduit":return new Block(e,{Target:{type:"UUIDArray",format:"intArray",align:"R",playerLookup:!0,tip:e}});case"jigsaw":return new Block(e,{name:{type:"text",format:"string",fwClass:"bigTF",value:"minecraft:empty",tip:e},pool:{type:"text",format:"string",fwClass:"bigTF",value:"minecraft:empty",tip:e},final_state:{type:"text",format:"string",fwClass:"bigTF",value:"minecraft:air",tip:e},target:{type:"text",format:"string",fwClass:"bigTF",value:"minecraft:empty",tip:e},joint:{type:"makeSelect",format:"string",values:["aligned","rollable"],fwClass:"bigTF",value:"minecraft:empty",tip:e}});case"player_wall_head":case"player_head":return new PlayerHead(e,{});case"chiseled_bookshelf":return new BlockWithSlots(e,{},6);case"oak_sign":case"pale_oak_sign":case"spruce_sign":case"birch_sign":case"jungle_sign":case"acacia_sign":case"dark_oak_sign":case"mangrove_sign":case"crimson_sign":case"warped_sign":case"bamboo_sign":case"cherry_sign":case"oak_wall_hanging_sign":case"pale_oak_wall_hanging_sign":case"spruce_wall_hanging_sign":case"birch_wall_hanging_sign":case"jungle_wall_hanging_sign":case"acacia_wall_hanging_sign":case"dark_oak_wall_hanging_sign":case"mangrove_wall_hanging_sign":case"crimson_wall_hanging_sign":case"warped_wall_hanging_sign":case"bamboo_wall_hanging_sign":case"cherry_wall_hanging_sign":case"pale_oak_hanging_sign":case"oak_hanging_sign":case"spruce_hanging_sign":case"birch_hanging_sign":case"jungle_hanging_sign":case"acacia_hanging_sign":case"dark_oak_hanging_sign":case"mangrove_hanging_sign":case"crimson_hanging_sign":case"warped_hanging_sign":case"bamboo_hanging_sign":case"cherry_hanging_sign":case"oak_wall_sign":case"pale_oak_wall_sign":case"spruce_wall_sign":case"birch_wall_sign":case"jungle_wall_sign":case"acacia_wall_sign":case"dark_oak_wall_sign":case"mangrove_wall_sign":case"warped_wall_sign":case"crimson_wall_sign":case"bamboo_wall_sign":case"cherry_wall_sign":return new Sign(e,{is_waxed:{type:"choice",values:unsetTrueFalse,format:"b",tip:"sign",align:"R"}});case"structure_block":return new Block(e,structureBlockNBT);default:return new Block(e,{})}}function buildListOfBlocksWithData(){for(var e in itemsAndBlocks){var t;"i"!=itemsAndBlocks[e].c&&(t=loadBlockClass(e),Object.keys(t.blockNBT).length)&&hasBlockData.push(e)}}function copyEntityNBT(e){copyToClipboard('{id:"minecraft:'+$("#entity"+e).val()+'"'+entityDescriptors["e"+e].getEntitySpecificCommand(e)+"}")}function pasteEntityNBT(n){navigator.clipboard.readText().then(t=>{try{var e=new CMDParser(""),a=e.parseCompound(extractSegment("{","}",t.indexOf("{"),t)),o=extractMinecraftID(a.id.val);$("#entity"+n+"_filter").val(""),$("#entity"+n+"_filter").trigger("keyup"),$("#entity"+n).val(o),$("#entity"+n).trigger("change"),cachedNBT.clear(),e.loadSummonCommand(a,n),generateCommand()}catch(e){alertify.alert("Error Can't load in this NBT:<br>"+t+"<br>"+e.toString())}})}function copyItemNBT(e){copyToClipboard(getItemNBT(e))}function copyTradeNBT(e){$("#closeItemUI_"+e+"buy").trigger("click"),$("#closeItemUI_"+e+"buyB").trigger("click"),$("#closeItemUI_"+e+"sell").trigger("click");let t=getTradeNBT(e);copyToClipboard(t=t.length?"{"+t.substr(1)+"}":t)}function pasteTradeNBT(a){$("#closeItemUI_"+a+"buy").trigger("click"),$("#closeItemUI_"+a+"buyB").trigger("click"),$("#closeItemUI_"+a+"sell").trigger("click"),navigator.clipboard.readText().then(t=>{try{var e=new CMDParser("");addTradeFromNBT(e.parseCompound(extractSegment("{","}",t.indexOf("{"),t)),a,e),generateCommand()}catch(e){alertify.alert("Error Can't load in this Trade:<br>"+t+"<br>"+e.toString())}})}function moveMultiItem(e,t){var a=e.substr(0,e.indexOf("_"));let o=[];$("#"+a+" > .itemSelectControl").each(function(e){o.push(this.id.substring(0,this.id.lastIndexOf("Pane")))});a=o.indexOf(e);if(1==t&&a<o.length-1||-1==t&&0<a){var e=a+t,t=[],n=($("#"+o[a]).length&&($("#closeItemUI_"+o[a]).trigger("click"),t.push(o[e])),$("#"+o[e]).length&&($("#closeItemUI_"+o[e]).trigger("click"),t.push(o[a])),getItemNBT(o[a])),n=(aNBT=getItemNBT(o[e]),bNBT=n,aNBT.length&&(aNBT="{"+aNBT.substr(1)+"}"),bNBT.length&&(bNBT="{"+bNBT.substr(1)+"}"),cachedNBT.setNBT(o[a],aNBT),cachedNBT.setNBT(o[e],bNBT),new CMDParser(""));setupItemTradeSlotForNBT(o[a],n.parseCompound(extractSegment("{","}",aNBT.indexOf("{"),aNBT)),n),setupItemTradeSlotForNBT(o[e],n.parseCompound(extractSegment("{","}",bNBT.indexOf("{"),bNBT)),n);for(const s of t)$("#createItemUI_"+s).trigger("click");generateCommand()}}function moveTrade(e,t){var a=e.substr(0,e.indexOf("_"));let o=[];$("#"+a+" > .trade").each(function(e){o.push(this.id)});var n,a=o.indexOf(e);(1==t&&a<o.length-1||-1==t&&0<a)&&(e=a+t,$("#closeItemUI_"+o[a]+"buy").trigger("click"),$("#closeItemUI_"+o[a]+"buyB").trigger("click"),$("#closeItemUI_"+o[a]+"sell").trigger("click"),$("#closeItemUI_"+o[e]+"buy").trigger("click"),$("#closeItemUI_"+o[e]+"buyB").trigger("click"),$("#closeItemUI_"+o[e]+"sell").trigger("click"),t=getTradeNBT(o[a]),aNBT=getTradeNBT(o[e]),bNBT=t,aNBT.length&&(aNBT="{"+aNBT.substr(1)+"}"),bNBT.length&&(bNBT="{"+bNBT.substr(1)+"}"),n=(t=new CMDParser("")).parseCompound(extractSegment("{","}",aNBT.indexOf("{"),aNBT)),cachedNBT.setNBT(o[a]+"buy",""),cachedNBT.setNBT(o[a]+"buyB",""),cachedNBT.setNBT(o[a]+"sell",""),cachedNBT.setNBT(o[e]+"buy",""),cachedNBT.setNBT(o[e]+"buyB",""),cachedNBT.setNBT(o[e]+"sell",""),addTradeFromNBT(n,o[a],t),addTradeFromNBT(n=t.parseCompound(extractSegment("{","}",bNBT.indexOf("{"),bNBT)),o[e],t),generateCommand())}function pasteItemNBT(i){navigator.clipboard.readText().then(t=>{try{var e=new CMDParser(""),a=extractSegment("{","}",t.indexOf("{"),t),o=e.parseCompound(a),n=extractMinecraftID(o.id.val);if($("#"+i+"_filter").val(""),updateItemSelectOptions("#"+i),!$("#"+i+" option[value='"+n+"']").length)throw new MCSException(n+" is not a valid item id");if($("#"+i).val(n),$("#"+i).trigger("change"),null!=o.count&&$(`#${i}Count`).val(parseInt(o.count.val)),null!=o.components)for(const s in o.components.val)loadComponentNBTIntoSlot(("!"==s.charAt(0)?"!":"")+extractMinecraftID(s),n,i,{val:o.components.val[s].val});generateCommand()}catch(e){alertify.alert("Error Can't load in this Item:<br>"+t+"<br>"+e.toString())}})}function copyToClipboard(e){if(navigator.clipboard&&navigator.clipboard.writeText)navigator.clipboard.writeText(e).then(function(){},function(){});else{var t=document.createElement("textarea");t.value=e,t.style.top="0",t.style.left="0",t.style.position="fixed",document.body.appendChild(t),t.focus(),t.select();try{document.execCommand("copy")}catch(e){}document.body.removeChild(t)}}function unsetItem(e){$("#"+e+"_filter").val(""),$("#"+e+"_filter").trigger("keyup"),$("#"+e).val("-1"),$("#"+e).trigger("change"),cachedNBT.unsetItem(e),generateCommand()}function getHexColor(e){return("000000"+(e>>>0).toString(16)).slice(-6).toUpperCase()}function getRandomInt(e,t){return Math.floor(Math.random()*(t-e+1))+e}function loadVersions(){($("#intro").length?$("#intro"):$("#commandForm")).load("vers.html")}function loadSupporters(){($("#intro").length?$("#intro"):$("#commandForm")).load("supporters.php")}$(function(){settings=new Settings,window.onresize=function(){desktopMode&&$("#commandOutput").css({top:0,left:$(window).width()-510})},$(document).mousemove(function(e){mouse.x=e.pageX,mouse.y=e.pageY}),$(document).bind("keydown",function(e){e.ctrlKey&&(90==e.keyCode?(loadFromHistory(-1),e.preventDefault()):89==e.keyCode&&(loadFromHistory(1),e.preventDefault()))}),navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/Android/i)?(desktopMode=!1,$(".ui-widget-content").css({position:"relative",width:"100%",top:0,left:0})):($("#clipBoard").draggable(),$("#commandOutput").draggable(),$("#commandInput").draggable(),$(".ui-widget-content").on("click",function(){bringToFront(this.id)})),$("#clipBoard").hide(),$("#commandOutput").hide(),$("#commandInput").hide(),$("#community").hide(),$("#toClipBoard").bind("click",function(){copyToClipboard($("#commandOutput-ta").val())}),$("#parseNBT").bind("click",function(){parseNBT(stripHTMLTags($("#commandInput-ta").val().trim()),CURRENT_VERSION)}),$("#closeImportBut").bind("click",function(){$("#commandInput").hide()}),$("#clearNBT").bind("click",function(){$("#commandInput-ta").val("")}),$("#disableOutput").bind("change",function(){$("#disableOutput").is(":checked")?$("#commandOutput-ta").val("Command output is disabled to improve performance while you work on large commands."):generateCommand()}),localStorage.cmdHistory&&(cmdHistory=JSON.parse(localStorage.cmdHistory)),loadManagement(),!electronMode&&"undefined"==typeof offlineMode||(linkMode=!1);var e=new URLSearchParams(window.location.search);linkMode&&e.has("cmd")?loadItemsAndBlocks(settings.lang,e.get("cmd").replaceAll("_"," ")):loadItemsAndBlocks(settings.lang),e.has("link_mode")?(linkMode="true"==e.get("link_mode"),localStorage.link_mode=e.get("link_mode")):null!=localStorage.link_mode&&(linkMode="true"==localStorage.link_mode),createCommandButtons()});const CURRENT_VERSION="1.21.5";var signedIn=!1,sortField="title",sortOrder="a",gRowIndex=0,userToken="",commandID=-1,mcfunctions=[],currentFunctionEdit=-1,ttNewPassword="The supplied password must be between 6 and 64 characters and can only contain numbers, letters, dashes, or underscores.",llPasswordReset="Password Reset",llEnterEmail="Enter the email that you supplied when you created your account. MCStacker will reset your password and email it to you.",monthNames=new Array("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec");function mkTT(e){return' title="'+e+'"'}function getCookie(e){for(var t=e+"=",a=document.cookie.split(";"),o=0;o<a.length;o++){for(var n=a[o];" "==n.charAt(0);)n=n.substring(1);if(0==n.indexOf(t))return n.substring(t.length,n.length)}return""}function setCookie(e,t,a){var o,n="";a&&((o=new Date).setTime(o.getTime()+24*a*60*60*1e3),n="; expires="+o.toUTCString()),document.cookie=e+"="+(t||"")+n+"; path=/"}function loadManagement(){userToken=getCookie("userToken"),loadNavPane();var e=window.location.hash;"#"==e.charAt(0)&&$.isNumeric(e.substr(2))&&(showCommunity(),showDetails(e.substr(2),!0))}function hashpword(e){return tmp=MD5(e+"This is the client side salt. There is more robust seasoning at the server side")}function loadNavPane(){$("#navPane").html(makeNavButton("Search","showSearch()","Search and Browse commands saved by others")),$.post("mcstacker2.php",{op:"isSignedIn",userToken:userToken},function(e,t){var a="<a class='redX' href=\"javascript:hideSavedCommands()\">&#9747;</a>";"signedIn"==$(e).find("action").text()?($("#navPane").append(makeNavButton("My Commands","showAccount('title', 'a', 0)")+makeNavButton("Favorites","showMyLikes('title','a',0)")+makeNavButton("Discuss","showDiscussions('title','a',0)")+makeNavButton("Account Settings","showAccountSettings()")+makeNavButton("Sign Out","signOut()")+"<span class='fRight'>"+$(e).find("username").text()+a+"</span>"),signedIn=!0,$("#commandOutput").append("<span id='saveAsBut' class='greenPlus'>Save Command</span>"),$("#saveAsBut").bind("click",function(){$("#community").show(),makeDetailsForm("",-1,$("#commandOutput-ta").val())})):($("#navPane").append(makeNavButton("Sign In","displayLogin('You are not currently signed in.')")+"<span class='fRight'>"+a+"</span>"),signedIn=!1)})}function hideSavedCommands(){$("#community").hide()}function showDiscussions(e,t,a){$("#manPane").html("<div id='searchResults'></div><div id='detailsPane'></div>");var o=$("#commandsPerPage").length?$("#commandsPerPage").val():10;gRowIndex=a,$.post("mcstacker2.php",{op:"searchCommands2",searchWhat:"unread",commandTypeSearch:"Any",searchString:"",userToken:userToken,sortField:e,sortOrder:t,commandsPerPage:o,rowIndex:a},function(e,t){"searchResult"==$(e).find("action").text()?showSearchResult(e,a,"unread"):"searchFailed"==$(e).find("action").text()&&$("#searchResults").html($(e).find("message").text())})}function showMyLikes(e,t,a){var o=$("#commandsPerPage").length?$("#commandsPerPage").val():10;$("#manPane").html("<div id='searchResults'></div><div id='detailsPane'></div>"),gRowIndex=a,$.post("mcstacker2.php",{op:"searchCommands2",userToken:userToken,searchWhat:"likes",commandTypeSearch:"Any",searchString:"",sortField:e,sortOrder:t,commandsPerPage:o,rowIndex:a},function(e,t){"searchResult"==$(e).find("action").text()?showSearchResult(e,a,"likes"):"searchFailed"==$(e).find("action").text()&&$("#searchResults").html($(e).find("message").text())})}function showHome(){$("#manPane").load(ppAbout)}function showHelp(){$("#manPane").load(ppHelp)}function makeNavButton(e,t,a){return'<a href="javascript:'+t+"\" class='navButton' "+(ttip=null!=a?mkTT(a):"")+">"+e+"</a>"}function makeButton(e,t,a){return'<a href="javascript:'+t+"\" class='mButton' "+(ttip=null!=a?mkTT(a):"")+">"+e+"</a>"}function makePageButton(e,t,a){return'<a href="javascript:'+t+"\" class='"+a+"'>"+e+"</a>"}function makeButtonR(e,t,a){return'<a href="javascript:'+t+"\" class='mButton fRight' "+mkTT(a)+">"+e+"</a>"}function doSignIn(){hashedpword=hashpword($("#password").val()),$.post("mcstacker2.php",{op:"doSignIn",hashedpword:hashedpword,username:$("#username").val()},function(e,t){userToken=$(e).find("userToken").text(),message=$(e).find("message").text(),"showCommands"==$(e).find("action").text()?(showCommands(e,0),loadNavPane()):"signInFailed"==$(e).find("action").text()&&($("#message").html(message),alertify.error(message))})}function showSearch(){makeSearchForm(),doSearch("date_modified","d",0)}function makeSearchForm(){for(var e=["Any","bossbar","data","effect","execute","fill","give","item","kill","loot","particle","playsound","replaceitem","scoreboard","setblock","summon","team","teleport","tellraw","title"],t="",a=0;a<e.length;a++)t+="<option value='"+e[a]+"'>"+e[a]+"</option>";$("#manPane").html("<h2 class='command'>Search/Browse</h2><label labelfor='commandTypeSearch' class='search'>Command Type</label><select id='commandTypeSearch'>"+t+"</select><label labelfor='searchWhat' class='search'>Search By</label><select id='searchWhat'"+mkTT("Narrow down your search by choosing to search only some parts of the saved information.")+"><option value='0'>Title, Description or Creator</option><option value='1'>Title</option><option value='2'>Description</option><option value='4'>Creator</option><option value='3'>Tag</option><option value='6'>Comments</option></select><label labelfor='searchString' class='search'>Search Text</label><input type='text' id='searchString'"+mkTT("Search for text in saved commands. Leave blank to browse all commands. Advanced boolean search strings are accepted. A leading plus (+) sign indicates that this word must be present in every result returned. A leading minus (-) sign indicates that this word must not be present in any result returned. ( ) Parentheses are used to group words into sub expressions. A phrase that is enclosed in double quotes matches only results that contain this phrase literally.")+">"+makeButton("Search/Browse","onClick=doSearch('title', 'a', 0)","Search and browse commands created by other users.")+"<div id='searchResults'></div>")}function searchUsers(e){makeSearchForm(),$("#commandTypeSearch").val("Any"),$("#searchWhat").val(4),$("#searchString").val(e),doSearch("title","a",0)}function searchTag(e){showSearch(),$("#commandTypeSearch").val("Any"),$("#searchWhat").val(3),$("#searchString").val(e),doSearch("title","a",0)}function doSearch(e,t,a){sortOrder=t,sortField=e;t=$("#commandsPerPage").length?$("#commandsPerPage").val():10;$.post("mcstacker2.php",{op:"searchCommands2",searchWhat:$("#searchWhat").val(),commandTypeSearch:$("#commandTypeSearch").val(),searchString:$("#searchString").val(),userToken:userToken,sortField:sortField,sortOrder:sortOrder,rowIndex:a,commandsPerPage:t},function(e,t){"searchResult"==$(e).find("action").text()?showSearchResult(e,a,"search"):"searchFailed"==$(e).find("action").text()&&$("#searchResults").html($(e).find("message").text())})}function showSearchResult(e,a,o){$("#searchResults").empty();var t="",n=$(e).find("rowCount").text(),s="";if(10<n){cmdPerPage=parseInt($(e).find("commandsPerPage").text());let t="";for(let e=0;e<n;e+=cmdPerPage)t+=`<option value='${e}'>${e+1} to ${e+cmdPerPage}</option>`;for($("#searchResults").append(`<label labelfor='pageGroup' class='search'>Commands</label><select id='pageGroup' class='updateSearch'>${t}</select>`),0<$(`#pageGroup option[value='${a}']`).length&&$("#pageGroup").val(a),$("#searchResults").append(`<label labelfor='commandsPerPage' class='search'>Per Page</label><select id='commandsPerPage' class='updateSearch'>
